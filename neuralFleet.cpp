...
public:
    ...
    void dumpSanitizedParams(MBRegistry *mreg) {
        myShipNet.save(mreg, "floatNet.");
        myShipNet.dumpSanitizedParams(mreg, "floatNet.");
    }
    ...
    void putDefaults(MBRegistry *mreg, FleetAIType aiType) {
        ...
        NeuralConfigValue configs1[] = {
            ...
            { "floatNet.input[0].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[0].radius", "1379.394165" },
            { "floatNet.input[0].useTangent", "TRUE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[10].radius", "26.197947" },
            { "floatNet.input[10].useTangent", "TRUE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[11].radius", "1410.684570" },
            { "floatNet.input[11].useTangent", "FALSE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[12].radius", "821.751221" },
            { "floatNet.input[12].useTangent", "FALSE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[13].radius", "3000.000000" },
            { "floatNet.input[13].useTangent", "FALSE" },
            { "floatNet.input[13].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[14].radius", "2820.190674" },
            { "floatNet.input[14].useTangent", "FALSE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[15].radius", "152.445862" },
            { "floatNet.input[15].useTangent", "TRUE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[16].radius", "1642.232056" },
            { "floatNet.input[16].useTangent", "FALSE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[17].radius", "938.246948" },
            { "floatNet.input[17].useTangent", "TRUE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[18].radius", "1578.296631" },
            { "floatNet.input[18].useTangent", "FALSE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[19].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[19].radius", "2423.319824" },
            { "floatNet.input[19].useTangent", "TRUE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[1].radius", "2067.721191" },
            { "floatNet.input[1].useTangent", "FALSE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[2].radius", "1371.876465" },
            { "floatNet.input[2].useTangent", "TRUE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[3].radius", "1263.489990" },
            { "floatNet.input[3].useTangent", "FALSE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[4].radius", "2304.703857" },
            { "floatNet.input[4].useTangent", "TRUE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[5].radius", "1718.594727" },
            { "floatNet.input[5].useTangent", "TRUE" },
            { "floatNet.input[5].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[6].radius", "2545.418213" },
            { "floatNet.input[6].useTangent", "TRUE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[7].radius", "2474.785889" },
            { "floatNet.input[7].useTangent", "FALSE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[8].radius", "2051.518799" },
            { "floatNet.input[8].useTangent", "FALSE" },
            { "floatNet.input[8].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[9].radius", "1191.592407" },
            { "floatNet.input[9].useTangent", "FALSE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.output[20].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[20].radius", "2464.956787" },
            { "floatNet.output[20].useTangent", "FALSE" },
            { "floatNet.output[20].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[30].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[30].radius", "2050.290771" },
            { "floatNet.output[30].useTangent", "TRUE" },
            { "floatNet.output[30].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[31].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[31].radius", "602.595520" },
            { "floatNet.output[31].useTangent", "TRUE" },
            { "floatNet.output[31].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[32].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[32].radius", "1519.014038" },
            { "floatNet.output[32].useTangent", "FALSE" },
            { "floatNet.output[32].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[33].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[33].radius", "3000.000000" },
            { "floatNet.output[33].useTangent", "TRUE" },
            { "floatNet.output[33].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[34].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[34].radius", "2529.224365" },
            { "floatNet.output[34].useTangent", "FALSE" },
            { "floatNet.output[34].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[35].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[35].radius", "211.022003" },
            { "floatNet.output[35].useTangent", "TRUE" },
            { "floatNet.output[35].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[36].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[36].radius", "1125.137329" },
            { "floatNet.output[36].useTangent", "TRUE" },
            { "floatNet.output[36].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[37].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[37].radius", "1372.211548" },
            { "floatNet.output[37].useTangent", "FALSE" },
            { "floatNet.output[37].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[38].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[38].radius", "812.498596" },
            { "floatNet.output[38].useTangent", "FALSE" },
            { "floatNet.output[38].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[39].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[39].radius", "2725.875488" },
            { "floatNet.output[39].useTangent", "FALSE" },
            { "floatNet.output[39].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[21].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[21].radius", "1413.617065" },
            { "floatNet.output[21].useTangent", "TRUE" },
            { "floatNet.output[21].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[22].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[22].radius", "2569.132568" },
            { "floatNet.output[22].useTangent", "TRUE" },
            { "floatNet.output[22].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[23].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[23].radius", "1969.989868" },
            { "floatNet.output[23].useTangent", "TRUE" },
            { "floatNet.output[23].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[24].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[24].radius", "2281.656494" },
            { "floatNet.output[24].useTangent", "TRUE" },
            { "floatNet.output[24].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[25].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[25].radius", "2072.078369" },
            { "floatNet.output[25].useTangent", "TRUE" },
            { "floatNet.output[25].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[26].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[26].radius", "1009.818115" },
            { "floatNet.output[26].useTangent", "FALSE" },
            { "floatNet.output[26].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[27].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[27].radius", "1700.157471" },
            { "floatNet.output[27].useTangent", "TRUE" },
            { "floatNet.output[27].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[28].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.output[28].radius", "1027.284424" },
            { "floatNet.output[28].useTangent", "TRUE" },
            { "floatNet.output[28].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[29].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[29].radius", "1428.817993" },
            { "floatNet.output[29].useTangent", "TRUE" },
            { "floatNet.output[29].valueType", "NEURAL_VALUE_FORCE" },
            { "rotateStartingAngle", "TRUE" },
        ...
        NeuralConfigValue configs2[] = {
            ...
            { "floatNet.input[0].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[0].radius", "0.000000" },
            { "floatNet.input[0].useTangent", "TRUE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[10].radius", "0.000000" },
            { "floatNet.input[10].useTangent", "TRUE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[11].radius", "0.000000" },
            { "floatNet.input[11].useTangent", "TRUE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "TRUE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[13].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[13].radius", "0.000000" },
            { "floatNet.input[13].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[14].radius", "0.000000" },
            { "floatNet.input[14].useTangent", "FALSE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[15].radius", "0.000000" },
            { "floatNet.input[15].useTangent", "TRUE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "FALSE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "TRUE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[18].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[18].radius", "0.000000" },
            { "floatNet.input[18].useTangent", "FALSE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[19].radius", "0.000000" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[1].radius", "0.000000" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "TRUE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[21].radius", "0.000000" },
            { "floatNet.input[21].useTangent", "TRUE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[22].radius", "-1.000000" },
            { "floatNet.input[22].useTangent", "TRUE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[23].radius", "0.000000" },
            { "floatNet.input[23].useTangent", "FALSE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[24].radius", "1876.846924" },
            { "floatNet.input[24].useTangent", "FALSE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[2].radius", "142.804443" },
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[3].radius", "0.000000" },
            { "floatNet.input[3].useTangent", "FALSE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "FALSE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[5].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[5].radius", "0.000000" },
            { "floatNet.input[5].useTangent", "FALSE" },
            { "floatNet.input[5].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[6].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[6].radius", "0.000000" },
            { "floatNet.input[6].useTangent", "TRUE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[7].radius", "0.000000" },
            { "floatNet.input[7].useTangent", "TRUE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[8].radius", "0.000000" },
            { "floatNet.input[8].useTangent", "TRUE" },
            { "floatNet.input[8].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[9].radius", "0.000000" },
            { "floatNet.input[9].useTangent", "FALSE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[100].radius", "-1.000000" },
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[101].radius", "0.000000" },
            { "floatNet.output[101].useTangent", "TRUE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[102].radius", "0.000000" },
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "FALSE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[104].radius", "1716.954956" },
            { "floatNet.output[104].useTangent", "TRUE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[105].radius", "0.000000" },
            { "floatNet.output[105].useTangent", "FALSE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[106].radius", "-0.857375" },
            { "floatNet.output[106].useTangent", "TRUE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[107].radius", "0.000000" },
            { "floatNet.output[107].useTangent", "TRUE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[108].radius", "0.000000" },
            { "floatNet.output[108].useTangent", "TRUE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[109].radius", "426.598633" },
            { "floatNet.output[109].useTangent", "TRUE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[110].radius", "0.000000" },
            { "floatNet.output[110].useTangent", "TRUE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[111].radius", "0.000000" },
            { "floatNet.output[111].useTangent", "TRUE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[112].radius", "0.000000" },
            { "floatNet.output[112].useTangent", "TRUE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[113].radius", "0.000000" },
            { "floatNet.output[113].useTangent", "FALSE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[114].radius", "0.000000" },
            { "floatNet.output[114].useTangent", "TRUE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[115].radius", "0.000000" },
            { "floatNet.output[115].useTangent", "FALSE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "FALSE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[117].radius", "-1.000000" },
            { "floatNet.output[117].useTangent", "TRUE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[118].radius", "0.000000" },
            { "floatNet.output[118].useTangent", "FALSE" },
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[119].radius", "0.000000" },
            { "floatNet.output[119].useTangent", "FALSE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[120].radius", "0.000000" },
            { "floatNet.output[120].useTangent", "FALSE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[121].radius", "-1.000000" },
            { "floatNet.output[121].useTangent", "TRUE" },
            { "floatNet.output[121].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[122].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[122].radius", "0.000000" },
            { "floatNet.output[122].useTangent", "FALSE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[123].radius", "0.000000" },
            { "floatNet.output[123].useTangent", "FALSE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[124].radius", "0.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
            { "rotateStartingAngle", "TRUE" },
            { "sensorGrid.staleCoreTime", "0.000000" },
            { "sensorGrid.staleFighterTime", "0.000000" },
        ...
        NeuralConfigValue configs3[] = {
            ...
            { "floatNet.input[0].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[0].radius", "0.000000" },
            { "floatNet.input[0].useTangent", "TRUE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[10].radius", "0.000000" },
            { "floatNet.input[10].useTangent", "TRUE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[11].radius", "0.000000" },
            { "floatNet.input[11].useTangent", "TRUE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "TRUE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[13].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[13].radius", "0.000000" },
            { "floatNet.input[13].useTangent", "TRUE" },
            { "floatNet.input[13].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[14].radius", "0.000000" },
            { "floatNet.input[14].useTangent", "FALSE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[15].radius", "0.000000" },
            { "floatNet.input[15].useTangent", "TRUE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "TRUE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "TRUE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[18].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[18].radius", "0.000000" },
            { "floatNet.input[18].useTangent", "TRUE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[19].radius", "-1.000000" },
            { "floatNet.input[19].useTangent", "FALSE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[1].radius", "0.000000" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[20].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "TRUE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[21].radius", "0.000000" },
            { "floatNet.input[21].useTangent", "TRUE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[22].radius", "-1.000000" },
            { "floatNet.input[22].useTangent", "FALSE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "FALSE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[24].radius", "1876.846924" },
            { "floatNet.input[24].useTangent", "TRUE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[2].radius", "142.804443" },
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[3].radius", "0.000000" },
            { "floatNet.input[3].useTangent", "FALSE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "FALSE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[5].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[5].radius", "0.000000" },
            { "floatNet.input[5].useTangent", "FALSE" },
            { "floatNet.input[5].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[6].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[6].radius", "-1.000000" },
            { "floatNet.input[6].useTangent", "FALSE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[7].radius", "156.061691" },
            { "floatNet.input[7].useTangent", "TRUE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[8].radius", "0.000000" },
            { "floatNet.input[8].useTangent", "TRUE" },
            { "floatNet.input[8].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[9].radius", "0.000000" },
            { "floatNet.input[9].useTangent", "FALSE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[100].radius", "-1.000000" },
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[101].radius", "1346.359497" },
            { "floatNet.output[101].useTangent", "TRUE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[102].radius", "144.401123" },
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "TRUE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[104].radius", "1716.403198" },
            { "floatNet.output[104].useTangent", "FALSE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[105].radius", "0.000000" },
            { "floatNet.output[105].useTangent", "TRUE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[106].radius", "-0.814506" },
            { "floatNet.output[106].useTangent", "FALSE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[107].radius", "0.000000" },
            { "floatNet.output[107].useTangent", "TRUE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[108].radius", "0.000000" },
            { "floatNet.output[108].useTangent", "TRUE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[109].radius", "426.598633" },
            { "floatNet.output[109].useTangent", "TRUE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[110].radius", "-1.000000" },
            { "floatNet.output[110].useTangent", "FALSE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[111].radius", "0.000000" },
            { "floatNet.output[111].useTangent", "TRUE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[112].radius", "0.000000" },
            { "floatNet.output[112].useTangent", "TRUE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[113].radius", "0.000000" },
            { "floatNet.output[113].useTangent", "FALSE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[114].radius", "143.071716" },
            { "floatNet.output[114].useTangent", "FALSE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[115].radius", "-1.000000" },
            { "floatNet.output[115].useTangent", "TRUE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "FALSE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[117].radius", "-1.000000" },
            { "floatNet.output[117].useTangent", "FALSE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[118].radius", "150.485336" },
            { "floatNet.output[118].useTangent", "FALSE" },
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[119].radius", "0.000000" },
            { "floatNet.output[119].useTangent", "TRUE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[120].radius", "0.000000" },
            { "floatNet.output[120].useTangent", "FALSE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[121].radius", "-1.000000" },
            { "floatNet.output[121].useTangent", "TRUE" },
            { "floatNet.output[121].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[122].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.output[122].radius", "155.966476" },
            { "floatNet.output[122].useTangent", "TRUE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[123].radius", "-1.000000" },
            { "floatNet.output[123].useTangent", "TRUE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[124].radius", "0.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
        ...
        NeuralConfigValue configs4[] = {
            ...
            { "floatNet.input[0].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[0].radius", "0.000000" },
            { "floatNet.input[0].useTangent", "TRUE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[10].radius", "0.000000" },
            { "floatNet.input[10].useTangent", "TRUE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[11].radius", "0.000000" },
            { "floatNet.input[11].useTangent", "FALSE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "TRUE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[13].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[13].radius", "0.000000" },
            { "floatNet.input[13].useTangent", "TRUE" },
            { "floatNet.input[13].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[14].radius", "0.000000" },
            { "floatNet.input[14].useTangent", "FALSE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_TICK" },
            ...
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "FALSE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "FALSE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[18].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[18].radius", "0.000000" },
            { "floatNet.input[18].useTangent", "TRUE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_MOBID" },
            ...
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "TRUE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[21].radius", "144.088669" },
            { "floatNet.input[21].useTangent", "TRUE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[22].radius", "-1.000000" },
            { "floatNet.input[22].useTangent", "FALSE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "FALSE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[24].radius", "1876.846924" },
            { "floatNet.input[24].useTangent", "TRUE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[2].radius", "-1.000000" },
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[3].radius", "-1.000000" },
            { "floatNet.input[3].useTangent", "FALSE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "FALSE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_MOBID" },
            ...
            { "floatNet.input[5].radius", "0.000000" },
            { "floatNet.input[5].useTangent", "FALSE" },
            { "floatNet.input[5].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[6].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[6].radius", "-0.950000" },
            { "floatNet.input[6].useTangent", "TRUE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[7].radius", "156.061691" },
            { "floatNet.input[7].useTangent", "FALSE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[8].radius", "0.000000" },
            { "floatNet.input[8].useTangent", "TRUE" },
            { "floatNet.input[8].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[9].radius", "0.000000" },
            { "floatNet.input[9].useTangent", "FALSE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[100].radius", "-1.000000" },
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[101].radius", "1346.359497" },
            { "floatNet.output[101].useTangent", "FALSE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.output[102].radius", "151.621170" },
            { "floatNet.output[102].useTangent", "TRUE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "TRUE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[104].radius", "1716.403198" },
            { "floatNet.output[104].useTangent", "FALSE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[105].radius", "0.000000" },
            { "floatNet.output[105].useTangent", "FALSE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[106].radius", "-0.814506" },
            { "floatNet.output[106].useTangent", "FALSE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.output[107].radius", "0.000000" },
            { "floatNet.output[107].useTangent", "FALSE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[108].radius", "0.000000" },
            { "floatNet.output[108].useTangent", "FALSE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[109].radius", "426.598633" },
            { "floatNet.output[109].useTangent", "TRUE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[110].radius", "-1.000000" },
            { "floatNet.output[110].useTangent", "TRUE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[111].radius", "0.000000" },
            { "floatNet.output[111].useTangent", "FALSE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[112].radius", "151.377563" },
            { "floatNet.output[112].useTangent", "FALSE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[113].radius", "0.000000" },
            { "floatNet.output[113].useTangent", "TRUE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[114].radius", "143.071716" },
            { "floatNet.output[114].useTangent", "FALSE" },
            ...
            { "floatNet.output[115].useTangent", "TRUE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "FALSE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[117].radius", "-1.000000" },
            { "floatNet.output[117].useTangent", "FALSE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[118].radius", "150.485336" },
            { "floatNet.output[118].useTangent", "TRUE" },
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[119].radius", "2992.190186" },
            { "floatNet.output[119].useTangent", "TRUE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.output[120].radius", "0.000000" },
            { "floatNet.output[120].useTangent", "TRUE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[121].radius", "-1.000000" },
            { "floatNet.output[121].useTangent", "TRUE" },
            { "floatNet.output[121].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[122].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[122].radius", "155.966476" },
            { "floatNet.output[122].useTangent", "TRUE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[123].radius", "-1.000000" },
            { "floatNet.output[123].useTangent", "FALSE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_HEADING" },
        ...
        NeuralConfigValue configs5[] = {
            ...
            { "floatNet.node[84].op", "ML_FOP_Nx1_POW_SUM" },
            ...
            { "floatNet.input[0].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[0].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[0].radius", "0.000000" },
            { "floatNet.input[0].useTangent", "FALSE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[10].radius", "0.000000" },
            { "floatNet.input[10].useTangent", "TRUE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[11].radius", "0.000000" },
            { "floatNet.input[11].useTangent", "TRUE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[12].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[12].frequency", "0.000000" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "FALSE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[12].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[13].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[13].frequency", "0.000000" },
            { "floatNet.input[13].radius", "0.000000" },
            { "floatNet.input[13].useTangent", "FALSE" },
            { "floatNet.input[13].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[13].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[14].frequency", "0.000000" },
            { "floatNet.input[14].radius", "0.000000" },
            { "floatNet.input[14].useTangent", "FALSE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[14].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[15].radius", "0.000000" },
            { "floatNet.input[15].useTangent", "FALSE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[16].frequency", "0.000000" },
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "TRUE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[17].frequency", "3898.708740" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "FALSE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[17].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[18].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[18].frequency", "0.000000" },
            { "floatNet.input[18].radius", "147.504044" },
            { "floatNet.input[18].useTangent", "TRUE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[18].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[19].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[19].radius", "-1.000000" },
            { "floatNet.input[19].useTangent", "FALSE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[1].radius", "301.750824" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[20].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "FALSE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[20].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[21].frequency", "0.000000" },
            { "floatNet.input[21].radius", "-1.000000" },
            { "floatNet.input[21].useTangent", "TRUE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[22].radius", "6.802381" },
            { "floatNet.input[22].useTangent", "TRUE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[23].frequency", "0.000000" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "FALSE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[23].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[24].frequency", "0.000000" },
            { "floatNet.input[24].radius", "1086.721436" },
            { "floatNet.input[24].useTangent", "TRUE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.input[2].radius", "148.709793" },
            { "floatNet.input[2].useTangent", "TRUE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[3].radius", "-1.000000" },
            { "floatNet.input[3].useTangent", "TRUE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[4].frequency", "5622.903809" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "FALSE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[5].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[5].frequency", "0.000000" },
            { "floatNet.input[5].radius", "0.000000" },
            { "floatNet.input[5].useTangent", "TRUE" },
            { "floatNet.input[5].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[5].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[6].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[6].frequency", "0.000000" },
            { "floatNet.input[6].radius", "-0.950000" },
            { "floatNet.input[6].useTangent", "FALSE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[6].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[7].radius", "156.061691" },
            { "floatNet.input[7].useTangent", "TRUE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[8].frequency", "0.000000" },
            { "floatNet.input[8].radius", "0.000000" },
            { "floatNet.input[8].useTangent", "FALSE" },
            { "floatNet.input[8].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[8].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[9].radius", "0.000000" },
            { "floatNet.input[9].useTangent", "TRUE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[100].radius", "529.224609" },
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[101].radius", "1351.212036" },
            { "floatNet.output[101].useTangent", "FALSE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[102].radius", "159.202225" },
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "FALSE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[104].radius", "1572.406860" },
            { "floatNet.output[104].useTangent", "FALSE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[105].radius", "278.047913" },
            { "floatNet.output[105].useTangent", "TRUE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[106].radius", "2541.187500" },
            { "floatNet.output[106].useTangent", "FALSE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[107].radius", "0.000000" },
            { "floatNet.output[107].useTangent", "TRUE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[108].radius", "-1.000000" },
            { "floatNet.output[108].useTangent", "FALSE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[109].radius", "1485.732910" },
            { "floatNet.output[109].useTangent", "TRUE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[110].radius", "2742.620361" },
            { "floatNet.output[110].useTangent", "TRUE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[111].radius", "-1.000000" },
            { "floatNet.output[111].useTangent", "TRUE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[112].radius", "298.007172" },
            { "floatNet.output[112].useTangent", "FALSE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[113].radius", "-1.000000" },
            { "floatNet.output[113].useTangent", "TRUE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[114].radius", "322.285767" },
            { "floatNet.output[114].useTangent", "TRUE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[115].radius", "-1.000000" },
            { "floatNet.output[115].useTangent", "FALSE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "TRUE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[117].radius", "850.924561" },
            { "floatNet.output[117].useTangent", "FALSE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[118].radius", "298.878693" },
            { "floatNet.output[118].useTangent", "TRUE" },
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[119].radius", "3000.000000" },
            { "floatNet.output[119].useTangent", "TRUE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[120].radius", "2963.549072" },
            { "floatNet.output[120].useTangent", "TRUE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[121].radius", "-1.000000" },
            { "floatNet.output[121].useTangent", "FALSE" },
            { "floatNet.output[121].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[122].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[122].radius", "1693.586426" },
            { "floatNet.output[122].useTangent", "FALSE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[123].radius", "981.496277" },
            { "floatNet.output[123].useTangent", "FALSE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[124].radius", "-1.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
            { "rotateStartingAngle", "TRUE" },
            { "sensorGrid.staleCoreTime", "0.000000" },
        ...
        NeuralConfigValue configs6[] = {
            ...
            { "floatNet.node[39].op", "ML_FOP_Nx1_POW_SUM" },
            ...
            { "floatNet.input[10].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[11].radius", "0.000000" },
            { "floatNet.input[11].useTangent", "TRUE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[11].waveType", "NEURAL_WAVE_UNIT_SINE" },
            { "floatNet.input[12].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[12].frequency", "0.000000" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "FALSE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[12].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[13].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[13].frequency", "0.000000" },
            { "floatNet.input[13].radius", "0.000000" },
            { "floatNet.input[13].useTangent", "TRUE" },
            { "floatNet.input[13].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[13].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[14].frequency", "0.000000" },
            { "floatNet.input[14].radius", "157.085648" },
            { "floatNet.input[14].useTangent", "FALSE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[14].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[15].radius", "156.087997" },
            { "floatNet.input[15].useTangent", "FALSE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[16].frequency", "0.000000" },
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "TRUE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[17].frequency", "4093.644043" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "TRUE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[17].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[18].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[18].frequency", "0.000000" },
            { "floatNet.input[18].radius", "147.504044" },
            { "floatNet.input[18].useTangent", "TRUE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[18].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[19].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[19].radius", "-1.000000" },
            { "floatNet.input[19].useTangent", "FALSE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[1].radius", "301.750824" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[20].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "FALSE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[20].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[21].frequency", "0.000000" },
            { "floatNet.input[21].radius", "-1.000000" },
            { "floatNet.input[21].useTangent", "TRUE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[22].radius", "6.802381" },
            { "floatNet.input[22].useTangent", "TRUE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[23].frequency", "0.000000" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "TRUE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[23].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.input[24].frequency", "0.000000" },
            { "floatNet.input[24].radius", "1086.721436" },
            { "floatNet.input[24].useTangent", "FALSE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[2].radius", "148.709793" },
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[3].radius", "-1.000000" },
            { "floatNet.input[3].useTangent", "TRUE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            ...
            { "floatNet.input[4].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[5].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[5].frequency", "0.000000" },
            { "floatNet.input[5].radius", "0.000000" },
            { "floatNet.input[5].useTangent", "FALSE" },
            { "floatNet.input[5].valueType", "NEURAL_VALUE_FORCE" },
            ...
            { "floatNet.input[6].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[7].radius", "156.061691" },
            { "floatNet.input[7].useTangent", "FALSE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[8].frequency", "0.000000" },
            { "floatNet.input[8].radius", "0.000000" },
            { "floatNet.input[8].useTangent", "FALSE" },
            ...
            { "floatNet.input[8].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.input[9].radius", "154.979477" },
            { "floatNet.input[9].useTangent", "TRUE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[100].radius", "529.224609" },
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[101].radius", "1351.212036" },
            { "floatNet.output[101].useTangent", "TRUE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[102].radius", "13.126847" },
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "TRUE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[104].radius", "1729.684937" },
            { "floatNet.output[104].useTangent", "FALSE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[105].radius", "278.047913" },
            { "floatNet.output[105].useTangent", "FALSE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[106].radius", "2541.187500" },
            { "floatNet.output[106].useTangent", "FALSE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_CORES" },
            ...
            { "floatNet.output[107].useTangent", "FALSE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[108].radius", "-1.000000" },
            { "floatNet.output[108].useTangent", "FALSE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[109].radius", "1411.446289" },
            { "floatNet.output[109].useTangent", "TRUE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[110].radius", "2727.242432" },
            { "floatNet.output[110].useTangent", "TRUE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[111].radius", "-1.000000" },
            { "floatNet.output[111].useTangent", "TRUE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[112].radius", "312.907501" },
            { "floatNet.output[112].useTangent", "TRUE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[113].radius", "-1.000000" },
            { "floatNet.output[113].useTangent", "TRUE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[114].radius", "322.285767" },
            { "floatNet.output[114].useTangent", "FALSE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            ...
            { "floatNet.output[115].useTangent", "FALSE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "TRUE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[117].radius", "850.924561" },
            { "floatNet.output[117].useTangent", "FALSE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[118].radius", "298.878693" },
            { "floatNet.output[118].useTangent", "FALSE" },
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_EDGES" },
            ...
            { "floatNet.output[119].useTangent", "FALSE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[120].radius", "2963.549072" },
            { "floatNet.output[120].useTangent", "TRUE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_ENEMY" },
            ...
            { "floatNet.output[122].useTangent", "FALSE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[123].radius", "1030.571045" },
            { "floatNet.output[123].useTangent", "TRUE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[124].radius", "-1.000000" },
        ...
        NeuralConfigValue configs7[] = {
            ...
            { "floatNet.input[0].useTangent", "FALSE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[10].radius", "0.000000" },
            { "floatNet.input[10].useTangent", "FALSE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[11].radius", "0.000000" },
            { "floatNet.input[11].useTangent", "FALSE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[11].waveType", "NEURAL_WAVE_UNIT_SINE" },
            { "floatNet.input[12].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[12].frequency", "0.000000" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "FALSE" },
            ...
            { "floatNet.input[12].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[13].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[13].frequency", "0.000000" },
            { "floatNet.input[13].radius", "0.000000" },
            { "floatNet.input[13].useTangent", "TRUE" },
            { "floatNet.input[13].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[13].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[14].frequency", "0.000000" },
            { "floatNet.input[14].radius", "164.939926" },
            { "floatNet.input[14].useTangent", "TRUE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[14].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[15].radius", "156.087997" },
            { "floatNet.input[15].useTangent", "FALSE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[16].frequency", "0.000000" },
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "TRUE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_CROWD" },
            ...
            { "floatNet.input[17].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[17].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[18].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[18].frequency", "0.000000" },
            { "floatNet.input[18].radius", "147.504044" },
            { "floatNet.input[18].useTangent", "TRUE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[18].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[19].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[19].radius", "-1.000000" },
            { "floatNet.input[19].useTangent", "FALSE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[1].radius", "301.750824" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[20].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[20].frequency", "0.000000" },
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "FALSE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[20].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[21].frequency", "0.000000" },
            { "floatNet.input[21].radius", "-1.000000" },
            { "floatNet.input[21].useTangent", "FALSE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[22].radius", "6.802381" },
            { "floatNet.input[22].useTangent", "FALSE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.input[23].frequency", "0.000000" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "FALSE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[23].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[24].frequency", "0.000000" },
            { "floatNet.input[24].radius", "1086.721436" },
            { "floatNet.input[24].useTangent", "TRUE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[2].radius", "148.709793" },
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            ...
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[4].frequency", "5622.903809" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "TRUE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[5].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[5].frequency", "0.000000" },
            { "floatNet.input[5].radius", "0.000000" },
            ...
            { "floatNet.input[5].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[5].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[6].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[6].frequency", "0.000000" },
            { "floatNet.input[6].radius", "-0.950000" },
            { "floatNet.input[6].useTangent", "TRUE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_CROWD" },
            ...
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[7].radius", "4.193549" },
            { "floatNet.input[7].useTangent", "FALSE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[8].frequency", "0.000000" },
            { "floatNet.input[8].radius", "0.000000" },
            ...
            { "floatNet.input[8].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[8].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.input[9].radius", "154.979477" },
            { "floatNet.input[9].useTangent", "FALSE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_COHERE" },
            ...
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[101].radius", "1351.212036" },
            { "floatNet.output[101].useTangent", "FALSE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[102].radius", "167.162323" },
            { "floatNet.output[102].useTangent", "TRUE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "TRUE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[104].radius", "1729.684937" },
            { "floatNet.output[104].useTangent", "TRUE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[105].radius", "278.047913" },
            { "floatNet.output[105].useTangent", "TRUE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_ALIGN" },
            ...
            { "floatNet.output[106].useTangent", "TRUE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[107].radius", "-1.000000" },
            { "floatNet.output[107].useTangent", "TRUE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[108].radius", "-1.000000" },
            { "floatNet.output[108].useTangent", "TRUE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[109].radius", "1411.446289" },
            { "floatNet.output[109].useTangent", "FALSE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[110].radius", "2727.242432" },
            { "floatNet.output[110].useTangent", "TRUE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[111].radius", "-1.000000" },
            { "floatNet.output[111].useTangent", "FALSE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_SEPARATE" },
            ...
            { "floatNet.output[112].useTangent", "TRUE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[113].radius", "-1.000000" },
            { "floatNet.output[113].useTangent", "TRUE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_ALIGN" },
            ...
            { "floatNet.output[114].useTangent", "TRUE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[115].radius", "-1.000000" },
            { "floatNet.output[115].useTangent", "FALSE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            ...
            { "floatNet.output[116].useTangent", "TRUE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[117].radius", "850.924561" },
            { "floatNet.output[117].useTangent", "TRUE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_SEPARATE" },
            ...
            { "floatNet.output[119].useTangent", "TRUE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[120].radius", "2963.549072" },
            { "floatNet.output[120].useTangent", "FALSE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[121].radius", "-1.000000" },
            { "floatNet.output[121].useTangent", "FALSE" },
            { "floatNet.output[121].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[122].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[122].radius", "1693.586426" },
            { "floatNet.output[122].useTangent", "FALSE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_ZERO" },
            ...
            { "floatNet.output[123].useTangent", "FALSE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[124].radius", "-1.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
            { "rotateStartingAngle", "FALSE" },
        ...
        NeuralConfigValue configs8[] = {
            ...
            { "floatNet.node[75].inputs", "{}" },
            { "floatNet.node[75].op", "ML_FOP_Nx1_POW_SUM" },
            ...
            { "floatNet.input[0].useTangent", "FALSE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[10].radius", "157.201385" },
            { "floatNet.input[10].useTangent", "FALSE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[11].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[11].radius", "157.342880" },
            { "floatNet.input[11].useTangent", "FALSE" },
            { "floatNet.input[11].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[11].waveType", "NEURAL_WAVE_UNIT_SINE" },
            { "floatNet.input[12].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[12].frequency", "0.000000" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "FALSE" },
            ...
            { "floatNet.input[13].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.input[14].frequency", "0.000000" },
            { "floatNet.input[14].radius", "164.939926" },
            { "floatNet.input[14].useTangent", "TRUE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[14].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.input[15].radius", "156.087997" },
            { "floatNet.input[15].useTangent", "TRUE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[16].frequency", "0.000000" },
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "TRUE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[17].frequency", "4093.644043" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "TRUE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[17].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[18].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[18].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[18].frequency", "0.000000" },
            { "floatNet.input[18].radius", "147.504044" },
            { "floatNet.input[18].useTangent", "TRUE" },
            ...
            { "floatNet.input[18].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[19].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[19].radius", "-1.000000" },
            { "floatNet.input[19].useTangent", "FALSE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[1].radius", "301.750824" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_CROWD" },
            ...
            { "floatNet.input[20].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[21].frequency", "0.000000" },
            { "floatNet.input[21].radius", "-1.000000" },
            { "floatNet.input[21].useTangent", "FALSE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_FORCE" },
            ...
            { "floatNet.input[22].useTangent", "FALSE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_TICK" },
            { "floatNet.input[22].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[23].frequency", "0.000000" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "TRUE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[23].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[24].frequency", "0.000000" },
            { "floatNet.input[24].radius", "1086.721436" },
            { "floatNet.input[24].useTangent", "TRUE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[2].radius", "148.709793" },
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            ...
            { "floatNet.input[3].useTangent", "TRUE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[4].frequency", "5622.903809" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "TRUE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_CROWD" },
            ...
            { "floatNet.input[8].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[9].radius", "154.979477" },
            { "floatNet.input[9].useTangent", "FALSE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_COHERE" },
            ...
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[101].radius", "1351.212036" },
            { "floatNet.output[101].useTangent", "TRUE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_CORES" },
            ...
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "TRUE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_HEADING" },
            ...
            { "floatNet.output[104].useTangent", "FALSE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[105].radius", "278.047913" },
            { "floatNet.output[105].useTangent", "TRUE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[106].radius", "2541.187500" },
            { "floatNet.output[106].useTangent", "TRUE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[107].radius", "-1.000000" },
            { "floatNet.output[107].useTangent", "FALSE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_EDGES" },
            ...
            { "floatNet.output[110].useTangent", "FALSE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[111].radius", "-1.000000" },
            { "floatNet.output[111].useTangent", "FALSE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[112].radius", "312.907501" },
            { "floatNet.output[112].useTangent", "TRUE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[113].radius", "-1.000000" },
            { "floatNet.output[113].useTangent", "TRUE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.output[114].radius", "322.285767" },
            { "floatNet.output[114].useTangent", "TRUE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[115].radius", "-1.000000" },
            { "floatNet.output[115].useTangent", "FALSE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "TRUE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_HEADING" },
            ...
            { "floatNet.output[122].useTangent", "TRUE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[123].radius", "1030.571045" },
            { "floatNet.output[123].useTangent", "TRUE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_HEADING" },
        ...
        NeuralConfigValue configs9[] = {
            ...
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[20].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "TRUE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[20].waveType", "NEURAL_WAVE_FMOD" },
            ...
            { "floatNet.input[22].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[23].frequency", "0.000000" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "TRUE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[23].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[24].frequency", "0.000000" },
            { "floatNet.input[24].radius", "1086.721436" },
            { "floatNet.input[24].useTangent", "FALSE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[2].radius", "148.709793" },
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            ...
            { "floatNet.input[3].radius", "-1.000000" },
            { "floatNet.input[3].useTangent", "TRUE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[4].frequency", "5622.903809" },
            { "floatNet.input[4].radius", "0.000000" },
            ...
            { "floatNet.input[5].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[6].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[6].frequency", "0.000000" },
            { "floatNet.input[6].radius", "-0.950000" },
            { "floatNet.input[6].useTangent", "FALSE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[6].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[7].radius", "4.193549" },
            { "floatNet.input[7].useTangent", "TRUE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_CROWD" },
            ...
            { "floatNet.input[9].useTangent", "FALSE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[100].radius", "529.224609" },
            { "floatNet.output[100].useTangent", "FALSE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_COHERE" },
            ...
            { "floatNet.output[101].useTangent", "FALSE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[102].radius", "167.162323" },
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "TRUE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[104].radius", "1729.684937" },
            { "floatNet.output[104].useTangent", "FALSE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[105].radius", "278.047913" },
            { "floatNet.output[105].useTangent", "TRUE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_EDGES" },
            ...
            { "floatNet.output[106].useTangent", "TRUE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[107].radius", "-1.000000" },
            { "floatNet.output[107].useTangent", "FALSE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_EDGES" },
            ...
            { "floatNet.output[108].useTangent", "TRUE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[109].radius", "1411.446289" },
            { "floatNet.output[109].useTangent", "FALSE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[110].radius", "2727.242432" },
            { "floatNet.output[110].useTangent", "FALSE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[111].radius", "-1.000000" },
            { "floatNet.output[111].useTangent", "TRUE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            ...
            { "floatNet.output[113].useTangent", "TRUE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[114].radius", "322.285767" },
            { "floatNet.output[114].useTangent", "FALSE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[115].radius", "-1.000000" },
            { "floatNet.output[115].useTangent", "TRUE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "FALSE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[117].radius", "850.924561" },
            { "floatNet.output[117].useTangent", "TRUE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            ...
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.output[119].radius", "2850.000000" },
            { "floatNet.output[119].useTangent", "TRUE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[120].radius", "2963.549072" },
            { "floatNet.output[120].useTangent", "TRUE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_ENEMY" },
            ...
            { "floatNet.output[122].useTangent", "FALSE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[123].radius", "1030.571045" },
            { "floatNet.output[123].useTangent", "TRUE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[124].radius", "-1.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
            { "rotateStartingAngle", "FALSE" },
        ...
        NeuralConfigValue configs10[] = {
            ...
            { "floatNet.node[115].op", "ML_FOP_Nx1_POW_SUM" },
            { "floatNet.node[115].params", "{0.000000, }" },
            { "floatNet.node[116].inputs", "{}" },
            { "floatNet.node[116].op", "ML_FOP_3x2_IF_INSIDE_RANGE_ELSE_CONST" },
            { "floatNet.node[116].params", "{0.000000, }" },
            ...
            { "guardRange", "87.259979" },
            { "floatNet.input[0].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[0].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[0].radius", "0.000000" },
            { "floatNet.input[0].useTangent", "FALSE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            ...
            { "floatNet.input[11].waveType", "NEURAL_WAVE_UNIT_SINE" },
            { "floatNet.input[12].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[12].frequency", "0.000000" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "FALSE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[12].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[13].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[13].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[13].frequency", "0.000000" },
            ...
            { "floatNet.input[14].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.input[15].radius", "156.087997" },
            { "floatNet.input[15].useTangent", "FALSE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_ZERO" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[16].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[16].frequency", "0.000000" },
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "FALSE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[17].frequency", "4093.644043" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "FALSE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_FORCE" },
            ...
            { "floatNet.input[18].radius", "147.504044" },
            { "floatNet.input[18].useTangent", "FALSE" },
            { "floatNet.input[18].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[18].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[19].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[19].radius", "144.802826" },
            { "floatNet.input[19].useTangent", "TRUE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[1].radius", "301.750824" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[20].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[20].radius", "-1.000000" },
            { "floatNet.input[20].useTangent", "TRUE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[20].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[21].frequency", "0.000000" },
            { "floatNet.input[21].radius", "-1.000000" },
            { "floatNet.input[21].useTangent", "FALSE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_FORCE" },
            ...
            { "floatNet.input[22].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[22].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.input[23].frequency", "0.000000" },
            { "floatNet.input[23].radius", "-1.000000" },
            { "floatNet.input[23].useTangent", "TRUE" },
            { "floatNet.input[23].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[23].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[24].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[24].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[24].frequency", "0.000000" },
            { "floatNet.input[24].radius", "1086.721436" },
            { "floatNet.input[24].useTangent", "TRUE" },
            { "floatNet.input[24].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[2].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[2].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[2].radius", "148.709793" },
            { "floatNet.input[2].useTangent", "TRUE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[3].radius", "-1.000000" },
            { "floatNet.input[3].useTangent", "FALSE" },
            ...
            { "floatNet.input[4].useTangent", "TRUE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[4].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[5].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[5].frequency", "0.000000" },
            { "floatNet.input[5].radius", "0.000000" },
            { "floatNet.input[5].useTangent", "TRUE" },
            { "floatNet.input[5].valueType", "NEURAL_VALUE_FORCE" },
            ...
            { "floatNet.input[7].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[8].frequency", "0.000000" },
            { "floatNet.input[8].radius", "0.000000" },
            { "floatNet.input[8].useTangent", "TRUE" },
            { "floatNet.input[8].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[8].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[9].radius", "154.979477" },
            { "floatNet.input[9].useTangent", "TRUE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.output[100].radius", "529.224609" },
            { "floatNet.output[100].useTangent", "TRUE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.output[101].radius", "1351.212036" },
            { "floatNet.output[101].useTangent", "FALSE" },
            ...
            { "floatNet.output[104].useTangent", "TRUE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[105].radius", "278.047913" },
            { "floatNet.output[105].useTangent", "TRUE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[106].radius", "2541.187500" },
            { "floatNet.output[106].useTangent", "FALSE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            ...
            { "floatNet.output[111].useTangent", "FALSE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[112].radius", "296.518951" },
            { "floatNet.output[112].useTangent", "FALSE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[113].radius", "-1.000000" },
            { "floatNet.output[113].useTangent", "FALSE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.output[114].radius", "322.285767" },
            { "floatNet.output[114].useTangent", "TRUE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            ...
            { "floatNet.output[115].useTangent", "TRUE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "FALSE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.output[117].radius", "850.924561" },
            { "floatNet.output[117].useTangent", "FALSE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[118].radius", "298.878693" },
            { "floatNet.output[118].useTangent", "FALSE" },
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[119].radius", "2850.000000" },
            { "floatNet.output[119].useTangent", "FALSE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            ...
            { "floatNet.output[122].useTangent", "TRUE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_SEPARATE" },
            { "floatNet.output[123].radius", "1030.571045" },
            { "floatNet.output[123].useTangent", "TRUE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[124].radius", "-1.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
            { "rotateStartingAngle", "TRUE" },
        ...
        NeuralConfigValue configs11[] = {
            ...
            { "floatNet.input[0].radius", "0.000000" },
            { "floatNet.input[0].useTangent", "FALSE" },
            { "floatNet.input[0].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[10].radius", "157.201385" },
            { "floatNet.input[10].useTangent", "FALSE" },
            ...
            { "floatNet.input[11].waveType", "NEURAL_WAVE_UNIT_SINE" },
            { "floatNet.input[12].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[12].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.input[12].frequency", "0.000000" },
            { "floatNet.input[12].radius", "0.000000" },
            { "floatNet.input[12].useTangent", "TRUE" },
            { "floatNet.input[12].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            ...
            { "floatNet.input[13].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[14].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[14].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.input[14].frequency", "0.000000" },
            { "floatNet.input[14].radius", "164.939926" },
            { "floatNet.input[14].useTangent", "FALSE" },
            { "floatNet.input[14].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[14].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[15].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[15].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.input[15].radius", "156.087997" },
            { "floatNet.input[15].useTangent", "FALSE" },
            { "floatNet.input[15].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.input[16].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            ...
            { "floatNet.input[16].radius", "0.000000" },
            { "floatNet.input[16].useTangent", "FALSE" },
            { "floatNet.input[16].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[17].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[17].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[17].frequency", "4093.644043" },
            { "floatNet.input[17].radius", "0.000000" },
            { "floatNet.input[17].useTangent", "FALSE" },
            { "floatNet.input[17].valueType", "NEURAL_VALUE_CROWD" },
            ...
            { "floatNet.input[18].valueType", "NEURAL_VALUE_MOBID" },
            { "floatNet.input[18].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[19].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[19].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.input[19].frequency", "0.000000" },
            { "floatNet.input[19].radius", "144.802826" },
            { "floatNet.input[19].useTangent", "FALSE" },
            { "floatNet.input[19].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[19].waveType", "NEURAL_WAVE_UNIT_SINE" },
            { "floatNet.input[1].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[1].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[1].radius", "301.750824" },
            { "floatNet.input[1].useTangent", "TRUE" },
            { "floatNet.input[1].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[20].crowdType", "NEURAL_CROWD_ENEMY_MISSILE" },
            { "floatNet.input[20].forceType", "NEURAL_FORCE_ENEMY_BASE" },
            { "floatNet.input[20].radius", "0.000000" },
            { "floatNet.input[20].useTangent", "FALSE" },
            { "floatNet.input[20].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[20].waveType", "NEURAL_WAVE_FMOD" },
            { "floatNet.input[21].crowdType", "NEURAL_CROWD_ENEMY_SHIP" },
            { "floatNet.input[21].forceType", "NEURAL_FORCE_ENEMY" },
            { "floatNet.input[21].frequency", "0.000000" },
            { "floatNet.input[21].radius", "-1.000000" },
            { "floatNet.input[21].useTangent", "TRUE" },
            { "floatNet.input[21].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.input[22].radius", "6.802381" },
            { "floatNet.input[22].useTangent", "FALSE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[22].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[23].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[23].forceType", "NEURAL_FORCE_CENTER" },
            { "floatNet.input[23].frequency", "0.000000" },
            ...
            { "floatNet.input[2].useTangent", "FALSE" },
            { "floatNet.input[2].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[3].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[3].forceType", "NEURAL_FORCE_BASE" },
            { "floatNet.input[3].radius", "-1.000000" },
            { "floatNet.input[3].useTangent", "FALSE" },
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_EDGES" },
            { "floatNet.input[4].frequency", "5622.903809" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "FALSE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            { "floatNet.input[4].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[5].crowdType", "NEURAL_CROWD_FRIEND_FIGHTER" },
            { "floatNet.input[5].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.input[5].frequency", "0.000000" },
            { "floatNet.input[5].radius", "0.000000" },
            ...
            { "floatNet.input[5].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[5].waveType", "NEURAL_WAVE_SINE" },
            { "floatNet.input[6].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[6].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[6].frequency", "0.000000" },
            { "floatNet.input[6].radius", "-0.950000" },
            { "floatNet.input[6].useTangent", "FALSE" },
            { "floatNet.input[6].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[6].waveType", "NEURAL_WAVE_NONE" },
            { "floatNet.input[7].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[7].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            { "floatNet.input[7].radius", "4.193549" },
            { "floatNet.input[7].useTangent", "TRUE" },
            { "floatNet.input[7].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[8].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            { "floatNet.input[8].forceType", "NEURAL_FORCE_ENEMY_BASE_GUESS" },
            { "floatNet.input[8].frequency", "0.000000" },
            { "floatNet.input[8].radius", "0.000000" },
            ...
            { "floatNet.input[8].waveType", "NEURAL_WAVE_ABS_SINE" },
            { "floatNet.input[9].crowdType", "NEURAL_CROWD_FRIEND_MISSILE" },
            { "floatNet.input[9].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.input[9].radius", "154.979477" },
            { "floatNet.input[9].useTangent", "TRUE" },
            { "floatNet.input[9].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[100].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[100].radius", "529.224609" },
            { "floatNet.output[100].useTangent", "TRUE" },
            { "floatNet.output[100].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[101].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[101].radius", "1351.212036" },
            { "floatNet.output[101].useTangent", "FALSE" },
            { "floatNet.output[101].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[102].forceType", "NEURAL_FORCE_SEPARATE" },
            ...
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_CORNERS" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "FALSE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_ENEMY" },
            ...
            { "floatNet.output[104].useTangent", "FALSE" },
            { "floatNet.output[104].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[105].forceType", "NEURAL_FORCE_NEAREST_FRIEND_MISSILE" },
            { "floatNet.output[105].radius", "278.047913" },
            { "floatNet.output[105].useTangent", "FALSE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_ALIGN" },
            ...
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[108].radius", "-0.950000" },
            { "floatNet.output[108].useTangent", "FALSE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[109].radius", "1411.446289" },
            { "floatNet.output[109].useTangent", "FALSE" },
            { "floatNet.output[109].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[110].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[110].radius", "2590.880371" },
            { "floatNet.output[110].useTangent", "FALSE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[111].radius", "151.967468" },
            { "floatNet.output[111].useTangent", "TRUE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[112].radius", "296.518951" },
            { "floatNet.output[112].useTangent", "FALSE" },
            { "floatNet.output[112].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[113].forceType", "NEURAL_FORCE_ZERO" },
            { "floatNet.output[113].radius", "-1.000000" },
            { "floatNet.output[113].useTangent", "TRUE" },
            { "floatNet.output[113].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[114].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[114].radius", "322.285767" },
            { "floatNet.output[114].useTangent", "FALSE" },
            { "floatNet.output[114].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[115].forceType", "NEURAL_FORCE_HEADING" },
            { "floatNet.output[115].radius", "-1.000000" },
            { "floatNet.output[115].useTangent", "FALSE" },
            { "floatNet.output[115].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[116].forceType", "NEURAL_FORCE_CORES" },
            { "floatNet.output[116].radius", "0.000000" },
            { "floatNet.output[116].useTangent", "TRUE" },
            { "floatNet.output[116].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[117].forceType", "NEURAL_FORCE_COHERE" },
            { "floatNet.output[117].radius", "1002.034180" },
            { "floatNet.output[117].useTangent", "TRUE" },
            { "floatNet.output[117].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[118].forceType", "NEURAL_FORCE_ENEMY_MISSILE" },
            { "floatNet.output[118].radius", "298.878693" },
            ...
            { "floatNet.output[119].useTangent", "FALSE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            { "floatNet.output[120].radius", "2963.549072" },
            { "floatNet.output[120].useTangent", "FALSE" },
            { "floatNet.output[120].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[121].forceType", "NEURAL_FORCE_ENEMY" },
            ...
            { "floatNet.output[121].useTangent", "FALSE" },
            { "floatNet.output[121].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[122].forceType", "NEURAL_FORCE_ENEMY_COHERE" },
            { "floatNet.output[122].radius", "1693.586426" },
            { "floatNet.output[122].useTangent", "FALSE" },
            { "floatNet.output[122].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[123].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            ...
            { "floatNet.output[123].useTangent", "FALSE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_ALIGN" },
            { "floatNet.output[124].radius", "-1.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
            { "rotateStartingAngle", "TRUE" },
        ...
        NeuralConfigValue configs12[] = {
            ...
            { "floatNet.input[0].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[10].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[10].forceType", "NEURAL_FORCE_ALIGN2" },
            { "floatNet.input[10].radius", "157.201385" },
            { "floatNet.input[10].useTangent", "FALSE" },
            { "floatNet.input[10].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[11].crowdType", "NEURAL_CROWD_BASE_ENEMY_SHIP" },
            ...
            { "floatNet.input[21].valueType", "NEURAL_VALUE_CROWD" },
            { "floatNet.input[22].crowdType", "NEURAL_CROWD_CORES" },
            { "floatNet.input[22].forceType", "NEURAL_FORCE_ALIGN2" },
            { "floatNet.input[22].radius", "6.802381" },
            { "floatNet.input[22].useTangent", "FALSE" },
            { "floatNet.input[22].valueType", "NEURAL_VALUE_FRIEND_SHIPS" },
            { "floatNet.input[22].waveType", "NEURAL_WAVE_NONE" },
            ...
            { "floatNet.input[3].valueType", "NEURAL_VALUE_CREDITS" },
            { "floatNet.input[4].crowdType", "NEURAL_CROWD_BASE_FRIEND_SHIP" },
            { "floatNet.input[4].forceType", "NEURAL_FORCE_NEAREST_EDGE" },
            { "floatNet.input[4].frequency", "5622.903809" },
            { "floatNet.input[4].radius", "0.000000" },
            { "floatNet.input[4].useTangent", "FALSE" },
            { "floatNet.input[4].valueType", "NEURAL_VALUE_RANDOM_UNIT" },
            ...
            { "floatNet.output[102].useTangent", "FALSE" },
            { "floatNet.output[102].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[103].forceType", "NEURAL_FORCE_NEAREST_CORNER" },
            { "floatNet.output[103].radius", "-1.000000" },
            { "floatNet.output[103].useTangent", "FALSE" },
            { "floatNet.output[103].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[104].forceType", "NEURAL_FORCE_ENEMY" },
            ...
            { "floatNet.output[105].useTangent", "FALSE" },
            { "floatNet.output[105].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[106].forceType", "NEURAL_FORCE_ALIGN2" },
            { "floatNet.output[106].radius", "2541.187500" },
            { "floatNet.output[106].useTangent", "FALSE" },
            { "floatNet.output[106].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[107].forceType", "NEURAL_FORCE_BASE_DEFENSE" },
            ...
            { "floatNet.output[107].useTangent", "TRUE" },
            { "floatNet.output[107].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[108].forceType", "NEURAL_FORCE_ALIGN2" },
            { "floatNet.output[108].radius", "-0.950000" },
            { "floatNet.output[108].useTangent", "FALSE" },
            { "floatNet.output[108].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[109].forceType", "NEURAL_FORCE_HEADING" },
            ...
            { "floatNet.output[110].useTangent", "FALSE" },
            { "floatNet.output[110].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[111].forceType", "NEURAL_FORCE_ALIGN2" },
            { "floatNet.output[111].radius", "151.967468" },
            { "floatNet.output[111].useTangent", "TRUE" },
            { "floatNet.output[111].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[112].forceType", "NEURAL_FORCE_HEADING" },
            ...
            { "floatNet.output[118].useTangent", "FALSE" },
            { "floatNet.output[118].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[119].forceType", "NEURAL_FORCE_ALIGN2" },
            { "floatNet.output[119].radius", "2850.000000" },
            { "floatNet.output[119].useTangent", "FALSE" },
            { "floatNet.output[119].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[120].forceType", "NEURAL_FORCE_NEAREST_FRIEND" },
            ...
            { "floatNet.output[123].useTangent", "FALSE" },
            { "floatNet.output[123].valueType", "NEURAL_VALUE_FORCE" },
            { "floatNet.output[124].forceType", "NEURAL_FORCE_ALIGN2" },
            { "floatNet.output[124].radius", "-1.000000" },
            { "floatNet.output[124].useTangent", "FALSE" },
            { "floatNet.output[124].valueType", "NEURAL_VALUE_FORCE" },
            { "sensorGrid.staleCoreTime", "0.000000" },
