                          ...
                          uint32 mpSize, uint32 *mpIndex)
{
     ...
     */
    if (method == doSimple) {
        targetPlayers[*tpIndex].aiType = FLEET_AI_FLOCK5;
        targetPlayers[*tpIndex].playerName = "FlockFleet5Test";
...
static void MainMutateParams(FleetAIType aiType, MBRegistry *mreg)
{
    if (aiType == FLEET_AI_FLOCK4 ||
        ...
        MainMutationFParams vf[] = {
            ...
            { "centerRadius",          0.0f, 900.0f, 0.05f, 0.05f, 0.10f},
            { "centerWeight",         -0.1f,   0.1f, 0.05f, 0.05f, 0.10f},

            { "coresRadius",           0.0f, 900.0f, 0.05f, 0.05f, 0.05f},
            { "coresWeight",          -1.0f,   1.0f, 0.05f, 0.05f, 0.05f},
