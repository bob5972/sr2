...
typedef enum SpriteSet {
    ...
    SPRITE_SET_URSA_BLUE,
    SPRITE_SET_URSA_BLUE2,
    SPRITE_SET_URSA_PURPLE,
    SPRITE_SET_URSA_PURPLE2,
    SPRITE_SET_URSA_PINK,
    SPRITE_SET_URSA_PINK2,
    SPRITE_SET_URSA_ORANGE,
    SPRITE_SET_URSA_GREEN,
    SPRITE_SET_URSA_GREEN2,
    SPRITE_SET_URSA_GREEN3,
    SPRITE_SET_URSA_BLUE3,
    SPRITE_SET_URSA_MAGENTA,
    SPRITE_SET_URSA_RED,
    SPRITE_SET_URSA_ORANGE2,
