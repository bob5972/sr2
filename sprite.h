...
typedef enum SpriteSet {
    ...
    SPRITE_SET_ALTAIR_PURPLE,
    SPRITE_SET_ALTAIR_PURPLE2,
    SPRITE_SET_ALTAIR_YELLOW,
    SPRITE_SET_ALTAIR_RED2,
    SPRITE_SET_ALTAIR_GREEN,
    SPRITE_SET_ALTAIR_GREEN2,
    SPRITE_SET_ALTAIR_BLUE,
    SPRITE_SET_ALTAIR_BLUE2,
    SPRITE_SET_ALTAIR_MAGENTA,
    SPRITE_SET_ALTAIR_RED,
    SPRITE_SET_ALTAIR_RED3,
    SPRITE_SET_ALTAIR_GREEN3,
    SPRITE_SET_ALTAIR_ORANGE,
    SPRITE_SET_ALTAIR_ORANGE2,
    SPRITE_SET_ALTAIR_YELLOW2,
