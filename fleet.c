...
static const FleetAIType gRankings[] = {
    ...
    FLEET_AI_CLOUD,     //  2.2%
    FLEET_AI_MAPPER,    //  2.3%
    FLEET_AI_RUNAWAY,   //  8.1%
    FLEET_AI_COWARD,    // 10.3%
    FLEET_AI_BUNDLE1,   // 18.5%
    FLEET_AI_BUNDLE8,   // 21.6%
    FLEET_AI_BUNDLE7,   // 21.9%
    FLEET_AI_BUNDLE4,   // 22.0%
    FLEET_AI_CIRCLE,    // 24.0%
    FLEET_AI_FLOCK1,    // 24.2%
    FLEET_AI_BASIC,     // 27.7%
    FLEET_AI_BUNDLE6,   // 28.8%
    FLEET_AI_BUNDLE5,   // 32.4%
    FLEET_AI_NEURAL4,   // 32.7%
    FLEET_AI_BUNDLE2,   // 33.3%
    FLEET_AI_NEURAL2,   // 35.9%
    FLEET_AI_FLOCK2,    // 38.0%
    FLEET_AI_NEURAL3,   // 38.0%
    FLEET_AI_BUNDLE9,   // 41.6%
    FLEET_AI_BUNDLE3,   // 45.2%
    FLEET_AI_HOLD,      // 46.7%
    FLEET_AI_NEURAL1,   // 46.8%
    FLEET_AI_BUNDLE10,  // 51.4%
    FLEET_AI_META,      // 55.1%
    FLEET_AI_BUNDLE11,  // 58.1%
    FLEET_AI_BUNDLE13,  // 60.6%
    FLEET_AI_NEURAL6,   // 60.9%
    FLEET_AI_NEURAL5,   // 60.9%
    FLEET_AI_BUNDLE14,  // 61.4%
    FLEET_AI_FLOCK4,    // 63.9%
    FLEET_AI_NEURAL8,   // 67.5%
    FLEET_AI_NEURAL10,  // 68.6%
    FLEET_AI_FLOCK5,    // 70.0%
    FLEET_AI_FLOCK3,    // 70.7%
    FLEET_AI_NEURAL9,   // 71.4%
    FLEET_AI_NEURAL7,   // 72.1%
    FLEET_AI_BUNDLE12,  // 75.6%
    FLEET_AI_FLOCK6,    // 75.8%
    FLEET_AI_FLOCK7,    // 77.8%
    FLEET_AI_NEURAL12,  // 78.1%
    FLEET_AI_NEURAL11,  // 79.5%
    FLEET_AI_BUNDLE16,  // 81.8%
    FLEET_AI_BINEURAL1, // 82.1%
    FLEET_AI_FLOCK8,    // 82.3%
    FLEET_AI_BUNDLE15,  // 83.4%
    FLEET_AI_BINEURAL2, // 83.9%
    FLEET_AI_FLOCK9,    // 92.5%
    FLEET_AI_BINEURAL3, // Unranked
    FLEET_AI_BINEURAL4, // Unranked
};
...
{
    if (aiType >= FLEET_AI_NEURAL1 && aiType <= FLEET_AI_NEURAL12) {
        return TRUE;
    }
    return FALSE;
}
