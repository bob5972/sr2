...
public:
    ...
    void putDefaults(MBRegistry *mreg, FleetAIType aiType) {
        ...
        BundleConfigValue configs5[] = {
            ...
            { "align.crowd.radius.periodic.amplitude.value", "0.122731" },
            { "align.crowd.radius.periodic.period.mobJitterScale", "-0.751439" },
            { "align.crowd.radius.periodic.period.value", "8683.955078" },
            { "align.crowd.radius.periodic.tickShift.mobJitterScale", "0.376637" },
            { "align.crowd.radius.periodic.tickShift.value", "15.725204" },
            { "align.crowd.radius.value.mobJitterScale", "-0.900000" },
            { "align.crowd.radius.value.value", "1026.403320" },
            { "align.crowd.size.periodic.amplitude.mobJitterScale", "-0.651726" },
            { "align.crowd.size.periodic.amplitude.value", "0.602157" },
            { "align.crowd.size.periodic.period.mobJitterScale", "-0.186423" },
            { "align.crowd.size.periodic.period.value", "7993.830566" },
            { "align.crowd.size.periodic.tickShift.mobJitterScale", "-0.252465" },
            { "align.crowd.size.periodic.tickShift.value", "2531.738770" },
            { "align.crowd.size.value.mobJitterScale", "0.068867" },
            { "align.crowd.size.value.value", "10.558844" },
            { "align.crowd.size.valueType", "periodic" },
            { "align.radius.periodic.amplitude.mobJitterScale", "-0.365437" },
            { "align.radius.periodic.amplitude.value", "0.217860" },
            { "align.radius.periodic.period.mobJitterScale", "-0.215525" },
            { "align.radius.periodic.period.value", "4468.025879" },
            { "align.radius.periodic.tickShift.mobJitterScale", "-0.432457" },
            { "align.radius.periodic.tickShift.value", "3890.056396" },
            { "align.radius.value.mobJitterScale", "-0.410328" },
            { "align.radius.value.value", "669.974304" },
            { "align.radius.valueType", "periodic" },
            { "align.rangeType", "quadraticDown" },
            { "align.weight.periodic.amplitude.mobJitterScale", "-0.962766" },
            { "align.weight.periodic.amplitude.value", "0.221791" },
            { "align.weight.periodic.period.mobJitterScale", "-0.813709" },
            { "align.weight.periodic.period.value", "6574.039062" },
            { "align.weight.periodic.tickShift.mobJitterScale", "0.067380" },
            { "align.weight.periodic.tickShift.value", "3052.066162" },
            { "align.weight.value.mobJitterScale", "0.207647" },
            { "align.weight.value.value", "-5.250550" },
            { "align.weight.valueType", "constant" },
            { "attackRange", "186.650711" },
            { "attackSeparate.crowd.radius.periodic.amplitude.mobJitterScale", "0.685209" },
            { "attackSeparate.crowd.radius.periodic.amplitude.value", "-1.000000" },
            { "attackSeparate.crowd.radius.periodic.period.mobJitterScale", "0.636034" },
            { "attackSeparate.crowd.radius.periodic.period.value", "-1.000000" },
            { "attackSeparate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.335412" },
            { "attackSeparate.crowd.radius.periodic.tickShift.value", "6020.559570" },
            { "attackSeparate.crowd.radius.value.mobJitterScale", "0.555896" },
            { "attackSeparate.crowd.radius.value.value", "141.919769" },
            { "attackSeparate.crowd.radius.valueType", "periodic" },
            { "attackSeparate.crowd.size.periodic.amplitude.mobJitterScale", "-0.929466" },
            { "attackSeparate.crowd.size.periodic.amplitude.value", "0.778532" },
            { "attackSeparate.crowd.size.periodic.period.mobJitterScale", "0.509078" },
            { "attackSeparate.crowd.size.periodic.period.value", "5382.154297" },
            { "attackSeparate.crowd.size.periodic.tickShift.mobJitterScale", "0.079664" },
            { "attackSeparate.crowd.size.periodic.tickShift.value", "3858.968018" },
            { "attackSeparate.crowd.size.value.mobJitterScale", "0.360540" },
            { "attackSeparate.crowd.size.value.value", "8.487959" },
            { "attackSeparate.crowdType", "strictOff" },
            { "attackSeparate.radius.periodic.amplitude.mobJitterScale", "0.854036" },
            { "attackSeparate.radius.periodic.amplitude.value", "-0.435201" },
            { "attackSeparate.radius.periodic.period.mobJitterScale", "0.549149" },
            { "attackSeparate.radius.periodic.period.value", "2342.196289" },
            { "attackSeparate.radius.periodic.tickShift.mobJitterScale", "0.976031" },
            { "attackSeparate.radius.periodic.tickShift.value", "3853.916016" },
            { "attackSeparate.radius.value.mobJitterScale", "-0.311289" },
            { "attackSeparate.radius.value.value", "1224.508301" },
            { "attackSeparate.radius.valueType", "periodic" },
            { "attackSeparate.weight.periodic.amplitude.mobJitterScale", "0.342855" },
            { "attackSeparate.weight.periodic.amplitude.value", "0.109965" },
            { "attackSeparate.weight.periodic.period.mobJitterScale", "-0.520496" },
            { "attackSeparate.weight.periodic.period.value", "3603.733398" },
            { "attackSeparate.weight.periodic.tickShift.mobJitterScale", "-0.001839" },
            { "attackSeparate.weight.periodic.tickShift.value", "8771.796875" },
            { "attackSeparate.weight.value.mobJitterScale", "0.770895" },
            { "attackSeparate.weight.value.value", "6.946533" },
            { "base.crowd.radius.periodic.amplitude.mobJitterScale", "0.900000" },
            { "base.crowd.radius.periodic.amplitude.value", "-1.000000" },
            { "base.crowd.radius.periodic.period.mobJitterScale", "-0.106534" },
            { "base.crowd.radius.periodic.period.value", "50.968925" },
            { "base.crowd.radius.periodic.tickShift.mobJitterScale", "-0.875444" },
            { "base.crowd.radius.periodic.tickShift.value", "-1.000000" },
            { "base.crowd.radius.value.mobJitterScale", "-0.299624" },
            { "base.crowd.radius.value.value", "1981.176636" },
            { "base.crowd.size.periodic.amplitude.mobJitterScale", "-0.077413" },
            { "base.crowd.size.periodic.amplitude.value", "0.814553" },
            { "base.crowd.size.periodic.period.mobJitterScale", "-0.519880" },
            { "base.crowd.size.periodic.period.value", "5310.315430" },
            { "base.crowd.size.periodic.tickShift.mobJitterScale", "-0.444484" },
            { "base.crowd.size.periodic.tickShift.value", "7894.571777" },
            { "base.crowd.size.value.mobJitterScale", "0.020357" },
            { "base.crowd.size.value.value", "3.276221" },
            { "base.crowd.size.valueType", "periodic" },
            { "base.radius.periodic.amplitude.mobJitterScale", "-0.067425" },
            { "base.radius.periodic.amplitude.value", "-0.787608" },
            { "base.radius.periodic.period.mobJitterScale", "-0.681077" },
            { "base.radius.periodic.period.value", "8650.042969" },
            { "base.radius.periodic.tickShift.mobJitterScale", "0.624227" },
            { "base.radius.periodic.tickShift.value", "10000.000000" },
            { "base.radius.value.mobJitterScale", "-0.365797" },
            { "base.radius.value.value", "805.126282" },
            { "base.radius.valueType", "constant" },
            { "base.rangeType", "quadraticDown" },
            { "base.weight.periodic.amplitude.mobJitterScale", "-0.039369" },
            { "base.weight.periodic.amplitude.value", "0.838347" },
            { "base.weight.periodic.period.mobJitterScale", "-0.842128" },
            { "base.weight.periodic.period.value", "5700.625488" },
            { "base.weight.periodic.tickShift.mobJitterScale", "-0.327630" },
            { "base.weight.periodic.tickShift.value", "7991.454590" },
            { "base.weight.value.mobJitterScale", "0.635278" },
            { "base.weight.value.value", "-2.922077" },
            { "base.weight.valueType", "periodic" },
            { "baseDefense.crowd.radius.periodic.amplitude.mobJitterScale", "0.341819" },
            { "baseDefense.crowd.radius.periodic.amplitude.value", "-0.586899" },
            { "baseDefense.crowd.radius.periodic.period.mobJitterScale", "1.000000" },
            { "baseDefense.crowd.radius.periodic.period.value", "4459.477539" },
            { "baseDefense.crowd.radius.periodic.tickShift.mobJitterScale", "-0.046811" },
            { "baseDefense.crowd.radius.periodic.tickShift.value", "5201.296875" },
            { "baseDefense.crowd.radius.value.mobJitterScale", "0.488250" },
            { "baseDefense.crowd.radius.value.value", "325.400604" },
            { "baseDefense.crowd.size.periodic.amplitude.mobJitterScale", "0.522119" },
            { "baseDefense.crowd.size.periodic.amplitude.value", "-0.675070" },
            { "baseDefense.crowd.size.periodic.period.mobJitterScale", "0.683198" },
            { "baseDefense.crowd.size.periodic.period.value", "5750.467285" },
            { "baseDefense.crowd.size.periodic.tickShift.mobJitterScale", "0.356567" },
            { "baseDefense.crowd.size.periodic.tickShift.value", "5716.159180" },
            { "baseDefense.crowd.size.value.mobJitterScale", "0.542759" },
            { "baseDefense.crowd.size.value.value", "6.269723" },
            { "baseDefense.crowd.size.valueType", "constant" },
            { "baseDefense.crowdType", "quadraticDown" },
            { "baseDefense.radius.periodic.amplitude.mobJitterScale", "0.075007" },
            { "baseDefense.radius.periodic.amplitude.value", "0.076784" },
            { "baseDefense.radius.periodic.period.mobJitterScale", "-0.065090" },
            { "baseDefense.radius.periodic.period.value", "686.932861" },
            { "baseDefense.radius.periodic.tickShift.mobJitterScale", "-0.810000" },
            { "baseDefense.radius.periodic.tickShift.value", "4109.527832" },
            { "baseDefense.radius.value.mobJitterScale", "0.264441" },
            { "baseDefense.radius.value.value", "1277.119507" },
            { "baseDefense.radius.valueType", "constant" },
            { "baseDefense.rangeType", "linearDown" },
            { "baseDefense.weight.periodic.amplitude.mobJitterScale", "-0.268884" },
            { "baseDefense.weight.periodic.amplitude.value", "0.328657" },
            { "baseDefense.weight.periodic.period.mobJitterScale", "-0.078686" },
            { "baseDefense.weight.periodic.period.value", "5694.143555" },
            { "baseDefense.weight.periodic.tickShift.mobJitterScale", "1.000000" },
            { "baseDefense.weight.periodic.tickShift.value", "1835.578003" },
            { "baseDefense.weight.value.mobJitterScale", "0.758176" },
            { "baseDefense.weight.value.value", "-3.552660" },
            { "baseDefense.weight.valueType", "periodic" },
            { "center.crowd.radius.periodic.amplitude.mobJitterScale", "0.624732" },
            { "center.crowd.radius.periodic.amplitude.value", "0.111164" },
            { "center.crowd.radius.periodic.period.mobJitterScale", "-0.817455" },
            { "center.crowd.radius.periodic.period.value", "7957.036621" },
            { "center.crowd.radius.periodic.tickShift.mobJitterScale", "0.128368" },
            { "center.crowd.radius.periodic.tickShift.value", "5334.335938" },
            { "center.crowd.radius.value.mobJitterScale", "-0.675457" },
            { "center.crowd.radius.value.value", "1792.022095" },
            { "center.crowd.radius.valueType", "periodic" },
            { "center.crowd.size.periodic.amplitude.mobJitterScale", "0.892136" },
            { "center.crowd.size.periodic.amplitude.value", "-0.866147" },
            { "center.crowd.size.periodic.period.mobJitterScale", "-0.504432" },
            { "center.crowd.size.periodic.period.value", "5002.157227" },
            { "center.crowd.size.periodic.tickShift.mobJitterScale", "0.186978" },
            { "center.crowd.size.periodic.tickShift.value", "992.401978" },
            { "center.crowd.size.value.mobJitterScale", "-0.602209" },
            { "center.crowd.size.value.value", "-0.714033" },
            { "center.crowd.size.valueType", "constant" },
            { "center.crowdType", "strictOn" },
            { "center.radius.periodic.amplitude.mobJitterScale", "0.126219" },
            { "center.radius.periodic.amplitude.value", "0.738236" },
            { "center.radius.periodic.period.mobJitterScale", "0.675488" },
            { "center.radius.periodic.period.value", "3932.560791" },
            { "center.radius.periodic.tickShift.mobJitterScale", "-0.481233" },
            { "center.radius.periodic.tickShift.value", "3891.710205" },
            { "center.radius.value.mobJitterScale", "-0.032453" },
            { "center.radius.value.value", "442.723816" },
            { "center.radius.valueType", "constant" },
            { "center.rangeType", "strictOn" },
            { "center.weight.periodic.amplitude.mobJitterScale", "0.401055" },
            { "center.weight.periodic.amplitude.value", "1.000000" },
            { "center.weight.periodic.period.mobJitterScale", "-1.000000" },
            { "center.weight.periodic.period.value", "7571.628418" },
            { "center.weight.periodic.tickShift.mobJitterScale", "-0.147375" },
            { "center.weight.periodic.tickShift.value", "6851.072266" },
            { "center.weight.value.mobJitterScale", "0.787976" },
            { "center.weight.value.value", "-10.000000" },
            { "center.weight.valueType", "periodic" },
            { "cohere.crowd.radius.periodic.amplitude.mobJitterScale", "0.596174" },
            { "cohere.crowd.radius.periodic.amplitude.value", "0.060823" },
            { "cohere.crowd.radius.periodic.period.mobJitterScale", "-0.656032" },
            { "cohere.crowd.radius.periodic.period.value", "5780.582520" },
            { "cohere.crowd.radius.periodic.tickShift.mobJitterScale", "0.151504" },
            { "cohere.crowd.radius.periodic.tickShift.value", "1399.153442" },
            { "cohere.crowd.radius.value.mobJitterScale", "0.082184" },
            { "cohere.crowd.radius.value.value", "1101.157349" },
            { "cohere.crowd.size.periodic.amplitude.mobJitterScale", "-0.297980" },
            { "cohere.crowd.size.periodic.amplitude.value", "1.000000" },
            { "cohere.crowd.size.periodic.period.mobJitterScale", "0.734525" },
            { "cohere.crowd.size.periodic.period.value", "6350.357910" },
            { "cohere.crowd.size.periodic.tickShift.mobJitterScale", "-0.630623" },
            { "cohere.crowd.size.periodic.tickShift.value", "6347.559082" },
            { "cohere.crowd.size.value.mobJitterScale", "-0.200226" },
            { "cohere.crowd.size.value.value", "12.889885" },
            { "cohere.crowdType", "always" },
            { "cohere.radius.periodic.amplitude.mobJitterScale", "-0.805627" },
            { "cohere.radius.periodic.amplitude.value", "0.576194" },
            { "cohere.radius.periodic.period.mobJitterScale", "0.543748" },
            { "cohere.radius.periodic.period.value", "2916.622070" },
            { "cohere.radius.periodic.tickShift.mobJitterScale", "-0.632045" },
            { "cohere.radius.periodic.tickShift.value", "6569.726074" },
            { "cohere.radius.value.mobJitterScale", "0.038626" },
            { "cohere.radius.value.value", "1332.168457" },
            { "cohere.radius.valueType", "constant" },
            { "cohere.weight.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "cohere.weight.periodic.amplitude.value", "-0.342388" },
            { "cohere.weight.periodic.period.mobJitterScale", "0.782945" },
            { "cohere.weight.periodic.period.value", "6795.334473" },
            { "cohere.weight.periodic.tickShift.mobJitterScale", "0.574161" },
            { "cohere.weight.periodic.tickShift.value", "1586.304321" },
            { "cohere.weight.value.mobJitterScale", "0.195610" },
            { "cohere.weight.value.value", "-5.601663" },
            { "cohere.weight.valueType", "periodic" },
            { "cores.crowd.radius.periodic.amplitude.mobJitterScale", "-0.690545" },
            { "cores.crowd.radius.periodic.amplitude.value", "-0.094207" },
            { "cores.crowd.radius.periodic.period.mobJitterScale", "-0.425457" },
            { "cores.crowd.radius.periodic.period.value", "8939.181641" },
            { "cores.crowd.radius.periodic.tickShift.mobJitterScale", "-0.781051" },
            { "cores.crowd.radius.periodic.tickShift.value", "1215.954834" },
            { "cores.crowd.radius.value.mobJitterScale", "-0.666945" },
            { "cores.crowd.radius.value.value", "604.010925" },
            { "cores.crowd.radius.valueType", "constant" },
            { "cores.crowd.size.periodic.amplitude.mobJitterScale", "0.435909" },
            { "cores.crowd.size.periodic.amplitude.value", "-0.438174" },
            { "cores.crowd.size.periodic.period.mobJitterScale", "0.876587" },
            { "cores.crowd.size.periodic.period.value", "207.358261" },
            { "cores.crowd.size.periodic.tickShift.mobJitterScale", "0.354781" },
            { "cores.crowd.size.periodic.tickShift.value", "5046.608887" },
            { "cores.crowd.size.value.mobJitterScale", "-0.463476" },
            { "cores.crowd.size.value.value", "2.710378" },
            { "cores.radius.periodic.amplitude.mobJitterScale", "1.000000" },
            { "cores.radius.periodic.amplitude.value", "-0.322385" },
            { "cores.radius.periodic.period.mobJitterScale", "-0.900000" },
            { "cores.radius.periodic.period.value", "6644.359375" },
            { "cores.radius.periodic.tickShift.mobJitterScale", "0.192949" },
            { "cores.radius.periodic.tickShift.value", "6309.586426" },
            { "cores.radius.value.mobJitterScale", "-0.933292" },
            { "cores.radius.value.value", "1659.406616" },
            { "cores.radius.valueType", "periodic" },
            { "cores.rangeType", "always" },
            { "cores.weight.periodic.amplitude.mobJitterScale", "-0.402196" },
            { "cores.weight.periodic.amplitude.value", "-0.335926" },
            { "cores.weight.periodic.period.mobJitterScale", "-0.900000" },
            { "cores.weight.periodic.period.value", "2859.510254" },
            { "cores.weight.periodic.tickShift.mobJitterScale", "0.333280" },
            { "cores.weight.periodic.tickShift.value", "8161.643555" },
            { "cores.weight.value.mobJitterScale", "0.411679" },
            { "cores.weight.value.value", "2.285540" },
            { "cores.weight.valueType", "constant" },
            { "corners.crowd.radius.periodic.amplitude.mobJitterScale", "0.564000" },
            { "corners.crowd.radius.periodic.amplitude.value", "-0.909120" },
            { "corners.crowd.radius.periodic.period.mobJitterScale", "0.200112" },
            { "corners.crowd.radius.periodic.period.value", "9062.220703" },
            { "corners.crowd.radius.periodic.tickShift.mobJitterScale", "0.624735" },
            { "corners.crowd.radius.periodic.tickShift.value", "-1.000000" },
            { "corners.crowd.radius.value.mobJitterScale", "-1.000000" },
            { "corners.crowd.radius.value.value", "398.345184" },
            { "corners.crowd.radius.valueType", "periodic" },
            { "corners.crowd.size.periodic.amplitude.mobJitterScale", "-0.794669" },
            { "corners.crowd.size.periodic.amplitude.value", "0.167759" },
            { "corners.crowd.size.periodic.period.mobJitterScale", "-0.173465" },
            { "corners.crowd.size.periodic.period.value", "6124.559570" },
            { "corners.crowd.size.periodic.tickShift.mobJitterScale", "-1.000000" },
            { "corners.crowd.size.periodic.tickShift.value", "4048.147461" },
            { "corners.crowd.size.value.mobJitterScale", "-0.434997" },
            { "corners.crowd.size.value.value", "3.197161" },
            { "corners.crowd.size.valueType", "constant" },
            { "corners.radius.periodic.amplitude.mobJitterScale", "0.135906" },
            { "corners.radius.periodic.amplitude.value", "0.413320" },
            { "corners.radius.periodic.period.mobJitterScale", "-0.911937" },
            { "corners.radius.periodic.period.value", "10000.000000" },
            { "corners.radius.periodic.tickShift.mobJitterScale", "-0.911747" },
            { "corners.radius.periodic.tickShift.value", "5933.346680" },
            { "corners.radius.value.mobJitterScale", "-0.637671" },
            { "corners.radius.value.value", "497.262360" },
            { "corners.weight.periodic.amplitude.mobJitterScale", "-0.584571" },
            { "corners.weight.periodic.amplitude.value", "-0.257665" },
            { "corners.weight.periodic.period.mobJitterScale", "-0.010920" },
            { "corners.weight.periodic.period.value", "3081.316895" },
            { "corners.weight.periodic.tickShift.mobJitterScale", "0.790126" },
            { "corners.weight.periodic.tickShift.value", "3030.024414" },
            { "corners.weight.value.mobJitterScale", "0.027276" },
            { "corners.weight.value.value", "3.550147" },
            ...
            { "curHeadingWeight.periodic.period.mobJitterScale", "0.398824" },
            { "curHeadingWeight.periodic.period.value", "2449.127686" },
            { "curHeadingWeight.periodic.tickShift.mobJitterScale", "-0.411993" },
            { "curHeadingWeight.periodic.tickShift.value", "7524.051270" },
            { "curHeadingWeight.value.mobJitterScale", "0.525151" },
            { "curHeadingWeight.value.value", "0.875147" },
            { "edges.crowd.radius.periodic.amplitude.mobJitterScale", "0.378371" },
            { "edges.crowd.radius.periodic.amplitude.value", "0.757712" },
            { "edges.crowd.radius.periodic.period.mobJitterScale", "-0.530516" },
            { "edges.crowd.radius.periodic.period.value", "9952.199219" },
            { "edges.crowd.radius.periodic.tickShift.mobJitterScale", "0.855316" },
            { "edges.crowd.radius.periodic.tickShift.value", "10000.000000" },
            { "edges.crowd.radius.value.mobJitterScale", "0.819361" },
            { "edges.crowd.radius.value.value", "483.565063" },
            { "edges.crowd.size.periodic.amplitude.mobJitterScale", "-0.668091" },
            { "edges.crowd.size.periodic.amplitude.value", "-0.734565" },
            { "edges.crowd.size.periodic.period.mobJitterScale", "0.495603" },
            { "edges.crowd.size.periodic.period.value", "6883.020996" },
            { "edges.crowd.size.periodic.tickShift.mobJitterScale", "1.000000" },
            { "edges.crowd.size.periodic.tickShift.value", "4143.883301" },
            { "edges.crowd.size.value.mobJitterScale", "-0.427208" },
            { "edges.crowd.size.value.value", "8.595836" },
            { "edges.radius.periodic.amplitude.mobJitterScale", "-0.509654" },
            { "edges.radius.periodic.amplitude.value", "0.190635" },
            { "edges.radius.periodic.period.mobJitterScale", "-0.788818" },
            { "edges.radius.periodic.period.value", "5693.668457" },
            { "edges.radius.periodic.tickShift.mobJitterScale", "0.808157" },
            { "edges.radius.periodic.tickShift.value", "4041.212158" },
            { "edges.radius.value.mobJitterScale", "0.805793" },
            { "edges.radius.value.value", "1517.207642" },
            { "edges.radius.valueType", "constant" },
            { "edges.weight.periodic.amplitude.mobJitterScale", "-0.662456" },
            { "edges.weight.periodic.amplitude.value", "0.679696" },
            { "edges.weight.periodic.period.mobJitterScale", "-0.360581" },
            { "edges.weight.periodic.period.value", "1333.224609" },
            { "edges.weight.periodic.tickShift.mobJitterScale", "0.199602" },
            { "edges.weight.periodic.tickShift.value", "3843.356934" },
            { "edges.weight.value.mobJitterScale", "0.741972" },
            { "edges.weight.value.value", "4.997354" },
            { "edges.weight.valueType", "periodic" },
            { "enemy.crowd.radius.periodic.amplitude.mobJitterScale", "-0.513176" },
            { "enemy.crowd.radius.periodic.amplitude.value", "-0.338126" },
            { "enemy.crowd.radius.periodic.period.mobJitterScale", "0.940440" },
            { "enemy.crowd.radius.periodic.period.value", "61.093712" },
            { "enemy.crowd.radius.periodic.tickShift.mobJitterScale", "-0.570252" },
            { "enemy.crowd.radius.periodic.tickShift.value", "-1.000000" },
            { "enemy.crowd.radius.value.mobJitterScale", "-0.832311" },
            { "enemy.crowd.radius.value.value", "1241.414673" },
            { "enemy.crowd.size.periodic.amplitude.mobJitterScale", "-0.303584" },
            { "enemy.crowd.size.periodic.amplitude.value", "-0.819248" },
            { "enemy.crowd.size.periodic.period.mobJitterScale", "0.954999" },
            { "enemy.crowd.size.periodic.period.value", "7575.926758" },
            { "enemy.crowd.size.periodic.tickShift.mobJitterScale", "-0.741327" },
            { "enemy.crowd.size.periodic.tickShift.value", "7468.682129" },
            { "enemy.crowd.size.value.mobJitterScale", "0.187990" },
            { "enemy.crowd.size.value.value", "11.688250" },
            { "enemy.radius.periodic.amplitude.mobJitterScale", "-0.138351" },
            { "enemy.radius.periodic.amplitude.value", "-0.213739" },
            { "enemy.radius.periodic.period.mobJitterScale", "-0.485041" },
            { "enemy.radius.periodic.period.value", "1204.912598" },
            { "enemy.radius.periodic.tickShift.mobJitterScale", "-0.022313" },
            { "enemy.radius.periodic.tickShift.value", "5823.729492" },
            { "enemy.radius.value.mobJitterScale", "-1.000000" },
            { "enemy.radius.value.value", "-1.000000" },
            { "enemy.rangeType", "linearDown" },
            { "enemy.weight.periodic.amplitude.mobJitterScale", "-0.115791" },
            { "enemy.weight.periodic.amplitude.value", "0.583412" },
            { "enemy.weight.periodic.period.mobJitterScale", "0.018072" },
            { "enemy.weight.periodic.period.value", "1887.864868" },
            { "enemy.weight.periodic.tickShift.mobJitterScale", "0.843193" },
            { "enemy.weight.periodic.tickShift.value", "935.604309" },
            { "enemy.weight.value.mobJitterScale", "0.210212" },
            { "enemy.weight.value.value", "-6.195770" },
            { "enemyBase.crowd.radius.periodic.amplitude.mobJitterScale", "0.053183" },
            { "enemyBase.crowd.radius.periodic.amplitude.value", "-0.230169" },
            { "enemyBase.crowd.radius.periodic.period.mobJitterScale", "-0.704241" },
            { "enemyBase.crowd.radius.periodic.period.value", "7344.727539" },
            { "enemyBase.crowd.radius.periodic.tickShift.mobJitterScale", "-0.682952" },
            { "enemyBase.crowd.radius.periodic.tickShift.value", "6024.229492" },
            { "enemyBase.crowd.radius.value.mobJitterScale", "-0.509598" },
            { "enemyBase.crowd.radius.value.value", "1406.729980" },
            { "enemyBase.crowd.size.periodic.amplitude.mobJitterScale", "1.000000" },
            { "enemyBase.crowd.size.periodic.amplitude.value", "0.524096" },
            { "enemyBase.crowd.size.periodic.period.mobJitterScale", "0.141062" },
            { "enemyBase.crowd.size.periodic.period.value", "6189.389648" },
            { "enemyBase.crowd.size.periodic.tickShift.mobJitterScale", "0.044321" },
            { "enemyBase.crowd.size.periodic.tickShift.value", "4533.192871" },
            { "enemyBase.crowd.size.value.mobJitterScale", "-0.733396" },
            { "enemyBase.crowd.size.value.value", "-0.504712" },
            { "enemyBase.crowdType", "strictOff" },
            { "enemyBase.radius.periodic.amplitude.mobJitterScale", "-0.991884" },
            { "enemyBase.radius.periodic.amplitude.value", "0.403651" },
            { "enemyBase.radius.periodic.period.mobJitterScale", "-0.434654" },
            { "enemyBase.radius.periodic.period.value", "6295.250000" },
            { "enemyBase.radius.periodic.tickShift.mobJitterScale", "0.507344" },
            { "enemyBase.radius.periodic.tickShift.value", "9781.980469" },
            { "enemyBase.radius.value.mobJitterScale", "-0.562025" },
            { "enemyBase.radius.value.value", "236.681595" },
            { "enemyBase.radius.valueType", "constant" },
            { "enemyBase.weight.periodic.amplitude.mobJitterScale", "0.801324" },
            { "enemyBase.weight.periodic.amplitude.value", "-0.525640" },
            { "enemyBase.weight.periodic.period.mobJitterScale", "0.835742" },
            { "enemyBase.weight.periodic.period.value", "10000.000000" },
            { "enemyBase.weight.periodic.tickShift.mobJitterScale", "0.141312" },
            { "enemyBase.weight.periodic.tickShift.value", "7659.267090" },
            { "enemyBase.weight.value.mobJitterScale", "-0.418468" },
            { "enemyBase.weight.value.value", "9.793259" },
            { "enemyBase.weight.valueType", "constant" },
            { "evadeFighters", "FALSE" },
            { "evadeRange", "209.937012" },
            { "evadeStrictDistance", "298.576385" },
            { "evadeUseStrictDistance", "FALSE" },
            { "fleetLocus.circularPeriod", "5085.281250" },
            { "fleetLocus.circularWeight", "1.543742" },
            { "fleetLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "0.393149" },
            { "fleetLocus.force.crowd.radius.periodic.amplitude.value", "0.687643" },
            { "fleetLocus.force.crowd.radius.periodic.period.mobJitterScale", "0.900000" },
            { "fleetLocus.force.crowd.radius.periodic.period.value", "8568.735352" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "-0.467895" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.value", "5659.822266" },
            { "fleetLocus.force.crowd.radius.value.mobJitterScale", "0.626203" },
            { "fleetLocus.force.crowd.radius.value.value", "304.644958" },
            { "fleetLocus.force.crowd.radius.valueType", "constant" },
            { "fleetLocus.force.crowd.size.periodic.amplitude.mobJitterScale", "0.515273" },
            { "fleetLocus.force.crowd.size.periodic.amplitude.value", "-0.237505" },
            { "fleetLocus.force.crowd.size.periodic.period.mobJitterScale", "-0.044069" },
            { "fleetLocus.force.crowd.size.periodic.period.value", "6517.367188" },
            { "fleetLocus.force.crowd.size.periodic.tickShift.mobJitterScale", "-0.313275" },
            { "fleetLocus.force.crowd.size.periodic.tickShift.value", "3587.172363" },
            { "fleetLocus.force.crowd.size.value.mobJitterScale", "-0.373848" },
            { "fleetLocus.force.crowd.size.value.value", "8.435922" },
            { "fleetLocus.force.crowdType", "strictOn" },
            { "fleetLocus.force.radius.periodic.amplitude.mobJitterScale", "-0.298235" },
            { "fleetLocus.force.radius.periodic.amplitude.value", "0.790968" },
            { "fleetLocus.force.radius.periodic.period.mobJitterScale", "0.973437" },
            { "fleetLocus.force.radius.periodic.period.value", "5228.549805" },
            { "fleetLocus.force.radius.periodic.tickShift.mobJitterScale", "-0.729856" },
            { "fleetLocus.force.radius.periodic.tickShift.value", "7947.075684" },
            { "fleetLocus.force.radius.value.mobJitterScale", "0.818176" },
            { "fleetLocus.force.radius.value.value", "1429.644287" },
            { "fleetLocus.force.radius.valueType", "constant" },
            { "fleetLocus.force.rangeType", "linearUp" },
            { "fleetLocus.force.weight.periodic.amplitude.mobJitterScale", "0.235123" },
            { "fleetLocus.force.weight.periodic.amplitude.value", "-0.845499" },
            { "fleetLocus.force.weight.periodic.period.mobJitterScale", "-0.452918" },
            { "fleetLocus.force.weight.periodic.period.value", "6908.266113" },
            { "fleetLocus.force.weight.periodic.tickShift.mobJitterScale", "-0.389995" },
            { "fleetLocus.force.weight.periodic.tickShift.value", "4013.142578" },
            { "fleetLocus.force.weight.value.mobJitterScale", "-0.389882" },
            { "fleetLocus.force.weight.value.value", "-4.531455" },
            { "fleetLocus.force.weight.valueType", "constant" },
            { "fleetLocus.linearWeight", "1.455750" },
            { "fleetLocus.linearXPeriod", "2735.881592" },
            { "fleetLocus.linearYPeriod", "575.660706" },
            { "fleetLocus.randomWeight", "1.899668" },
            { "fleetLocus.useScaled", "TRUE" },
            { "gatherAbandonStale", "TRUE" },
            { "gatherRange", "37.957649" },
            { "guardRange", "66.711075" },
            { "mobLocus.circularPeriod.mobJitterScale", "-1.000000" },
            { "mobLocus.circularPeriod.value", "-1.000000" },
            { "mobLocus.circularWeight.periodic.amplitude.mobJitterScale", "-0.380331" },
            { "mobLocus.circularWeight.periodic.amplitude.value", "0.325222" },
            { "mobLocus.circularWeight.periodic.period.mobJitterScale", "0.559801" },
            { "mobLocus.circularWeight.periodic.period.value", "1351.118652" },
            { "mobLocus.circularWeight.periodic.tickShift.mobJitterScale", "-0.394939" },
            { "mobLocus.circularWeight.periodic.tickShift.value", "3026.674805" },
            { "mobLocus.circularWeight.value.mobJitterScale", "-0.500029" },
            { "mobLocus.circularWeight.value.value", "5.418794" },
            { "mobLocus.circularWeight.valueType", "constant" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "0.304932" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.value", "0.240578" },
            { "mobLocus.force.crowd.radius.periodic.period.mobJitterScale", "0.912266" },
            { "mobLocus.force.crowd.radius.periodic.period.value", "614.530090" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "-0.742976" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.value", "-1.000000" },
            { "mobLocus.force.crowd.radius.value.mobJitterScale", "0.176778" },
            { "mobLocus.force.crowd.radius.value.value", "735.553528" },
            { "mobLocus.force.crowd.radius.valueType", "periodic" },
            { "mobLocus.force.crowd.size.periodic.amplitude.mobJitterScale", "-0.130690" },
            { "mobLocus.force.crowd.size.periodic.amplitude.value", "-0.986364" },
            { "mobLocus.force.crowd.size.periodic.period.mobJitterScale", "-0.334022" },
            { "mobLocus.force.crowd.size.periodic.period.value", "4498.463867" },
            { "mobLocus.force.crowd.size.periodic.tickShift.mobJitterScale", "0.145658" },
            { "mobLocus.force.crowd.size.periodic.tickShift.value", "6250.711426" },
            { "mobLocus.force.crowd.size.value.mobJitterScale", "0.605129" },
            { "mobLocus.force.crowd.size.value.value", "12.165135" },
            { "mobLocus.force.radius.periodic.amplitude.mobJitterScale", "-0.937506" },
            { "mobLocus.force.radius.periodic.amplitude.value", "0.596408" },
            { "mobLocus.force.radius.periodic.period.mobJitterScale", "0.157528" },
            { "mobLocus.force.radius.periodic.period.value", "4815.667969" },
            { "mobLocus.force.radius.periodic.tickShift.mobJitterScale", "-0.680549" },
            { "mobLocus.force.radius.periodic.tickShift.value", "2286.177002" },
            { "mobLocus.force.radius.value.mobJitterScale", "1.000000" },
            { "mobLocus.force.radius.value.value", "961.237305" },
            { "mobLocus.force.radius.valueType", "constant" },
            { "mobLocus.force.rangeType", "linearUp" },
            { "mobLocus.force.weight.periodic.amplitude.mobJitterScale", "-0.406186" },
            { "mobLocus.force.weight.periodic.amplitude.value", "0.231276" },
            { "mobLocus.force.weight.periodic.period.mobJitterScale", "0.931936" },
            { "mobLocus.force.weight.periodic.period.value", "2197.402832" },
            { "mobLocus.force.weight.periodic.tickShift.mobJitterScale", "0.927871" },
            { "mobLocus.force.weight.periodic.tickShift.value", "6280.317383" },
            { "mobLocus.force.weight.value.mobJitterScale", "-0.642374" },
            { "mobLocus.force.weight.value.value", "-0.667937" },
            { "mobLocus.linearWeight.periodic.amplitude.mobJitterScale", "-0.707387" },
            { "mobLocus.linearWeight.periodic.amplitude.value", "1.000000" },
            { "mobLocus.linearWeight.periodic.period.mobJitterScale", "0.823791" },
            { "mobLocus.linearWeight.periodic.period.value", "3338.653076" },
            { "mobLocus.linearWeight.periodic.tickShift.mobJitterScale", "-0.117286" },
            { "mobLocus.linearWeight.periodic.tickShift.value", "7446.732910" },
            { "mobLocus.linearWeight.value.mobJitterScale", "1.000000" },
            { "mobLocus.linearWeight.value.value", "1.931834" },
            { "mobLocus.linearXPeriod.mobJitterScale", "-0.168219" },
            { "mobLocus.linearXPeriod.value", "8248.387695" },
            { "mobLocus.linearYPeriod.mobJitterScale", "0.817698" },
            { "mobLocus.linearYPeriod.value", "531.793030" },
            { "mobLocus.proximityRadius.periodic.amplitude.mobJitterScale", "0.078539" },
            { "mobLocus.proximityRadius.periodic.amplitude.value", "0.839951" },
            { "mobLocus.proximityRadius.periodic.period.mobJitterScale", "0.742600" },
            { "mobLocus.proximityRadius.periodic.period.value", "10000.000000" },
            { "mobLocus.proximityRadius.periodic.tickShift.mobJitterScale", "0.784675" },
            { "mobLocus.proximityRadius.periodic.tickShift.value", "5062.821289" },
            { "mobLocus.proximityRadius.value.mobJitterScale", "-1.000000" },
            { "mobLocus.proximityRadius.value.value", "1102.618164" },
            { "mobLocus.proximityRadius.valueType", "periodic" },
            { "mobLocus.randomPeriod.mobJitterScale", "0.248454" },
            { "mobLocus.randomPeriod.value", "10000.000000" },
            { "mobLocus.randomWeight.periodic.amplitude.mobJitterScale", "1.000000" },
            { "mobLocus.randomWeight.periodic.amplitude.value", "0.723973" },
            { "mobLocus.randomWeight.periodic.period.mobJitterScale", "-0.792849" },
            { "mobLocus.randomWeight.periodic.period.value", "7436.664551" },
            { "mobLocus.randomWeight.periodic.tickShift.mobJitterScale", "-0.964026" },
            { "mobLocus.randomWeight.periodic.tickShift.value", "5956.462891" },
            { "mobLocus.randomWeight.value.mobJitterScale", "0.182813" },
            { "mobLocus.randomWeight.value.value", "-1.406540" },
            { "mobLocus.randomWeight.valueType", "constant" },
            { "mobLocus.resetOnProximity", "TRUE" },
            { "mobLocus.useScaled", "FALSE" },
            { "nearBaseRadius", "466.211639" },
            { "nearBaseRandomIdle", "TRUE" },
            { "nearestFriend.crowd.radius.periodic.amplitude.mobJitterScale", "0.690348" },
            { "nearestFriend.crowd.radius.periodic.amplitude.value", "0.118690" },
            { "nearestFriend.crowd.radius.periodic.period.mobJitterScale", "0.000000" },
            { "nearestFriend.crowd.radius.periodic.period.value", "6868.106445" },
            { "nearestFriend.crowd.radius.periodic.tickShift.mobJitterScale", "-0.120440" },
            { "nearestFriend.crowd.radius.periodic.tickShift.value", "10000.000000" },
            { "nearestFriend.crowd.radius.value.mobJitterScale", "0.711549" },
            { "nearestFriend.crowd.radius.value.value", "987.182861" },
            { "nearestFriend.crowd.radius.valueType", "periodic" },
            { "nearestFriend.crowd.size.periodic.amplitude.mobJitterScale", "0.414584" },
            { "nearestFriend.crowd.size.periodic.amplitude.value", "0.013152" },
            { "nearestFriend.crowd.size.periodic.period.mobJitterScale", "-0.229707" },
            { "nearestFriend.crowd.size.periodic.period.value", "6615.891113" },
            ...
            { "nearestFriend.crowd.size.value.mobJitterScale", "0.358540" },
            { "nearestFriend.crowd.size.value.value", "-0.647043" },
            { "nearestFriend.crowd.size.valueType", "periodic" },
            { "nearestFriend.radius.periodic.amplitude.mobJitterScale", "0.335377" },
            { "nearestFriend.radius.periodic.amplitude.value", "0.524447" },
            { "nearestFriend.radius.periodic.period.mobJitterScale", "-0.033223" },
            { "nearestFriend.radius.periodic.period.value", "7882.907715" },
            { "nearestFriend.radius.periodic.tickShift.mobJitterScale", "-0.527481" },
            { "nearestFriend.radius.periodic.tickShift.value", "8837.281250" },
            { "nearestFriend.radius.value.mobJitterScale", "-0.034144" },
            { "nearestFriend.radius.value.value", "869.537598" },
            { "nearestFriend.radius.valueType", "periodic" },
            { "nearestFriend.weight.periodic.amplitude.mobJitterScale", "0.419583" },
            { "nearestFriend.weight.periodic.amplitude.value", "-0.656646" },
            { "nearestFriend.weight.periodic.period.mobJitterScale", "0.105077" },
            { "nearestFriend.weight.periodic.period.value", "8421.138672" },
            { "nearestFriend.weight.periodic.tickShift.mobJitterScale", "-0.627320" },
            { "nearestFriend.weight.periodic.tickShift.value", "8024.816406" },
            { "nearestFriend.weight.value.mobJitterScale", "-0.746810" },
            { "nearestFriend.weight.value.value", "-10.000000" },
            { "nearestFriend.weight.valueType", "periodic" },
            { "randomIdle", "FALSE" },
            { "randomizeStoppedVelocity", "TRUE" },
            { "rotateStartingAngle", "TRUE" },
            { "separate.crowd.radius.periodic.amplitude.mobJitterScale", "0.127321" },
            { "separate.crowd.radius.periodic.amplitude.value", "-0.032126" },
            { "separate.crowd.radius.periodic.period.mobJitterScale", "-1.000000" },
            { "separate.crowd.radius.periodic.period.value", "6513.107910" },
            { "separate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.174435" },
            { "separate.crowd.radius.periodic.tickShift.value", "5177.468750" },
            { "separate.crowd.radius.value.mobJitterScale", "0.196305" },
            { "separate.crowd.radius.value.value", "390.052032" },
            { "separate.crowd.size.periodic.amplitude.mobJitterScale", "1.000000" },
            { "separate.crowd.size.periodic.amplitude.value", "0.870190" },
            { "separate.crowd.size.periodic.period.mobJitterScale", "-0.265448" },
            { "separate.crowd.size.periodic.period.value", "1390.280273" },
            { "separate.crowd.size.periodic.tickShift.mobJitterScale", "-1.000000" },
            { "separate.crowd.size.periodic.tickShift.value", "6505.115723" },
            { "separate.crowd.size.value.mobJitterScale", "0.783156" },
            { "separate.crowd.size.value.value", "-1.000000" },
            { "separate.crowdType", "never" },
            { "separate.radius.periodic.amplitude.mobJitterScale", "0.504734" },
            { "separate.radius.periodic.amplitude.value", "-0.659435" },
            { "separate.radius.periodic.period.mobJitterScale", "-0.074663" },
            { "separate.radius.periodic.period.value", "2253.110107" },
            { "separate.radius.periodic.tickShift.mobJitterScale", "-0.692338" },
            { "separate.radius.periodic.tickShift.value", "3594.668457" },
            { "separate.radius.value.mobJitterScale", "0.807110" },
            { "separate.radius.value.value", "1184.227661" },
            { "separate.radius.valueType", "periodic" },
            { "separate.rangeType", "linearDown" },
            { "separate.weight.periodic.amplitude.mobJitterScale", "-0.810000" },
            { "separate.weight.periodic.amplitude.value", "-0.036229" },
            { "separate.weight.periodic.period.mobJitterScale", "0.032437" },
            { "separate.weight.periodic.period.value", "9029.959961" },
            { "separate.weight.periodic.tickShift.mobJitterScale", "-0.526747" },
            { "separate.weight.periodic.tickShift.value", "284.545776" },
            { "separate.weight.value.mobJitterScale", "0.582685" },
            { "separate.weight.value.value", "-6.726097" },
            { "separate.weight.valueType", "periodic" },
            { "simpleAttack", "TRUE" },
            { "startingMaxRadius", "1348.664917" },
            { "startingMinRadius", "755.151001" },
        };
        ...
        VERIFY(aiType <= FLEET_AI_BUNDLE5);
