...
public:
    ...
    void putDefaults(MBRegistry *mreg, FleetAIType aiType) {
        ...
        BundleConfigValue configs5[] = {
            { "align.crowd.radius.periodic.amplitude.mobJitterScale", "0.191380" },
            { "align.crowd.radius.periodic.period.mobJitterScale", "0.316628" },
            { "align.crowd.radius.periodic.period.value", "5300.484863" },
            { "align.crowd.radius.periodic.tickShift.mobJitterScale", "-0.073774" },
            { "align.crowd.radius.periodic.tickShift.value", "369.517426" },
            { "align.crowd.radius.value.mobJitterScale", "0.314363" },
            { "align.crowd.radius.value.value", "60.085773" },
            { "align.crowd.size.periodic.amplitude.value", "-0.846981" },
            { "align.crowd.size.periodic.period.mobJitterScale", "1.000000" },
            { "align.crowd.size.periodic.period.value", "2281.664307" },
            { "align.crowd.size.periodic.tickShift.mobJitterScale", "-0.738361" },
            { "align.crowd.size.periodic.tickShift.value", "6582.549316" },
            { "align.crowd.size.value.value", "17.168802" },
            { "align.crowd.size.valueType", "periodic" },
            { "align.crowdType", "strictOn" },
            { "align.radius.periodic.amplitude.mobJitterScale", "-0.398778" },
            { "align.radius.periodic.amplitude.value", "-0.103290" },
            { "align.radius.periodic.period.mobJitterScale", "-0.224253" },
            { "align.radius.periodic.period.value", "4069.960693" },
            { "align.radius.value.mobJitterScale", "-0.998502" },
            { "align.radius.value.value", "1214.045288" },
            { "align.rangeType", "strictOff" },
            { "align.weight.periodic.amplitude.mobJitterScale", "-0.793593" },
            { "align.weight.periodic.amplitude.value", "0.000973" },
            { "align.weight.periodic.tickShift.mobJitterScale", "1.000000" },
            { "align.weight.value.mobJitterScale", "-0.389613" },
            { "align.weight.value.value", "0.343063" },
            { "align.weight.valueType", "constant" },
            { "attackRange", "243.570023" },
            { "attackSeparate.crowd.radius.periodic.amplitude.value", "-0.779078" },
            { "attackSeparate.crowd.radius.periodic.period.mobJitterScale", "-0.183702" },
            { "attackSeparate.crowd.radius.periodic.period.value", "4712.188965" },
            { "attackSeparate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.246777" },
            { "attackSeparate.crowd.radius.periodic.tickShift.value", "2929.538330" },
            { "attackSeparate.crowd.radius.value.mobJitterScale", "-0.141487" },
            { "attackSeparate.crowd.radius.value.value", "2000.000000" },
            { "attackSeparate.crowd.radius.valueType", "constant" },
            { "attackSeparate.crowd.size.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "attackSeparate.crowd.size.periodic.amplitude.value", "-0.072791" },
            { "attackSeparate.crowd.size.periodic.period.mobJitterScale", "0.874276" },
            { "attackSeparate.crowd.size.periodic.period.value", "5231.126465" },
            { "attackSeparate.crowd.size.periodic.tickShift.mobJitterScale", "-0.740150" },
            { "attackSeparate.crowd.size.periodic.tickShift.value", "7671.451172" },
            { "attackSeparate.crowd.size.value.mobJitterScale", "0.277347" },
            { "attackSeparate.crowd.size.value.value", "4.852831" },
            { "attackSeparate.crowd.size.valueType", "periodic" },
            { "attackSeparate.crowdType", "quadraticDown" },
            { "attackSeparate.radius.periodic.amplitude.mobJitterScale", "0.092651" },
            { "attackSeparate.radius.periodic.amplitude.value", "-0.320954" },
            { "attackSeparate.radius.periodic.period.mobJitterScale", "0.507482" },
            { "attackSeparate.radius.periodic.period.value", "782.693726" },
            { "attackSeparate.radius.periodic.tickShift.mobJitterScale", "0.224179" },
            { "attackSeparate.radius.periodic.tickShift.value", "2147.426758" },
            { "attackSeparate.radius.value.mobJitterScale", "0.749635" },
            { "attackSeparate.radius.value.value", "1422.958130" },
            { "attackSeparate.radius.valueType", "periodic" },
            { "attackSeparate.rangeType", "never" },
            { "attackSeparate.weight.periodic.amplitude.mobJitterScale", "-0.083488" },
            { "attackSeparate.weight.periodic.amplitude.value", "-0.858721" },
            { "attackSeparate.weight.periodic.period.value", "7990.690430" },
            { "attackSeparate.weight.periodic.tickShift.value", "3958.638916" },
            { "attackSeparate.weight.value.mobJitterScale", "0.949503" },
            { "attackSeparate.weight.value.value", "5.848558" },
            { "attackSeparate.weight.valueType", "constant" },
            { "base.crowd.radius.periodic.amplitude.mobJitterScale", "-0.856791" },
            { "base.crowd.radius.periodic.period.value", "1434.848267" },
            { "base.crowd.radius.periodic.tickShift.value", "1809.140381" },
            { "base.crowd.radius.value.mobJitterScale", "0.811015" },
            { "base.crowd.radius.value.value", "527.280945" },
            { "base.crowd.radius.valueType", "periodic" },
            { "base.crowd.size.periodic.amplitude.mobJitterScale", "0.251199" },
            { "base.crowd.size.periodic.period.mobJitterScale", "0.661235" },
            { "base.crowd.size.periodic.period.value", "6604.086426" },
            { "base.crowd.size.periodic.tickShift.mobJitterScale", "0.832513" },
            { "base.crowd.size.periodic.tickShift.value", "61.859486" },
            { "base.crowd.size.value.mobJitterScale", "-0.651327" },
            { "base.crowd.size.value.value", "19.687889" },
            { "base.crowd.size.valueType", "constant" },
            { "base.crowdType", "quadraticDown" },
            { "base.radius.periodic.amplitude.value", "0.536907" },
            { "base.radius.periodic.period.value", "2416.389648" },
            { "base.radius.periodic.tickShift.mobJitterScale", "-0.419109" },
            { "base.radius.value.value", "586.354675" },
            { "base.radius.valueType", "constant" },
            { "base.rangeType", "never" },
            { "base.weight.periodic.amplitude.mobJitterScale", "0.356715" },
            { "base.weight.periodic.period.mobJitterScale", "0.074663" },
            { "base.weight.periodic.period.value", "546.788513" },
            { "base.weight.periodic.tickShift.mobJitterScale", "0.130416" },
            { "base.weight.value.mobJitterScale", "-0.191446" },
            { "base.weight.value.value", "-3.862251" },
            { "baseDefense.crowd.radius.periodic.amplitude.value", "-0.029466" },
            { "baseDefense.crowd.radius.periodic.period.mobJitterScale", "-0.983502" },
            { "baseDefense.crowd.radius.periodic.period.value", "8968.316406" },
            { "baseDefense.crowd.radius.periodic.tickShift.mobJitterScale", "-0.112986" },
            { "baseDefense.crowd.radius.value.mobJitterScale", "0.011190" },
            { "baseDefense.crowd.radius.valueType", "constant" },
            { "baseDefense.crowd.size.periodic.amplitude.value", "0.224533" },
            { "baseDefense.crowd.size.periodic.period.value", "2472.254639" },
            { "baseDefense.crowd.size.periodic.tickShift.mobJitterScale", "-0.526515" },
            { "baseDefense.crowd.size.periodic.tickShift.value", "-1.000000" },
            { "baseDefense.crowd.size.value.mobJitterScale", "-0.694818" },
            { "baseDefense.crowd.size.valueType", "periodic" },
            { "baseDefense.crowdType", "never" },
            { "baseDefense.radius.periodic.amplitude.value", "0.594326" },
            { "baseDefense.radius.periodic.period.mobJitterScale", "-0.351688" },
            { "baseDefense.radius.periodic.period.value", "1796.005981" },
            { "baseDefense.radius.value.mobJitterScale", "0.943254" },
            { "baseDefense.radius.value.value", "69.065956" },
            { "baseDefense.rangeType", "linearDown" },
            { "baseDefense.weight.periodic.amplitude.mobJitterScale", "0.246166" },
            { "baseDefense.weight.periodic.period.mobJitterScale", "-0.199175" },
            { "baseDefense.weight.periodic.tickShift.mobJitterScale", "0.362635" },
            { "baseDefense.weight.periodic.tickShift.value", "419.713287" },
            { "baseDefense.weight.value.mobJitterScale", "-0.550150" },
            { "baseDefense.weight.value.value", "2.439771" },
            { "baseDefense.weight.valueType", "constant" },
            { "center.crowd.radius.periodic.amplitude.mobJitterScale", "0.428423" },
            { "center.crowd.radius.periodic.amplitude.value", "0.340642" },
            { "center.crowd.radius.periodic.period.mobJitterScale", "0.721688" },
            { "center.crowd.radius.periodic.period.value", "7735.654785" },
            { "center.crowd.radius.periodic.tickShift.mobJitterScale", "-0.150476" },
            { "center.crowd.radius.periodic.tickShift.value", "4252.045898" },
            { "center.crowd.radius.value.mobJitterScale", "-0.528182" },
            { "center.crowd.radius.value.value", "1718.164551" },
            { "center.crowd.size.periodic.amplitude.mobJitterScale", "-0.358396" },
            { "center.crowd.size.periodic.amplitude.value", "-0.760849" },
            { "center.crowd.size.periodic.period.mobJitterScale", "-0.680708" },
            { "center.crowd.size.periodic.period.value", "1512.146240" },
            { "center.crowd.size.periodic.tickShift.mobJitterScale", "-0.855347" },
            { "center.crowd.size.periodic.tickShift.value", "6823.149902" },
            { "center.crowd.size.value.value", "2.235918" },
            { "center.crowd.size.valueType", "periodic" },
            { "center.radius.periodic.amplitude.mobJitterScale", "0.361890" },
            { "center.radius.periodic.amplitude.value", "-0.862174" },
            { "center.radius.periodic.period.mobJitterScale", "0.658820" },
            { "center.radius.periodic.period.value", "8442.937500" },
            { "center.radius.periodic.tickShift.mobJitterScale", "-0.691536" },
            { "center.radius.periodic.tickShift.value", "10000.000000" },
            { "center.radius.value.mobJitterScale", "-0.037639" },
            { "center.radius.value.value", "163.909851" },
            { "center.radius.valueType", "periodic" },
            { "center.weight.periodic.amplitude.mobJitterScale", "0.229971" },
            { "center.weight.periodic.amplitude.value", "0.404845" },
            { "center.weight.periodic.period.mobJitterScale", "0.310160" },
            { "center.weight.periodic.period.value", "7262.246094" },
            { "center.weight.value.value", "-3.866171" },
            { "center.weight.valueType", "periodic" },
            { "cohere.crowd.radius.periodic.amplitude.value", "-0.727592" },
            { "cohere.crowd.radius.periodic.period.mobJitterScale", "0.148751" },
            { "cohere.crowd.radius.periodic.tickShift.mobJitterScale", "0.853321" },
            { "cohere.crowd.radius.periodic.tickShift.value", "329.179962" },
            { "cohere.crowd.radius.value.mobJitterScale", "0.978849" },
            { "cohere.crowd.radius.value.value", "1719.851807" },
            { "cohere.crowd.radius.valueType", "constant" },
            { "cohere.crowd.size.periodic.period.value", "2268.963623" },
            { "cohere.crowd.size.periodic.tickShift.value", "7557.438965" },
            { "cohere.crowd.size.value.mobJitterScale", "0.664918" },
            { "cohere.crowd.size.value.value", "8.128455" },
            { "cohere.radius.periodic.amplitude.mobJitterScale", "-0.909828" },
            { "cohere.radius.periodic.amplitude.value", "-0.251947" },
            { "cohere.radius.periodic.period.mobJitterScale", "-0.441477" },
            { "cohere.radius.periodic.period.value", "517.444153" },
            { "cohere.radius.periodic.tickShift.mobJitterScale", "-0.757964" },
            { "cohere.radius.value.value", "1070.936646" },
            { "cohere.radius.valueType", "constant" },
            { "cohere.rangeType", "linearDown" },
            { "cohere.weight.periodic.amplitude.mobJitterScale", "0.042552" },
            { "cohere.weight.periodic.amplitude.value", "0.158386" },
            { "cohere.weight.periodic.period.mobJitterScale", "0.164813" },
            { "cohere.weight.periodic.period.value", "1900.354370" },
            { "cohere.weight.periodic.tickShift.mobJitterScale", "-0.031499" },
            { "cohere.weight.periodic.tickShift.value", "8151.271484" },
            { "cohere.weight.value.mobJitterScale", "0.381071" },
            { "cohere.weight.value.value", "-5.500629" },
            { "cohere.weight.valueType", "constant" },
            { "cores.crowd.radius.periodic.amplitude.mobJitterScale", "-0.391360" },
            { "cores.crowd.radius.periodic.period.value", "659.988220" },
            { "cores.crowd.radius.periodic.tickShift.mobJitterScale", "-0.255035" },
            { "cores.crowd.radius.periodic.tickShift.value", "7632.390137" },
            { "cores.crowd.radius.value.mobJitterScale", "-0.676579" },
            { "cores.crowd.radius.value.value", "1120.054565" },
            { "cores.crowd.radius.valueType", "constant" },
            { "cores.crowd.size.periodic.amplitude.mobJitterScale", "-0.454147" },
            { "cores.crowd.size.periodic.period.value", "10000.000000" },
            { "cores.crowd.size.periodic.tickShift.mobJitterScale", "-0.954875" },
            { "cores.crowd.size.value.mobJitterScale", "0.076104" },
            { "cores.crowd.size.valueType", "periodic" },
            { "cores.crowdType", "linearDown" },
            { "cores.radius.periodic.amplitude.mobJitterScale", "0.130480" },
            { "cores.radius.periodic.amplitude.value", "0.782120" },
            { "cores.radius.periodic.period.mobJitterScale", "0.394578" },
            { "cores.radius.periodic.tickShift.mobJitterScale", "-0.253364" },
            { "cores.radius.value.value", "732.880737" },
            { "cores.radius.valueType", "periodic" },
            { "cores.rangeType", "never" },
            { "cores.weight.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "cores.weight.periodic.period.mobJitterScale", "0.095397" },
            { "cores.weight.periodic.tickShift.mobJitterScale", "-0.448087" },
            { "cores.weight.periodic.tickShift.value", "125.525253" },
            { "cores.weight.value.value", "5.679478" },
            { "cores.weight.valueType", "constant" },
            { "corners.crowd.radius.periodic.amplitude.value", "-0.372415" },
            { "corners.crowd.radius.periodic.period.value", "2984.024170" },
            { "corners.crowd.radius.periodic.tickShift.value", "1948.402588" },
            { "corners.crowd.radius.value.mobJitterScale", "0.210947" },
            { "corners.crowd.radius.value.value", "-1.000000" },
            { "corners.crowd.size.periodic.amplitude.mobJitterScale", "0.038585" },
            { "corners.crowd.size.periodic.amplitude.value", "-0.202899" },
            { "corners.crowd.size.periodic.period.value", "84.420052" },
            { "corners.crowd.size.periodic.tickShift.mobJitterScale", "0.422278" },
            { "corners.crowd.size.value.mobJitterScale", "0.609737" },
            { "corners.crowd.size.value.value", "6.851180" },
            { "corners.crowd.size.valueType", "constant" },
            { "corners.crowdType", "linearDown" },
            { "corners.radius.periodic.amplitude.mobJitterScale", "-0.655411" },
            { "corners.radius.periodic.amplitude.value", "-0.228075" },
            { "corners.radius.periodic.period.value", "4245.181641" },
            { "corners.radius.periodic.tickShift.value", "4107.129395" },
            { "corners.radius.value.mobJitterScale", "0.886141" },
            { "corners.radius.value.value", "1568.655151" },
            { "corners.radius.valueType", "periodic" },
            { "corners.rangeType", "strictOn" },
            { "corners.weight.periodic.amplitude.mobJitterScale", "0.654999" },
            { "corners.weight.periodic.amplitude.value", "0.767112" },
            { "corners.weight.periodic.period.mobJitterScale", "-0.230499" },
            { "corners.weight.periodic.period.value", "1522.796387" },
            { "corners.weight.periodic.tickShift.mobJitterScale", "0.526477" },
            { "corners.weight.periodic.tickShift.value", "3001.861084" },
            { "corners.weight.value.mobJitterScale", "0.274431" },
            { "corners.weight.value.value", "5.241804" },
            { "corners.weight.valueType", "periodic" },
            { "creditReserve", "160.585327" },
            { "curHeadingWeight.periodic.amplitude.mobJitterScale", "0.858900" },
            { "curHeadingWeight.periodic.tickShift.mobJitterScale", "0.564518" },
            { "curHeadingWeight.periodic.tickShift.value", "9583.025391" },
            { "edges.crowd.radius.periodic.amplitude.mobJitterScale", "0.424336" },
            { "edges.crowd.radius.periodic.amplitude.value", "0.018939" },
            { "edges.crowd.radius.periodic.period.value", "1284.916138" },
            { "edges.crowd.radius.value.mobJitterScale", "0.457356" },
            { "edges.crowd.radius.value.value", "1179.990967" },
            { "edges.crowd.size.periodic.amplitude.mobJitterScale", "0.265106" },
            { "edges.crowd.size.periodic.amplitude.value", "-0.314064" },
            { "edges.crowd.size.periodic.period.mobJitterScale", "-0.105182" },
            { "edges.crowd.size.periodic.period.value", "4983.153320" },
            { "edges.crowd.size.periodic.tickShift.mobJitterScale", "-0.859472" },
            { "edges.crowd.size.periodic.tickShift.value", "7082.677734" },
            { "edges.crowd.size.value.mobJitterScale", "-0.172802" },
            { "edges.crowd.size.valueType", "periodic" },
            { "edges.crowdType", "strictOn" },
            { "edges.radius.periodic.amplitude.mobJitterScale", "-0.212448" },
            { "edges.radius.periodic.amplitude.value", "-0.814295" },
            { "edges.radius.periodic.period.mobJitterScale", "-0.049579" },
            { "edges.radius.periodic.tickShift.value", "4571.350586" },
            { "edges.radius.value.value", "788.761963" },
            { "edges.radius.valueType", "periodic" },
            { "edges.rangeType", "strictOff" },
            { "edges.weight.periodic.period.mobJitterScale", "-0.039562" },
            { "edges.weight.periodic.period.value", "2337.739502" },
            { "edges.weight.periodic.tickShift.mobJitterScale", "0.323681" },
            { "edges.weight.periodic.tickShift.value", "9666.623047" },
            { "edges.weight.value.mobJitterScale", "0.458488" },
            { "edges.weight.value.value", "4.679525" },
            { "enemy.crowd.radius.periodic.amplitude.mobJitterScale", "0.498594" },
            { "enemy.crowd.radius.periodic.period.mobJitterScale", "-0.378088" },
            { "enemy.crowd.radius.periodic.period.value", "7266.174805" },
            { "enemy.crowd.radius.periodic.tickShift.mobJitterScale", "0.052883" },
            { "enemy.crowd.radius.periodic.tickShift.value", "8723.581055" },
            { "enemy.crowd.radius.value.mobJitterScale", "-0.324296" },
            { "enemy.crowd.radius.value.value", "871.271545" },
            { "enemy.crowd.radius.valueType", "constant" },
            { "enemy.crowd.size.periodic.amplitude.value", "0.144696" },
            { "enemy.crowd.size.periodic.period.mobJitterScale", "-0.178862" },
            { "enemy.crowd.size.periodic.period.value", "5581.665527" },
            { "enemy.crowd.size.periodic.tickShift.value", "6223.567383" },
            { "enemy.crowd.size.value.mobJitterScale", "-0.994929" },
            { "enemy.crowd.size.value.value", "1.806554" },
            { "enemy.crowd.size.valueType", "constant" },
            { "enemy.crowdType", "strictOff" },
            { "enemy.radius.periodic.amplitude.value", "0.587067" },
            { "enemy.radius.periodic.period.mobJitterScale", "0.610247" },
            { "enemy.radius.periodic.tickShift.mobJitterScale", "0.028259" },
            { "enemy.radius.periodic.tickShift.value", "1791.338745" },
            { "enemy.radius.value.value", "1464.904907" },
            { "enemy.radius.valueType", "periodic" },
            { "enemy.weight.periodic.amplitude.mobJitterScale", "0.023407" },
            { "enemy.weight.periodic.amplitude.value", "0.224267" },
            { "enemy.weight.periodic.period.mobJitterScale", "-0.595846" },
            { "enemy.weight.periodic.period.value", "1966.640137" },
            { "enemy.weight.periodic.tickShift.mobJitterScale", "0.638593" },
            { "enemy.weight.periodic.tickShift.value", "7828.698242" },
            { "enemy.weight.value.value", "6.433347" },
            { "enemyBase.crowd.radius.periodic.amplitude.value", "0.403747" },
            { "enemyBase.crowd.radius.periodic.period.mobJitterScale", "0.886780" },
            { "enemyBase.crowd.radius.value.mobJitterScale", "0.505677" },
            { "enemyBase.crowd.radius.value.value", "244.503922" },
            { "enemyBase.crowd.size.periodic.amplitude.mobJitterScale", "0.341555" },
            { "enemyBase.crowd.size.periodic.amplitude.value", "-0.303758" },
            { "enemyBase.crowd.size.periodic.period.mobJitterScale", "-1.000000" },
            { "enemyBase.crowd.size.periodic.tickShift.mobJitterScale", "0.695718" },
            { "enemyBase.crowd.size.periodic.tickShift.value", "6370.805664" },
            { "enemyBase.radius.periodic.amplitude.mobJitterScale", "-0.251373" },
            { "enemyBase.radius.periodic.period.mobJitterScale", "0.086038" },
            { "enemyBase.radius.periodic.period.value", "9489.627930" },
            { "enemyBase.radius.periodic.tickShift.mobJitterScale", "0.062128" },
            { "enemyBase.radius.periodic.tickShift.value", "1861.351074" },
            { "enemyBase.radius.value.value", "769.628967" },
            { "enemyBase.radius.valueType", "constant" },
            { "enemyBase.rangeType", "linearUp" },
            { "enemyBase.weight.periodic.amplitude.mobJitterScale", "-0.388165" },
            { "enemyBase.weight.periodic.amplitude.value", "0.876527" },
            { "enemyBase.weight.periodic.period.mobJitterScale", "0.814001" },
            { "enemyBase.weight.periodic.tickShift.mobJitterScale", "0.125295" },
            { "enemyBase.weight.periodic.tickShift.value", "2526.939453" },
            { "enemyBase.weight.value.mobJitterScale", "0.037834" },
            { "enemyBase.weight.value.value", "0.044580" },
            { "enemyBase.weight.valueType", "constant" },
            { "evadeFighters", "FALSE" },
            { "evadeRange", "87.636452" },
            { "evadeStrictDistance", "337.023285" },
            { "fleetLocus.circularPeriod", "2801.291260" },
            { "fleetLocus.circularWeight", "1.235644" },
            { "fleetLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "0.657928" },
            { "fleetLocus.force.crowd.radius.periodic.amplitude.value", "-0.849073" },
            { "fleetLocus.force.crowd.radius.periodic.period.mobJitterScale", "-0.938947" },
            { "fleetLocus.force.crowd.radius.periodic.period.value", "7045.716797" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "0.403775" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.value", "9355.751953" },
            { "fleetLocus.force.crowd.radius.value.mobJitterScale", "0.101038" },
            { "fleetLocus.force.crowd.radius.value.value", "658.348633" },
            { "fleetLocus.force.crowd.radius.valueType", "periodic" },
            { "fleetLocus.force.crowd.size.periodic.amplitude.value", "-0.279505" },
            { "fleetLocus.force.crowd.size.periodic.period.mobJitterScale", "0.813234" },
            { "fleetLocus.force.crowd.size.periodic.tickShift.mobJitterScale", "-0.314461" },
            { "fleetLocus.force.crowd.size.value.value", "19.162012" },
            { "fleetLocus.force.crowd.size.valueType", "constant" },
            { "fleetLocus.force.crowdType", "strictOn" },
            { "fleetLocus.force.radius.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "fleetLocus.force.radius.periodic.amplitude.value", "0.710306" },
            { "fleetLocus.force.radius.periodic.period.mobJitterScale", "-0.751611" },
            { "fleetLocus.force.radius.periodic.tickShift.mobJitterScale", "-0.818843" },
            { "fleetLocus.force.radius.periodic.tickShift.value", "1750.460327" },
            { "fleetLocus.force.radius.value.mobJitterScale", "-0.722880" },
            { "fleetLocus.force.radius.value.value", "717.762451" },
            { "fleetLocus.force.rangeType", "quadraticDown" },
            { "fleetLocus.force.weight.periodic.period.mobJitterScale", "-0.365354" },
            { "fleetLocus.force.weight.periodic.tickShift.mobJitterScale", "0.121313" },
            { "fleetLocus.force.weight.value.mobJitterScale", "0.022243" },
            { "fleetLocus.force.weight.value.value", "-1.158717" },
            { "fleetLocus.force.weight.valueType", "periodic" },
            { "fleetLocus.linearWeight", "1.577250" },
            { "fleetLocus.linearXPeriod", "8411.842773" },
            { "fleetLocus.randomPeriod", "4950.260254" },
            { "fleetLocus.randomWeight", "1.588851" },
            { "fleetLocus.useScaled", "FALSE" },
            { "gatherAbandonStale", "TRUE" },
            { "gatherRange", "3.518754" },
            { "guardRange", "109.585159" },
            { "mobLocus.circularPeriod.mobJitterScale", "0.039893" },
            { "mobLocus.circularPeriod.value", "4831.399414" },
            { "mobLocus.circularWeight.periodic.amplitude.mobJitterScale", "0.526137" },
            { "mobLocus.circularWeight.periodic.amplitude.value", "-0.199084" },
            { "mobLocus.circularWeight.periodic.period.mobJitterScale", "0.014570" },
            { "mobLocus.circularWeight.periodic.period.value", "2229.125488" },
            { "mobLocus.circularWeight.periodic.tickShift.value", "1303.286987" },
            { "mobLocus.circularWeight.value.mobJitterScale", "0.682904" },
            { "mobLocus.circularWeight.value.value", "-1.432406" },
            { "mobLocus.circularWeight.valueType", "periodic" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "-0.727902" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.value", "0.980324" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "-0.774606" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.value", "9427.289062" },
            { "mobLocus.force.crowd.radius.value.mobJitterScale", "-0.550258" },
            { "mobLocus.force.crowd.radius.value.value", "382.596100" },
            { "mobLocus.force.crowd.radius.valueType", "periodic" },
            { "mobLocus.force.crowd.size.periodic.amplitude.mobJitterScale", "0.447138" },
            { "mobLocus.force.crowd.size.periodic.period.mobJitterScale", "0.188962" },
            { "mobLocus.force.crowd.size.periodic.period.value", "1324.034790" },
            { "mobLocus.force.crowd.size.periodic.tickShift.mobJitterScale", "-0.778533" },
            { "mobLocus.force.crowd.size.periodic.tickShift.value", "5851.666992" },
            { "mobLocus.force.crowd.size.value.mobJitterScale", "-0.659509" },
            { "mobLocus.force.crowd.size.value.value", "4.485137" },
            { "mobLocus.force.crowdType", "linearUp" },
            { "mobLocus.force.radius.periodic.amplitude.mobJitterScale", "0.428689" },
            { "mobLocus.force.radius.periodic.amplitude.value", "-0.081767" },
            { "mobLocus.force.radius.periodic.period.value", "8930.258789" },
            { "mobLocus.force.radius.periodic.tickShift.mobJitterScale", "0.268960" },
            { "mobLocus.force.radius.periodic.tickShift.value", "4571.847656" },
            { "mobLocus.force.radius.value.mobJitterScale", "0.394734" },
            { "mobLocus.force.radius.value.value", "356.446106" },
            { "mobLocus.force.radius.valueType", "periodic" },
            { "mobLocus.force.rangeType", "linearUp" },
            { "mobLocus.force.weight.periodic.amplitude.value", "-0.183852" },
            { "mobLocus.force.weight.periodic.period.mobJitterScale", "-0.261428" },
            { "mobLocus.force.weight.periodic.period.value", "6010.528320" },
            { "mobLocus.force.weight.periodic.tickShift.mobJitterScale", "0.292144" },
            { "mobLocus.force.weight.periodic.tickShift.value", "5920.755371" },
            { "mobLocus.force.weight.value.mobJitterScale", "-0.711579" },
            { "mobLocus.force.weight.valueType", "constant" },
            { "mobLocus.linearWeight.periodic.amplitude.mobJitterScale", "-0.977363" },
            { "mobLocus.linearWeight.periodic.amplitude.value", "-0.629929" },
            { "mobLocus.linearWeight.periodic.period.mobJitterScale", "0.262326" },
            { "mobLocus.linearWeight.periodic.period.value", "6403.965332" },
            { "mobLocus.linearWeight.periodic.tickShift.mobJitterScale", "-0.242800" },
            { "mobLocus.linearWeight.periodic.tickShift.value", "393.826294" },
            { "mobLocus.linearWeight.value.mobJitterScale", "0.074657" },
            { "mobLocus.linearWeight.value.value", "4.032585" },
            { "mobLocus.linearWeight.valueType", "constant" },
            { "mobLocus.linearXPeriod.value", "2257.685059" },
            { "mobLocus.linearYPeriod.mobJitterScale", "0.748688" },
            { "mobLocus.linearYPeriod.value", "9739.699219" },
            { "mobLocus.proximityRadius.periodic.amplitude.mobJitterScale", "-0.321105" },
            { "mobLocus.proximityRadius.periodic.period.mobJitterScale", "0.640894" },
            { "mobLocus.proximityRadius.periodic.period.value", "0.000000" },
            { "mobLocus.proximityRadius.periodic.tickShift.mobJitterScale", "-0.471310" },
            { "mobLocus.proximityRadius.periodic.tickShift.value", "2830.656250" },
            { "mobLocus.proximityRadius.value.value", "820.161499" },
            { "mobLocus.randomPeriod.mobJitterScale", "-0.970208" },
            { "mobLocus.randomPeriod.value", "8552.125000" },
            { "mobLocus.randomWeight.periodic.amplitude.mobJitterScale", "0.579686" },
            { "mobLocus.randomWeight.periodic.period.mobJitterScale", "0.939334" },
            { "mobLocus.randomWeight.periodic.period.value", "1572.317749" },
            { "mobLocus.randomWeight.periodic.tickShift.mobJitterScale", "-0.201615" },
            { "mobLocus.randomWeight.periodic.tickShift.value", "2476.774902" },
            { "mobLocus.randomWeight.value.value", "8.397922" },
            { "mobLocus.randomWeight.valueType", "constant" },
            { "mobLocus.resetOnProximity", "TRUE" },
            { "nearBaseRadius", "91.025482" },
            { "nearBaseRandomIdle", "FALSE" },
            { "nearestFriend.crowd.radius.periodic.period.mobJitterScale", "-0.900000" },
            { "nearestFriend.crowd.radius.periodic.period.value", "4127.954102" },
            { "nearestFriend.crowd.radius.value.mobJitterScale", "-0.140981" },
            { "nearestFriend.crowd.radius.value.value", "2000.000000" },
            { "nearestFriend.crowd.size.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "nearestFriend.crowd.size.periodic.amplitude.value", "-0.545169" },
            { "nearestFriend.crowd.size.periodic.period.mobJitterScale", "-0.949141" },
            { "nearestFriend.crowd.size.periodic.period.value", "7928.802734" },
            { "nearestFriend.crowd.size.periodic.tickShift.mobJitterScale", "0.278173" },
            { "nearestFriend.crowd.size.periodic.tickShift.value", "-1.000000" },
            { "nearestFriend.crowd.size.value.mobJitterScale", "0.989411" },
            { "nearestFriend.crowd.size.value.value", "3.519458" },
            { "nearestFriend.crowd.size.valueType", "periodic" },
            { "nearestFriend.crowdType", "strictOff" },
            { "nearestFriend.radius.periodic.amplitude.value", "-0.459030" },
            { "nearestFriend.radius.periodic.period.mobJitterScale", "-0.647801" },
            { "nearestFriend.radius.periodic.period.value", "5346.097656" },
            { "nearestFriend.radius.periodic.tickShift.mobJitterScale", "0.766826" },
            { "nearestFriend.radius.periodic.tickShift.value", "3399.028076" },
            { "nearestFriend.radius.value.mobJitterScale", "-0.779721" },
            { "nearestFriend.radius.value.value", "662.656311" },
            { "nearestFriend.rangeType", "always" },
            { "nearestFriend.weight.periodic.amplitude.mobJitterScale", "-0.446037" },
            { "nearestFriend.weight.periodic.period.value", "2309.055420" },
            { "nearestFriend.weight.periodic.tickShift.mobJitterScale", "0.586400" },
            { "nearestFriend.weight.periodic.tickShift.value", "463.562164" },
            { "nearestFriend.weight.value.value", "-4.880648" },
            { "nearestFriend.weight.valueType", "periodic" },
            { "playerType", "Target" },
            { "randomIdle", "TRUE" },
            { "randomizeStoppedVelocity", "TRUE" },
            { "rotateStartingAngle", "TRUE" },
            { "separate.crowd.radius.periodic.amplitude.value", "-0.550098" },
            { "separate.crowd.radius.periodic.period.mobJitterScale", "-0.561103" },
            { "separate.crowd.radius.periodic.period.value", "2514.050293" },
            { "separate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.067087" },
            { "separate.crowd.radius.value.mobJitterScale", "-1.000000" },
            { "separate.crowd.radius.value.value", "555.968445" },
            { "separate.crowd.radius.valueType", "periodic" },
            { "separate.crowd.size.periodic.amplitude.mobJitterScale", "0.185309" },
            { "separate.crowd.size.periodic.amplitude.value", "0.372820" },
            { "separate.crowd.size.periodic.period.mobJitterScale", "-0.554820" },
            { "separate.crowd.size.periodic.period.value", "1501.461426" },
            { "separate.crowd.size.periodic.tickShift.mobJitterScale", "1.000000" },
            { "separate.crowd.size.periodic.tickShift.value", "5780.972168" },
            { "separate.crowd.size.value.mobJitterScale", "-0.649035" },
            { "separate.crowd.size.value.value", "1.486274" },
            { "separate.crowd.size.valueType", "constant" },
            { "separate.crowdType", "never" },
            { "separate.radius.periodic.amplitude.mobJitterScale", "-0.698089" },
            { "separate.radius.periodic.period.mobJitterScale", "-0.837573" },
            { "separate.radius.periodic.tickShift.mobJitterScale", "-0.218818" },
            { "separate.radius.periodic.tickShift.value", "3528.328125" },
            { "separate.radius.value.value", "1592.435059" },
            { "separate.radius.valueType", "periodic" },
            { "separate.rangeType", "quadraticDown" },
            { "separate.weight.periodic.amplitude.value", "0.372159" },
            { "separate.weight.periodic.period.mobJitterScale", "-0.667352" },
            { "separate.weight.periodic.period.value", "1265.711670" },
            { "separate.weight.periodic.tickShift.mobJitterScale", "-0.546899" },
            { "separate.weight.value.mobJitterScale", "-0.306295" },
            { "separate.weight.value.value", "-2.833764" },
            { "simpleAttack", "TRUE" },
            { "startingMaxRadius", "1462.905518" },
            { "startingMinRadius", "613.175354" },
        };
