...
public:
    ...
    void putDefaults(MBRegistry *mreg, FleetAIType aiType) {
        ...
        BundleConfigValue configs5[] = {
            { "align.crowd.radius.periodic.amplitude.mobJitterScale", "0.773816" },
            { "align.crowd.radius.periodic.amplitude.value", "0.531932" },
            { "align.crowd.radius.periodic.period.mobJitterScale", "-0.872063" },
            { "align.crowd.radius.periodic.period.value", "6809.119629" },
            { "align.crowd.radius.periodic.tickShift.mobJitterScale", "0.548249" },
            { "align.crowd.radius.periodic.tickShift.value", "1093.369629" },
            { "align.crowd.radius.value.mobJitterScale", "-1.000000" },
            { "align.crowd.radius.value.value", "330.432159" },
            ...
            { "align.crowdType", "strictOff" },
            { "align.radius.periodic.amplitude.mobJitterScale", "-0.103650" },
            { "align.radius.periodic.amplitude.value", "-0.215587" },
            { "align.radius.periodic.period.mobJitterScale", "-0.504149" },
            { "align.radius.periodic.period.value", "2593.607178" },
            { "align.radius.periodic.tickShift.mobJitterScale", "-0.627764" },
            { "align.radius.periodic.tickShift.value", "4706.968262" },
            { "align.radius.value.mobJitterScale", "0.769160" },
            { "align.radius.value.value", "-1.000000" },
            { "align.radius.valueType", "periodic" },
            { "align.rangeType", "quadraticDown" },
            ...
            { "attackSeparate.crowd.radius.periodic.amplitude.mobJitterScale", "-0.127337" },
            { "attackSeparate.crowd.radius.periodic.amplitude.value", "0.867969" },
            { "attackSeparate.crowd.radius.periodic.period.mobJitterScale", "-0.650682" },
            { "attackSeparate.crowd.radius.periodic.period.value", "-0.990000" },
            { "attackSeparate.crowd.radius.periodic.tickShift.mobJitterScale", "0.792535" },
            { "attackSeparate.crowd.radius.periodic.tickShift.value", "3070.885010" },
            { "attackSeparate.crowd.radius.value.mobJitterScale", "0.069181" },
            { "attackSeparate.crowd.radius.value.value", "1373.903198" },
            ...
            { "attackSeparate.crowdType", "never" },
            { "attackSeparate.radius.periodic.amplitude.mobJitterScale", "0.371149" },
            { "attackSeparate.radius.periodic.amplitude.value", "-0.435201" },
            { "attackSeparate.radius.periodic.period.mobJitterScale", "0.730247" },
            { "attackSeparate.radius.periodic.period.value", "3255.769531" },
            { "attackSeparate.radius.periodic.tickShift.mobJitterScale", "0.782087" },
            { "attackSeparate.radius.periodic.tickShift.value", "1119.629150" },
            { "attackSeparate.radius.value.mobJitterScale", "-0.483809" },
            { "attackSeparate.radius.value.value", "1928.739868" },
            { "attackSeparate.radius.valueType", "periodic" },
            { "attackSeparate.rangeType", "quadraticDown" },
            ...
            { "base.crowd.radius.periodic.amplitude.mobJitterScale", "-0.143468" },
            { "base.crowd.radius.periodic.amplitude.value", "1.000000" },
            { "base.crowd.radius.periodic.period.mobJitterScale", "0.033025" },
            { "base.crowd.radius.periodic.period.value", "2163.767090" },
            { "base.crowd.radius.periodic.tickShift.mobJitterScale", "-1.000000" },
            { "base.crowd.radius.periodic.tickShift.value", "1676.326050" },
            { "base.crowd.radius.value.mobJitterScale", "-0.648948" },
            { "base.crowd.radius.value.value", "827.924133" },
            { "base.crowd.radius.valueType", "constant" },
            ...
            { "base.crowd.size.valueType", "periodic" },
            { "base.radius.periodic.amplitude.mobJitterScale", "-0.067425" },
            { "base.radius.periodic.amplitude.value", "0.706420" },
            { "base.radius.periodic.period.mobJitterScale", "0.527732" },
            { "base.radius.periodic.period.value", "5201.663086" },
            { "base.radius.periodic.tickShift.mobJitterScale", "0.557585" },
            { "base.radius.periodic.tickShift.value", "5289.015137" },
            { "base.radius.value.mobJitterScale", "-0.272672" },
            { "base.radius.value.value", "1037.696167" },
            { "base.radius.valueType", "constant" },
            { "base.rangeType", "quadraticDown" },
            ...
            { "base.weight.valueType", "periodic" },
            { "baseDefense.crowd.radius.periodic.amplitude.mobJitterScale", "0.139872" },
            { "baseDefense.crowd.radius.periodic.amplitude.value", "-0.794197" },
            { "baseDefense.crowd.radius.periodic.period.mobJitterScale", "0.217053" },
            { "baseDefense.crowd.radius.periodic.period.value", "-1.000000" },
            { "baseDefense.crowd.radius.periodic.tickShift.mobJitterScale", "-0.294163" },
            { "baseDefense.crowd.radius.periodic.tickShift.value", "5248.515137" },
            { "baseDefense.crowd.radius.value.mobJitterScale", "0.439425" },
            { "baseDefense.crowd.radius.value.value", "-0.900000" },
            { "baseDefense.crowd.radius.valueType", "constant" },
            ...
            { "baseDefense.crowdType", "quadraticDown" },
            { "baseDefense.radius.periodic.amplitude.mobJitterScale", "-0.898434" },
            { "baseDefense.radius.periodic.amplitude.value", "0.503716" },
            { "baseDefense.radius.periodic.period.mobJitterScale", "0.158888" },
            { "baseDefense.radius.periodic.period.value", "6628.075684" },
            { "baseDefense.radius.periodic.tickShift.mobJitterScale", "-0.663771" },
            { "baseDefense.radius.periodic.tickShift.value", "2282.360352" },
            { "baseDefense.radius.value.mobJitterScale", "0.237997" },
            { "baseDefense.radius.value.value", "47.057972" },
            { "baseDefense.radius.valueType", "constant" },
            { "baseDefense.rangeType", "linearDown" },
            ...
            { "center.crowd.radius.periodic.amplitude.mobJitterScale", "-0.777972" },
            { "center.crowd.radius.periodic.amplitude.value", "0.798949" },
            { "center.crowd.radius.periodic.period.mobJitterScale", "-1.000000" },
            { "center.crowd.radius.periodic.period.value", "7877.466309" },
            { "center.crowd.radius.periodic.tickShift.mobJitterScale", "0.371853" },
            { "center.crowd.radius.periodic.tickShift.value", "3341.117676" },
            { "center.crowd.radius.value.mobJitterScale", "0.525610" },
            { "center.crowd.radius.value.value", "1544.166138" },
            ...
            { "center.crowd.size.valueType", "constant" },
            { "center.crowdType", "strictOn" },
            { "center.radius.periodic.amplitude.mobJitterScale", "0.789043" },
            { "center.radius.periodic.amplitude.value", "0.451824" },
            { "center.radius.periodic.period.mobJitterScale", "0.122213" },
            { "center.radius.periodic.period.value", "3185.374023" },
            { "center.radius.periodic.tickShift.mobJitterScale", "-0.323503" },
            { "center.radius.periodic.tickShift.value", "3245.539307" },
            { "center.radius.value.mobJitterScale", "-0.377821" },
            { "center.radius.value.value", "1374.222168" },
            { "center.radius.valueType", "constant" },
            { "center.rangeType", "always" },
            ...
            { "center.weight.valueType", "periodic" },
            { "cohere.crowd.radius.periodic.amplitude.mobJitterScale", "0.793762" },
            { "cohere.crowd.radius.periodic.amplitude.value", "-0.200905" },
            { "cohere.crowd.radius.periodic.period.mobJitterScale", "-0.671177" },
            { "cohere.crowd.radius.periodic.period.value", "3256.916260" },
            { "cohere.crowd.radius.periodic.tickShift.mobJitterScale", "-0.082508" },
            { "cohere.crowd.radius.periodic.tickShift.value", "2163.927002" },
            { "cohere.crowd.radius.value.mobJitterScale", "-0.562042" },
            { "cohere.crowd.radius.value.value", "1780.552246" },
            ...
            { "cohere.crowdType", "strictOn" },
            { "cohere.radius.periodic.amplitude.mobJitterScale", "0.810000" },
            { "cohere.radius.periodic.amplitude.value", "0.129742" },
            { "cohere.radius.periodic.period.mobJitterScale", "0.404731" },
            { "cohere.radius.periodic.period.value", "4454.511719" },
            { "cohere.radius.periodic.tickShift.mobJitterScale", "-0.265320" },
            { "cohere.radius.periodic.tickShift.value", "6569.726074" },
            { "cohere.radius.value.mobJitterScale", "0.097655" },
            { "cohere.radius.value.value", "960.147583" },
            { "cohere.radius.valueType", "constant" },
            ...
            { "cohere.weight.valueType", "periodic" },
            { "cores.crowd.radius.periodic.amplitude.mobJitterScale", "-0.220961" },
            { "cores.crowd.radius.periodic.amplitude.value", "0.111419" },
            { "cores.crowd.radius.periodic.period.mobJitterScale", "0.356439" },
            { "cores.crowd.radius.periodic.period.value", "7393.668457" },
            { "cores.crowd.radius.periodic.tickShift.mobJitterScale", "-0.562008" },
            { "cores.crowd.radius.periodic.tickShift.value", "4944.792969" },
            { "cores.crowd.radius.value.mobJitterScale", "-0.733639" },
            { "cores.crowd.radius.value.value", "48.773293" },
            { "cores.crowd.radius.valueType", "periodic" },
            ...
            { "cores.crowd.size.valueType", "constant" },
            { "cores.crowdType", "always" },
            { "cores.radius.periodic.amplitude.mobJitterScale", "1.000000" },
            { "cores.radius.periodic.amplitude.value", "1.000000" },
            { "cores.radius.periodic.period.mobJitterScale", "0.562891" },
            { "cores.radius.periodic.period.value", "3728.972412" },
            { "cores.radius.periodic.tickShift.mobJitterScale", "0.783805" },
            { "cores.radius.periodic.tickShift.value", "6189.655762" },
            { "cores.radius.value.mobJitterScale", "0.320882" },
            { "cores.radius.value.value", "338.741577" },
            { "cores.radius.valueType", "constant" },
            { "cores.rangeType", "always" },
            ...
            { "cores.weight.valueType", "constant" },
            { "corners.crowd.radius.periodic.amplitude.mobJitterScale", "0.614196" },
            { "corners.crowd.radius.periodic.amplitude.value", "0.146834" },
            { "corners.crowd.radius.periodic.period.mobJitterScale", "0.295635" },
            { "corners.crowd.radius.periodic.period.value", "2405.400635" },
            { "corners.crowd.radius.periodic.tickShift.mobJitterScale", "0.538336" },
            { "corners.crowd.radius.periodic.tickShift.value", "-1.000000" },
            { "corners.crowd.radius.value.mobJitterScale", "-1.000000" },
            { "corners.crowd.radius.value.value", "1273.083618" },
            { "corners.crowd.radius.valueType", "constant" },
            ...
            { "corners.radius.periodic.amplitude.mobJitterScale", "0.162802" },
            { "corners.radius.periodic.amplitude.value", "0.205700" },
            { "corners.radius.periodic.period.mobJitterScale", "-1.000000" },
            { "corners.radius.periodic.period.value", "8513.180664" },
            { "corners.radius.periodic.tickShift.mobJitterScale", "-0.902629" },
            { "corners.radius.periodic.tickShift.value", "428.440582" },
            { "corners.radius.value.mobJitterScale", "-0.489866" },
            { "corners.radius.value.value", "1737.401855" },
            { "corners.radius.valueType", "constant" },
            ...
            { "edges.crowd.radius.periodic.amplitude.mobJitterScale", "-0.468820" },
            { "edges.crowd.radius.periodic.amplitude.value", "1.000000" },
            { "edges.crowd.radius.periodic.period.mobJitterScale", "0.500206" },
            { "edges.crowd.radius.periodic.period.value", "1895.671143" },
            { "edges.crowd.radius.periodic.tickShift.mobJitterScale", "0.900000" },
            { "edges.crowd.radius.periodic.tickShift.value", "9928.017578" },
            { "edges.crowd.radius.value.mobJitterScale", "-0.482913" },
            { "edges.crowd.radius.value.value", "182.700409" },
            ...
            { "edges.radius.periodic.amplitude.mobJitterScale", "-0.706828" },
            { "edges.radius.periodic.amplitude.value", "0.068807" },
            { "edges.radius.periodic.period.mobJitterScale", "0.648850" },
            { "edges.radius.periodic.period.value", "5369.750977" },
            { "edges.radius.periodic.tickShift.mobJitterScale", "1.000000" },
            { "edges.radius.periodic.tickShift.value", "1020.260742" },
            { "edges.radius.value.mobJitterScale", "-0.774045" },
            { "edges.radius.value.value", "1190.647827" },
            { "edges.radius.valueType", "constant" },
            ...
            { "edges.weight.valueType", "periodic" },
            { "enemy.crowd.radius.periodic.amplitude.mobJitterScale", "0.778036" },
            { "enemy.crowd.radius.periodic.amplitude.value", "-0.275185" },
            { "enemy.crowd.radius.periodic.period.mobJitterScale", "0.846396" },
            { "enemy.crowd.radius.periodic.period.value", "9062.518555" },
            { "enemy.crowd.radius.periodic.tickShift.mobJitterScale", "-0.252552" },
            { "enemy.crowd.radius.periodic.tickShift.value", "-1.000000" },
            { "enemy.crowd.radius.value.mobJitterScale", "0.071094" },
            { "enemy.crowd.radius.value.value", "2000.000000" },
            ...
            { "enemy.crowd.size.valueType", "constant" },
            { "enemy.crowdType", "never" },
            { "enemy.radius.periodic.amplitude.mobJitterScale", "-0.124516" },
            { "enemy.radius.periodic.amplitude.value", "-0.279534" },
            { "enemy.radius.periodic.period.mobJitterScale", "-0.485041" },
            { "enemy.radius.periodic.period.value", "1062.841309" },
            { "enemy.radius.periodic.tickShift.mobJitterScale", "-0.097877" },
            { "enemy.radius.periodic.tickShift.value", "3565.766602" },
            { "enemy.radius.value.mobJitterScale", "-0.534148" },
            { "enemy.radius.value.value", "322.774628" },
            { "enemy.radius.valueType", "constant" },
            { "enemy.rangeType", "linearDown" },
            ...
            { "enemyBase.crowd.radius.periodic.amplitude.mobJitterScale", "1.000000" },
            { "enemyBase.crowd.radius.periodic.amplitude.value", "-0.500281" },
            { "enemyBase.crowd.radius.periodic.period.mobJitterScale", "-0.494311" },
            { "enemyBase.crowd.radius.periodic.period.value", "6070.160156" },
            { "enemyBase.crowd.radius.periodic.tickShift.mobJitterScale", "-0.881831" },
            { "enemyBase.crowd.radius.periodic.tickShift.value", "7549.542969" },
            { "enemyBase.crowd.radius.value.mobJitterScale", "-0.647612" },
            { "enemyBase.crowd.radius.value.value", "1173.403442" },
            { "enemyBase.crowd.radius.valueType", "constant" },
            ...
            { "enemyBase.crowdType", "linearUp" },
            { "enemyBase.radius.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "enemyBase.radius.periodic.amplitude.value", "0.892146" },
            { "enemyBase.radius.periodic.period.mobJitterScale", "-0.762241" },
            { "enemyBase.radius.periodic.period.value", "5765.630859" },
            { "enemyBase.radius.periodic.tickShift.mobJitterScale", "-0.050843" },
            { "enemyBase.radius.periodic.tickShift.value", "4790.399902" },
            { "enemyBase.radius.value.mobJitterScale", "0.184679" },
            { "enemyBase.radius.value.value", "530.059814" },
            { "enemyBase.radius.valueType", "periodic" },
            ...
            { "fleetLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "0.139218" },
            { "fleetLocus.force.crowd.radius.periodic.amplitude.value", "0.970357" },
            { "fleetLocus.force.crowd.radius.periodic.period.mobJitterScale", "-1.000000" },
            { "fleetLocus.force.crowd.radius.periodic.period.value", "7711.861816" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "0.966953" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.value", "8292.224609" },
            { "fleetLocus.force.crowd.radius.value.mobJitterScale", "0.800082" },
            { "fleetLocus.force.crowd.radius.value.value", "1501.743896" },
            { "fleetLocus.force.crowd.radius.valueType", "constant" },
            ...
            { "fleetLocus.force.crowd.size.valueType", "periodic" },
            { "fleetLocus.force.crowdType", "strictOn" },
            { "fleetLocus.force.radius.periodic.amplitude.mobJitterScale", "-0.194120" },
            { "fleetLocus.force.radius.periodic.amplitude.value", "0.386690" },
            { "fleetLocus.force.radius.periodic.period.mobJitterScale", "1.000000" },
            { "fleetLocus.force.radius.periodic.period.value", "1032.267456" },
            { "fleetLocus.force.radius.periodic.tickShift.mobJitterScale", "-0.422855" },
            { "fleetLocus.force.radius.periodic.tickShift.value", "5188.332031" },
            { "fleetLocus.force.radius.value.mobJitterScale", "0.868949" },
            { "fleetLocus.force.radius.value.value", "1827.765259" },
            { "fleetLocus.force.radius.valueType", "constant" },
            { "fleetLocus.force.rangeType", "always" },
            ...
            { "mobLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "0.165504" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.value", "0.247477" },
            { "mobLocus.force.crowd.radius.periodic.period.mobJitterScale", "1.000000" },
            { "mobLocus.force.crowd.radius.periodic.period.value", "7382.423340" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "-0.519529" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.value", "9915.421875" },
            { "mobLocus.force.crowd.radius.value.mobJitterScale", "-0.781897" },
            { "mobLocus.force.crowd.radius.value.value", "243.272263" },
            { "mobLocus.force.crowd.radius.valueType", "periodic" },
            ...
            { "mobLocus.force.crowd.size.valueType", "periodic" },
            { "mobLocus.force.crowdType", "linearUp" },
            { "mobLocus.force.radius.periodic.amplitude.mobJitterScale", "0.286870" },
            { "mobLocus.force.radius.periodic.amplitude.value", "0.794056" },
            { "mobLocus.force.radius.periodic.period.mobJitterScale", "0.996017" },
            { "mobLocus.force.radius.periodic.period.value", "5794.513672" },
            { "mobLocus.force.radius.periodic.tickShift.mobJitterScale", "0.212289" },
            { "mobLocus.force.radius.periodic.tickShift.value", "2314.237061" },
            { "mobLocus.force.radius.value.mobJitterScale", "0.499106" },
            { "mobLocus.force.radius.value.value", "1496.998535" },
            { "mobLocus.force.radius.valueType", "constant" },
            { "mobLocus.force.rangeType", "strictOff" },
            ...
            { "nearestFriend.crowd.radius.periodic.amplitude.value", "-0.079872" },
            { "nearestFriend.crowd.radius.periodic.period.mobJitterScale", "-0.011918" },
            { "nearestFriend.crowd.radius.periodic.period.value", "6181.295410" },
            { "nearestFriend.crowd.radius.periodic.tickShift.mobJitterScale", "-0.270052" },
            { "nearestFriend.crowd.radius.periodic.tickShift.value", "4150.705078" },
            { "nearestFriend.crowd.radius.value.mobJitterScale", "0.043697" },
            { "nearestFriend.crowd.radius.value.value", "785.779053" },
            ...
            { "nearestFriend.crowd.size.valueType", "periodic" },
            { "nearestFriend.radius.periodic.amplitude.mobJitterScale", "0.335377" },
            { "nearestFriend.radius.periodic.amplitude.value", "0.362549" },
            { "nearestFriend.radius.periodic.period.mobJitterScale", "-0.611512" },
            { "nearestFriend.radius.periodic.period.value", "7575.432617" },
            { "nearestFriend.radius.periodic.tickShift.mobJitterScale", "-0.367669" },
            { "nearestFriend.radius.periodic.tickShift.value", "7958.236816" },
            { "nearestFriend.radius.value.mobJitterScale", "-0.434431" },
            { "nearestFriend.radius.value.value", "1183.872437" },
            { "nearestFriend.radius.valueType", "periodic" },
            ...
            { "separate.crowd.radius.periodic.amplitude.mobJitterScale", "0.114589" },
            { "separate.crowd.radius.periodic.amplitude.value", "0.083034" },
            { "separate.crowd.radius.periodic.period.mobJitterScale", "-0.697423" },
            { "separate.crowd.radius.periodic.period.value", "2721.856445" },
            { "separate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.168553" },
            { "separate.crowd.radius.periodic.tickShift.value", "6264.737305" },
            { "separate.crowd.radius.value.mobJitterScale", "-0.545271" },
            { "separate.crowd.radius.value.value", "909.844849" },
            { "separate.crowd.radius.valueType", "constant" },
            ...
            { "separate.crowdType", "strictOff" },
            { "separate.radius.periodic.amplitude.mobJitterScale", "0.237986" },
            { "separate.radius.periodic.amplitude.value", "-0.203410" },
            { "separate.radius.periodic.period.mobJitterScale", "-0.078867" },
            { "separate.radius.periodic.period.value", "2530.513184" },
            { "separate.radius.periodic.tickShift.mobJitterScale", "-0.412025" },
            { "separate.radius.periodic.tickShift.value", "4656.739746" },
            { "separate.radius.value.mobJitterScale", "-0.310538" },
            { "separate.radius.value.value", "542.744324" },
            { "separate.radius.valueType", "periodic" },
            { "separate.rangeType", "linearDown" },
        ...
        BundleConfigValue configs6[] = {
            { "align.crowd.radius.periodic.amplitude.mobJitterScale", "0.303767"},
            { "align.crowd.radius.periodic.amplitude.value", "-0.028980" },
            { "align.crowd.radius.periodic.period.mobJitterScale", "-1.000000" },
            { "align.crowd.radius.periodic.period.value", "3396.909424" },
            { "align.crowd.radius.periodic.tickShift.mobJitterScale", "0.313868" },
            { "align.crowd.radius.periodic.tickShift.value", "4040.127930" },
            { "align.crowd.radius.value.mobJitterScale", "0.843717" },
            { "align.crowd.radius.value.value", "1462.830566" },
            ...
            { "align.crowd.size.valueType", "periodic" },
            { "align.crowdType", "strictOff" },
            { "align.radius.periodic.amplitude.mobJitterScale", "-0.590458" },
            { "align.radius.periodic.amplitude.value", "0.265961" },
            { "align.radius.periodic.period.mobJitterScale", "-0.620556" },
            { "align.radius.periodic.period.value", "5049.148438" },
            { "align.radius.periodic.tickShift.mobJitterScale", "0.356558" },
            { "align.radius.periodic.tickShift.value", "2067.238525" },
            { "align.radius.value.mobJitterScale", "1.000000" },
            { "align.radius.value.value", "653.465942" },
            { "align.radius.valueType", "periodic" },
            { "align.rangeType", "quadraticDown" },
            ...
            { "attackSeparate.crowd.radius.periodic.amplitude.mobJitterScale", "0.408364" },
            { "attackSeparate.crowd.radius.periodic.amplitude.value", "0.680756" },
            { "attackSeparate.crowd.radius.periodic.period.mobJitterScale", "-0.404524" },
            { "attackSeparate.crowd.radius.periodic.period.value", "7870.269043" },
            { "attackSeparate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.590382" },
            { "attackSeparate.crowd.radius.periodic.tickShift.value", "6012.278320" },
            { "attackSeparate.crowd.radius.value.mobJitterScale", "-0.349955" },
            { "attackSeparate.crowd.radius.value.value", "836.828186" },
            { "attackSeparate.crowd.radius.valueType", "periodic" },
            ...
            { "attackSeparate.crowd.size.valueType", "constant" },
            { "attackSeparate.crowdType", "never" },
            { "attackSeparate.radius.periodic.amplitude.mobJitterScale", "0.785959" },
            { "attackSeparate.radius.periodic.amplitude.value", "-0.650087" },
            { "attackSeparate.radius.periodic.period.mobJitterScale", "0.748814" },
            { "attackSeparate.radius.periodic.period.value", "4984.351562" },
            { "attackSeparate.radius.periodic.tickShift.mobJitterScale", "1.000000" },
            { "attackSeparate.radius.periodic.tickShift.value", "3720.978271" },
            { "attackSeparate.radius.value.mobJitterScale", "-0.928496" },
            { "attackSeparate.radius.value.value", "388.012268" },
            { "attackSeparate.radius.valueType", "periodic" },
            { "attackSeparate.rangeType", "quadraticDown" },
            ...
            { "base.crowd.radius.periodic.amplitude.mobJitterScale", "-0.308537" },
            { "base.crowd.radius.periodic.amplitude.value", "0.878051" },
            { "base.crowd.radius.periodic.period.mobJitterScale", "0.373826" },
            { "base.crowd.radius.periodic.period.value", "1131.804688" },
            { "base.crowd.radius.periodic.tickShift.mobJitterScale", "-0.694907" },
            { "base.crowd.radius.periodic.tickShift.value", "586.410522" },
            { "base.crowd.radius.value.mobJitterScale", "-0.460821" },
            { "base.crowd.radius.value.value", "235.429932" },
            { "base.crowd.radius.valueType", "constant" },
            ...
            { "base.crowd.size.valueType", "constant" },
            { "base.crowdType", "always" },
            { "base.radius.periodic.amplitude.mobJitterScale", "-0.733963" },
            { "base.radius.periodic.amplitude.value", "-0.918238" },
            { "base.radius.periodic.period.mobJitterScale", "-0.743692" },
            { "base.radius.periodic.period.value", "7371.557617" },
            { "base.radius.periodic.tickShift.mobJitterScale", "0.542223" },
            { "base.radius.periodic.tickShift.value", "4797.590332" },
            { "base.radius.value.mobJitterScale", "-0.233012" },
            { "base.radius.value.value", "1342.211548" },
            { "base.radius.valueType", "constant" },
            { "base.rangeType", "quadraticDown" },
            ...
            { "base.weight.valueType", "periodic" },
            { "baseDefense.crowd.radius.periodic.amplitude.mobJitterScale", "-0.345357" },
            { "baseDefense.crowd.radius.periodic.amplitude.value", "0.119525" },
            { "baseDefense.crowd.radius.periodic.period.mobJitterScale", "-0.801793" },
            { "baseDefense.crowd.radius.periodic.period.value", "1869.819214" },
            { "baseDefense.crowd.radius.periodic.tickShift.mobJitterScale", "-0.109900" },
            { "baseDefense.crowd.radius.periodic.tickShift.value", "4723.663574" },
            { "baseDefense.crowd.radius.value.mobJitterScale", "0.509529" },
            { "baseDefense.crowd.radius.value.value", "-0.900000" },
            ...
            { "baseDefense.crowd.size.valueType", "constant" },
            { "baseDefense.crowdType", "quadraticDown" },
            { "baseDefense.radius.periodic.amplitude.mobJitterScale", "0.355040" },
            { "baseDefense.radius.periodic.amplitude.value", "-0.809205" },
            { "baseDefense.radius.periodic.period.mobJitterScale", "-0.054079" },
            { "baseDefense.radius.periodic.period.value", "7848.520508" },
            { "baseDefense.radius.periodic.tickShift.mobJitterScale", "-0.367415" },
            { "baseDefense.radius.periodic.tickShift.value", "2458.569580" },
            { "baseDefense.radius.value.mobJitterScale", "-0.900000" },
            { "baseDefense.radius.value.value", "338.759857" },
            { "baseDefense.radius.valueType", "constant" },
            { "baseDefense.rangeType", "quadraticDown" },
            ...
            { "center.crowd.radius.periodic.amplitude.mobJitterScale", "-0.777972" },
            { "center.crowd.radius.periodic.amplitude.value", "0.033675" },
            { "center.crowd.radius.periodic.period.mobJitterScale", "-0.074787" },
            { "center.crowd.radius.periodic.period.value", "73.988731" },
            { "center.crowd.radius.periodic.tickShift.mobJitterScale", "0.737212" },
            { "center.crowd.radius.periodic.tickShift.value", "3361.212891" },
            { "center.crowd.radius.value.mobJitterScale", "0.843037" },
            { "center.crowd.radius.value.value", "978.496460" },
            { "center.crowd.radius.valueType", "periodic" },
            ...
            { "center.crowd.size.valueType", "constant" },
            { "center.crowdType", "strictOff" },
            { "center.radius.periodic.amplitude.mobJitterScale", "-0.470269" },
            { "center.radius.periodic.amplitude.value", "0.406305" },
            { "center.radius.periodic.period.mobJitterScale", "-0.630931" },
            { "center.radius.periodic.period.value", "3108.676514" },
            { "center.radius.periodic.tickShift.mobJitterScale", "-0.300984" },
            { "center.radius.periodic.tickShift.value", "6037.275879" },
            { "center.radius.value.mobJitterScale", "-0.534004" },
            { "center.radius.value.value", "421.806915" },
            { "center.radius.valueType", "constant" },
            { "center.rangeType", "always" },
            ...
            { "center.weight.valueType", "periodic" },
            { "cohere.crowd.radius.periodic.amplitude.mobJitterScale", "-0.716312" },
            { "cohere.crowd.radius.periodic.amplitude.value", "0.371293" },
            { "cohere.crowd.radius.periodic.period.mobJitterScale", "-0.186474" },
            { "cohere.crowd.radius.periodic.period.value", "8007.612793" },
            { "cohere.crowd.radius.periodic.tickShift.mobJitterScale", "-0.769986" },
            { "cohere.crowd.radius.periodic.tickShift.value", "1878.314697" },
            { "cohere.crowd.radius.value.mobJitterScale", "-0.796296" },
            { "cohere.crowd.radius.value.value", "1571.860718" },
            { "cohere.crowd.radius.valueType", "constant" },
            ...
            { "cohere.crowdType", "quadraticUp" },
            { "cohere.radius.periodic.amplitude.mobJitterScale", "-0.206370" },
            { "cohere.radius.periodic.amplitude.value", "0.805316" },
            { "cohere.radius.periodic.period.mobJitterScale", "-0.983127" },
            { "cohere.radius.periodic.period.value", "4315.744629" },
            { "cohere.radius.periodic.tickShift.mobJitterScale", "-0.385872" },
            { "cohere.radius.periodic.tickShift.value", "3923.043457" },
            { "cohere.radius.value.mobJitterScale", "0.532986" },
            { "cohere.radius.value.value", "1256.103394" },
            { "cohere.radius.valueType", "periodic" },
            ...
            { "cohere.weight.valueType", "constant" },
            { "cores.crowd.radius.periodic.amplitude.mobJitterScale", "0.477978" },
            { "cores.crowd.radius.periodic.amplitude.value", "-0.948364" },
            { "cores.crowd.radius.periodic.period.mobJitterScale", "0.442191" },
            { "cores.crowd.radius.periodic.period.value", "9811.847656" },
            { "cores.crowd.radius.periodic.tickShift.mobJitterScale", "-1.000000" },
            { "cores.crowd.radius.periodic.tickShift.value", "584.104919" },
            { "cores.crowd.radius.value.mobJitterScale", "-0.619411" },
            { "cores.crowd.radius.value.value", "415.072845" },
            { "cores.crowd.radius.valueType", "periodic" },
            ...
            { "cores.crowd.size.valueType", "constant" },
            { "cores.crowdType", "strictOn" },
            { "cores.radius.periodic.amplitude.mobJitterScale", "0.900000" },
            { "cores.radius.periodic.amplitude.value", "0.649809" },
            { "cores.radius.periodic.period.mobJitterScale", "0.596434" },
            { "cores.radius.periodic.period.value", "4720.613770" },
            { "cores.radius.periodic.tickShift.mobJitterScale", "0.900000" },
            { "cores.radius.periodic.tickShift.value", "7878.717773" },
            { "cores.radius.value.mobJitterScale", "0.101870" },
            { "cores.radius.value.value", "1826.412354" },
            { "cores.radius.valueType", "periodic" },
            { "cores.rangeType", "linearDown" },
            ...
            { "cores.weight.valueType", "constant" },
            { "corners.crowd.radius.periodic.amplitude.mobJitterScale", "0.403897" },
            { "corners.crowd.radius.periodic.amplitude.value", "-0.256576" },
            { "corners.crowd.radius.periodic.period.mobJitterScale", "-0.066142" },
            { "corners.crowd.radius.periodic.period.value", "3351.063965" },
            { "corners.crowd.radius.periodic.tickShift.mobJitterScale", "1.000000" },
            { "corners.crowd.radius.periodic.tickShift.value", "2015.971313" },
            { "corners.crowd.radius.value.mobJitterScale", "0.466270" },
            { "corners.crowd.radius.value.value", "1218.303101" },
            { "corners.crowd.radius.valueType", "constant" },
            ...
            { "corners.crowd.size.valueType", "constant" },
            { "corners.crowdType", "never" },
            { "corners.radius.periodic.amplitude.mobJitterScale", "0.825848" },
            { "corners.radius.periodic.amplitude.value", "0.226270" },
            { "corners.radius.periodic.period.mobJitterScale", "0.267180" },
            { "corners.radius.periodic.period.value", "10000.000000" },
            { "corners.radius.periodic.tickShift.mobJitterScale", "0.473145" },
            { "corners.radius.periodic.tickShift.value", "4363.056641" },
            { "corners.radius.value.mobJitterScale", "-0.678814" },
            { "corners.radius.value.value", "1079.862793" },
            { "corners.radius.valueType", "constant" },
            { "corners.rangeType", "quadraticDown" },
            ...
            { "edges.crowd.radius.periodic.amplitude.mobJitterScale", "-0.210496" },
            { "edges.crowd.radius.periodic.amplitude.value", "-0.674202" },
            { "edges.crowd.radius.periodic.period.mobJitterScale", "-0.675476" },
            { "edges.crowd.radius.periodic.period.value", "380.741638" },
            { "edges.crowd.radius.periodic.tickShift.mobJitterScale", "0.039908" },
            { "edges.crowd.radius.periodic.tickShift.value", "9209.983398" },
            { "edges.crowd.radius.value.mobJitterScale", "-0.804072" },
            { "edges.crowd.radius.value.value", "1540.808594" },
            ...
            { "edges.crowd.size.valueType", "periodic" },
            { "edges.crowdType", "strictOff" },
            { "edges.radius.periodic.amplitude.mobJitterScale", "0.352999" },
            { "edges.radius.periodic.amplitude.value", "0.709915" },
            { "edges.radius.periodic.period.mobJitterScale", "0.670024" },
            { "edges.radius.periodic.period.value", "8719.189453" },
            { "edges.radius.periodic.tickShift.mobJitterScale", "1.000000" },
            { "edges.radius.periodic.tickShift.value", "4223.023438" },
            { "edges.radius.value.mobJitterScale", "-0.564561" },
            { "edges.radius.value.value", "1884.610596" },
            { "edges.radius.valueType", "constant" },
            { "edges.rangeType", "quadraticUp" },
            ...
            { "edges.weight.valueType", "periodic" },
            { "enemy.crowd.radius.periodic.amplitude.mobJitterScale", "1.000000" },
            { "enemy.crowd.radius.periodic.amplitude.value", "1.000000" },
            { "enemy.crowd.radius.periodic.period.mobJitterScale", "-1.000000" },
            { "enemy.crowd.radius.periodic.period.value", "1835.988281" },
            { "enemy.crowd.radius.periodic.tickShift.mobJitterScale", "-0.325229" },
            { "enemy.crowd.radius.periodic.tickShift.value", "9834.126953" },
            { "enemy.crowd.radius.value.mobJitterScale", "-1.000000" },
            { "enemy.crowd.radius.value.value", "1055.827515" },
            { "enemy.crowd.radius.valueType", "periodic" },
            ...
            { "enemy.crowd.size.valueType", "constant" },
            { "enemy.crowdType", "never" },
            { "enemy.radius.periodic.amplitude.mobJitterScale", "-0.441839" },
            { "enemy.radius.periodic.amplitude.value", "-0.886941" },
            { "enemy.radius.periodic.period.mobJitterScale", "-0.475719" },
            { "enemy.radius.periodic.period.value", "8166.400391" },
            { "enemy.radius.periodic.tickShift.mobJitterScale", "-0.802857" },
            { "enemy.radius.periodic.tickShift.value", "3639.149902" },
            { "enemy.radius.value.mobJitterScale", "-0.622471" },
            { "enemy.radius.value.value", "1427.624023" },
            { "enemy.radius.valueType", "constant" },
            { "enemy.rangeType", "linearDown" },
            ...
            { "enemy.weight.valueType", "constant" },
            { "enemyBase.crowd.radius.periodic.amplitude.mobJitterScale", "0.355722" },
            { "enemyBase.crowd.radius.periodic.amplitude.value", "-0.201086" },
            { "enemyBase.crowd.radius.periodic.period.mobJitterScale", "-0.653379" },
            { "enemyBase.crowd.radius.periodic.period.value", "5540.330078" },
            { "enemyBase.crowd.radius.periodic.tickShift.mobJitterScale", "0.297608" },
            { "enemyBase.crowd.radius.periodic.tickShift.value", "10000.000000" },
            { "enemyBase.crowd.radius.value.mobJitterScale", "-0.853353" },
            { "enemyBase.crowd.radius.value.value", "108.650070" },
            { "enemyBase.crowd.radius.valueType", "constant" },
            ...
            { "enemyBase.crowd.size.valueType", "periodic" },
            { "enemyBase.crowdType", "quadraticDown" },
            { "enemyBase.radius.periodic.amplitude.mobJitterScale", "-0.800307" },
            { "enemyBase.radius.periodic.amplitude.value", "0.122007" },
            { "enemyBase.radius.periodic.period.mobJitterScale", "0.843012" },
            { "enemyBase.radius.periodic.period.value", "5151.595215" },
            { "enemyBase.radius.periodic.tickShift.mobJitterScale", "0.101504" },
            { "enemyBase.radius.periodic.tickShift.value", "2373.663086" },
            { "enemyBase.radius.value.mobJitterScale", "0.352570" },
            { "enemyBase.radius.value.value", "1291.818726" },
            { "enemyBase.radius.valueType", "constant" },
            { "enemyBase.rangeType", "quadraticDown" },
            ...
            { "fleetLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "-0.049298" },
            { "fleetLocus.force.crowd.radius.periodic.amplitude.value", "0.023914" },
            { "fleetLocus.force.crowd.radius.periodic.period.mobJitterScale", "0.577136" },
            { "fleetLocus.force.crowd.radius.periodic.period.value", "4158.054688" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "0.840494" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.value", "3528.776367" },
            { "fleetLocus.force.crowd.radius.value.mobJitterScale", "0.641586" },
            { "fleetLocus.force.crowd.radius.value.value", "1556.019409" },
            { "fleetLocus.force.crowd.radius.valueType", "constant" },
            ...
            { "fleetLocus.force.crowd.size.valueType", "periodic" },
            { "fleetLocus.force.crowdType", "always" },
            { "fleetLocus.force.radius.periodic.amplitude.mobJitterScale", "-0.282212" },
            { "fleetLocus.force.radius.periodic.amplitude.value", "-0.508336" },
            { "fleetLocus.force.radius.periodic.period.mobJitterScale", "-0.216779" },
            { "fleetLocus.force.radius.periodic.period.value", "8087.954102" },
            { "fleetLocus.force.radius.periodic.tickShift.mobJitterScale", "-0.418626" },
            { "fleetLocus.force.radius.periodic.tickShift.value", "5650.093750" },
            { "fleetLocus.force.radius.value.mobJitterScale", "-0.482937" },
            { "fleetLocus.force.radius.value.value", "1421.532227" },
            { "fleetLocus.force.radius.valueType", "constant" },
            { "fleetLocus.force.rangeType", "always" },
            ...
            { "mobLocus.circularWeight.valueType", "constant" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "-0.883554" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.value", "-0.352387" },
            { "mobLocus.force.crowd.radius.periodic.period.mobJitterScale", "-0.877645" },
            { "mobLocus.force.crowd.radius.periodic.period.value", "2471.635498" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "-0.325888" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.value", "3006.935547" },
            { "mobLocus.force.crowd.radius.value.mobJitterScale", "-1.000000" },
            { "mobLocus.force.crowd.radius.value.value", "1633.973999" },
            { "mobLocus.force.crowd.radius.valueType", "periodic" },
            ...
            { "mobLocus.force.crowd.size.valueType", "constant" },
            { "mobLocus.force.crowdType", "quadraticDown" },
            { "mobLocus.force.radius.periodic.amplitude.mobJitterScale", "-0.783651" },
            { "mobLocus.force.radius.periodic.amplitude.value", "-0.128708" },
            { "mobLocus.force.radius.periodic.period.mobJitterScale", "-0.439087" },
            { "mobLocus.force.radius.periodic.period.value", "7645.979980" },
            { "mobLocus.force.radius.periodic.tickShift.mobJitterScale", "0.016458" },
            { "mobLocus.force.radius.periodic.tickShift.value", "-0.900000" },
            { "mobLocus.force.radius.value.mobJitterScale", "0.810088" },
            { "mobLocus.force.radius.value.value", "1343.021606" },
            { "mobLocus.force.radius.valueType", "constant" },
            { "mobLocus.force.rangeType", "strictOff" },
            ...
            { "nearBaseRandomIdle", "TRUE" },
            { "nearestFriend.crowd.radius.periodic.amplitude.mobJitterScale", "0.894288" },
            { "nearestFriend.crowd.radius.periodic.amplitude.value", "-0.900000" },
            { "nearestFriend.crowd.radius.periodic.period.mobJitterScale", "-0.193002" },
            { "nearestFriend.crowd.radius.periodic.period.value", "8103.985840" },
            { "nearestFriend.crowd.radius.periodic.tickShift.mobJitterScale", "-0.941075" },
            { "nearestFriend.crowd.radius.periodic.tickShift.value", "752.274658" },
            { "nearestFriend.crowd.radius.value.mobJitterScale", "-0.153269" },
            { "nearestFriend.crowd.radius.value.value", "490.943604" },
            { "nearestFriend.crowd.radius.valueType", "constant" },
            ...
            { "nearestFriend.crowd.size.valueType", "periodic" },
            { "nearestFriend.radius.periodic.amplitude.mobJitterScale", "0.281290" },
            { "nearestFriend.radius.periodic.amplitude.value", "-0.618121" },
            { "nearestFriend.radius.periodic.period.mobJitterScale", "-0.472305" },
            { "nearestFriend.radius.periodic.period.value", "5906.472168" },
            { "nearestFriend.radius.periodic.tickShift.mobJitterScale", "-0.818305" },
            { "nearestFriend.radius.periodic.tickShift.value", "1229.078247" },
            { "nearestFriend.radius.value.mobJitterScale", "0.317248" },
            { "nearestFriend.radius.value.value", "-0.980100" },
            { "nearestFriend.radius.valueType", "periodic" },
            { "nearestFriend.rangeType", "always" },
            ...
            { "sensorGrid.staleFighterTime", "1.707165" },
            { "separate.crowd.radius.periodic.amplitude.mobJitterScale", "0.860380" },
            { "separate.crowd.radius.periodic.amplitude.value", "-0.306259" },
            { "separate.crowd.radius.periodic.period.mobJitterScale", "-0.265697" },
            { "separate.crowd.radius.periodic.period.value", "8421.583984" },
            { "separate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.169477" },
            { "separate.crowd.radius.periodic.tickShift.value", "4562.610840" },
            { "separate.crowd.radius.value.mobJitterScale", "0.011466" },
            { "separate.crowd.radius.value.value", "180.239548" },
            { "separate.crowd.radius.valueType", "constant" },
            ...
            { "separate.crowd.size.valueType", "constant" },
            { "separate.crowdType", "linearDown" },
            { "separate.radius.periodic.amplitude.mobJitterScale", "0.261785" },
            { "separate.radius.periodic.amplitude.value", "-0.675898" },
            { "separate.radius.periodic.period.mobJitterScale", "-0.024811" },
            { "separate.radius.periodic.period.value", "1811.048096" },
            { "separate.radius.periodic.tickShift.mobJitterScale", "0.374472" },
            { "separate.radius.periodic.tickShift.value", "4564.070801" },
            { "separate.radius.value.mobJitterScale", "0.876786" },
            { "separate.radius.value.value", "844.060608" },
            { "separate.radius.valueType", "periodic" },
            { "separate.rangeType", "linearDown" },
        ...
        BundleConfigValue configs7[] = {
            { "align.crowd.radius.periodic.amplitude.mobJitterScale", "0.653555" },
            { "align.crowd.radius.periodic.amplitude.value", "0.652492" },
            { "align.crowd.radius.periodic.period.mobJitterScale", "0.596374" },
            { "align.crowd.radius.periodic.period.value", "9913.634766" },
            { "align.crowd.radius.periodic.tickShift.mobJitterScale", "0.740750" },
            { "align.crowd.radius.periodic.tickShift.value", "7700.037598" },
            { "align.crowd.radius.value.mobJitterScale", "0.329074" },
            ...
            { "align.radius.periodic.amplitude.mobJitterScale", "-0.375990" },
            { "align.radius.periodic.amplitude.value", "-0.390739" },
            { "align.radius.periodic.period.mobJitterScale", "0.130139" },
            { "align.radius.periodic.period.value", "10000.000000" },
            { "align.radius.periodic.tickShift.mobJitterScale", "-0.776108" },
            { "align.radius.periodic.tickShift.value", "7148.439941" },
            { "align.radius.value.mobJitterScale", "-0.246045" },
            { "align.radius.value.value", "1046.518433" },
            { "align.radius.valueType", "constant" },
            { "align.rangeType", "never" },
            ...
            { "attackSeparate.crowd.radius.periodic.amplitude.mobJitterScale", "0.149401" },
            { "attackSeparate.crowd.radius.periodic.amplitude.value", "-0.951722" },
            { "attackSeparate.crowd.radius.periodic.period.mobJitterScale", "-0.632135" },
            { "attackSeparate.crowd.radius.periodic.period.value", "5261.521484" },
            { "attackSeparate.crowd.radius.periodic.tickShift.mobJitterScale", "0.804713" },
            { "attackSeparate.crowd.radius.periodic.tickShift.value", "1196.707153" },
            { "attackSeparate.crowd.radius.value.mobJitterScale", "-0.371070" },
            { "attackSeparate.crowd.radius.value.value", "1587.109619" },
            { "attackSeparate.crowd.radius.valueType", "periodic" },
            ...
            { "attackSeparate.radius.periodic.amplitude.mobJitterScale", "-0.615626" },
            { "attackSeparate.radius.periodic.amplitude.value", "0.900000" },
            { "attackSeparate.radius.periodic.period.mobJitterScale", "0.093444" },
            { "attackSeparate.radius.periodic.period.value", "4610.033691" },
            { "attackSeparate.radius.periodic.tickShift.mobJitterScale", "-0.099879" },
            { "attackSeparate.radius.periodic.tickShift.value", "8042.772949" },
            { "attackSeparate.radius.value.mobJitterScale", "0.203820" },
            { "attackSeparate.radius.value.value", "809.848755" },
            { "attackSeparate.radius.valueType", "periodic" },
            { "attackSeparate.rangeType", "linearDown" },
            ...
            { "attackSeparate.weight.valueType", "constant" },
            { "base.crowd.radius.periodic.amplitude.mobJitterScale", "0.741534" },
            { "base.crowd.radius.periodic.amplitude.value", "0.582580" },
            { "base.crowd.radius.periodic.period.mobJitterScale", "0.516584" },
            { "base.crowd.radius.periodic.period.value", "8186.723633" },
            { "base.crowd.radius.periodic.tickShift.mobJitterScale", "-0.875177" },
            { "base.crowd.radius.periodic.tickShift.value", "5995.842773" },
            { "base.crowd.radius.value.mobJitterScale", "-0.452220" },
            { "base.crowd.radius.value.value", "1740.667725" },
            { "base.crowd.radius.valueType", "periodic" },
            ...
            { "base.crowd.size.valueType", "constant" },
            { "base.crowdType", "quadraticDown" },
            { "base.radius.periodic.amplitude.mobJitterScale", "0.510039" },
            { "base.radius.periodic.amplitude.value", "0.746824" },
            { "base.radius.periodic.period.mobJitterScale", "-0.767744" },
            { "base.radius.periodic.period.value", "-1.000000" },
            { "base.radius.periodic.tickShift.mobJitterScale", "-0.127995" },
            { "base.radius.periodic.tickShift.value", "2971.962402" },
            { "base.radius.value.mobJitterScale", "-0.602608" },
            { "base.radius.value.value", "894.427368" },
            { "base.radius.valueType", "constant" },
            { "base.rangeType", "quadraticUp" },
            ...
            { "base.weight.valueType", "constant" },
            { "baseDefense.crowd.radius.periodic.amplitude.mobJitterScale", "0.446866" },
            { "baseDefense.crowd.radius.periodic.amplitude.value", "0.689858" },
            { "baseDefense.crowd.radius.periodic.period.mobJitterScale", "0.960214" },
            { "baseDefense.crowd.radius.periodic.period.value", "4945.483887" },
            { "baseDefense.crowd.radius.periodic.tickShift.mobJitterScale", "-0.492756" },
            { "baseDefense.crowd.radius.periodic.tickShift.value", "1323.097290" },
            { "baseDefense.crowd.radius.value.mobJitterScale", "0.221905" },
            { "baseDefense.crowd.radius.value.value", "190.752914" },
            { "baseDefense.crowd.radius.valueType", "periodic" },
            ...
            { "baseDefense.crowd.size.valueType", "constant" },
            { "baseDefense.crowdType", "strictOn" },
            { "baseDefense.radius.periodic.amplitude.mobJitterScale", "0.365004" },
            { "baseDefense.radius.periodic.amplitude.value", "0.256863" },
            { "baseDefense.radius.periodic.period.mobJitterScale", "0.087917" },
            { "baseDefense.radius.periodic.period.value", "5346.260254" },
            { "baseDefense.radius.periodic.tickShift.mobJitterScale", "0.900000" },
            { "baseDefense.radius.periodic.tickShift.value", "4674.336914" },
            { "baseDefense.radius.value.mobJitterScale", "-0.900000" },
            { "baseDefense.radius.value.value", "894.895386" },
            { "baseDefense.radius.valueType", "constant" },
            { "baseDefense.rangeType", "linearUp" },
            ...
            { "center.crowd.radius.periodic.amplitude.mobJitterScale", "-0.618629" },
            { "center.crowd.radius.periodic.amplitude.value", "-0.824285" },
            { "center.crowd.radius.periodic.period.mobJitterScale", "0.672028" },
            { "center.crowd.radius.periodic.period.value", "1875.173950" },
            { "center.crowd.radius.periodic.tickShift.mobJitterScale", "0.412306" },
            { "center.crowd.radius.periodic.tickShift.value", "7709.014160" },
            { "center.crowd.radius.value.mobJitterScale", "-0.276397" },
            { "center.crowd.radius.value.value", "2000.000000" },
            { "center.crowd.radius.valueType", "constant" },
            ...
            { "center.crowd.size.valueType", "constant" },
            { "center.crowdType", "quadraticDown" },
            { "center.radius.periodic.amplitude.mobJitterScale", "0.445817" },
            { "center.radius.periodic.amplitude.value", "-0.529666" },
            { "center.radius.periodic.period.mobJitterScale", "0.649338" },
            { "center.radius.periodic.period.value", "5419.169922" },
            { "center.radius.periodic.tickShift.mobJitterScale", "0.522481" },
            { "center.radius.periodic.tickShift.value", "3851.185059" },
            { "center.radius.value.mobJitterScale", "0.809273" },
            { "center.radius.value.value", "796.595825" },
            { "center.radius.valueType", "constant" },
            { "center.rangeType", "always" },
            ...
            { "center.weight.valueType", "periodic" },
            { "cohere.crowd.radius.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "cohere.crowd.radius.periodic.amplitude.value", "0.419012" },
            { "cohere.crowd.radius.periodic.period.mobJitterScale", "0.378379" },
            { "cohere.crowd.radius.periodic.period.value", "-1.000000" },
            { "cohere.crowd.radius.periodic.tickShift.mobJitterScale", "0.002584" },
            { "cohere.crowd.radius.periodic.tickShift.value", "1043.144409" },
            { "cohere.crowd.radius.value.mobJitterScale", "-0.087265" },
            { "cohere.crowd.radius.value.value", "778.665344" },
            { "cohere.crowd.radius.valueType", "constant" },
            ...
            { "cohere.crowdType", "quadraticUp" },
            { "cohere.radius.periodic.amplitude.mobJitterScale", "0.773034" },
            { "cohere.radius.periodic.amplitude.value", "-0.473515" },
            { "cohere.radius.periodic.period.mobJitterScale", "0.618839" },
            { "cohere.radius.periodic.period.value", "989.001953" },
            { "cohere.radius.periodic.tickShift.mobJitterScale", "-0.040459" },
            { "cohere.radius.periodic.tickShift.value", "7662.532227" },
            { "cohere.radius.value.mobJitterScale", "0.105630" },
            { "cohere.radius.value.value", "1517.630005" },
            { "cohere.radius.valueType", "periodic" },
            { "cohere.rangeType", "never" },
            ...
            { "cohere.weight.valueType", "constant" },
            { "cores.crowd.radius.periodic.amplitude.mobJitterScale", "-0.297693" },
            { "cores.crowd.radius.periodic.amplitude.value", "0.181148" },
            { "cores.crowd.radius.periodic.period.mobJitterScale", "0.057994" },
            { "cores.crowd.radius.periodic.period.value", "6757.915039" },
            { "cores.crowd.radius.periodic.tickShift.mobJitterScale", "-0.973643" },
            { "cores.crowd.radius.periodic.tickShift.value", "10000.000000" },
            { "cores.crowd.radius.value.mobJitterScale", "-0.534257" },
            { "cores.crowd.radius.value.value", "572.910583" },
            { "cores.crowd.radius.valueType", "periodic" },
            ...
            { "cores.crowd.size.valueType", "constant" },
            { "cores.crowdType", "strictOff" },
            { "cores.radius.periodic.amplitude.mobJitterScale", "0.561953" },
            { "cores.radius.periodic.amplitude.value", "-0.459170" },
            { "cores.radius.periodic.period.mobJitterScale", "0.120379" },
            { "cores.radius.periodic.period.value", "6655.360352" },
            { "cores.radius.periodic.tickShift.mobJitterScale", "-0.579671" },
            { "cores.radius.periodic.tickShift.value", "5619.370117" },
            { "cores.radius.value.mobJitterScale", "0.839069" },
            { "cores.radius.value.value", "1802.905029" },
            { "cores.radius.valueType", "periodic" },
            { "cores.rangeType", "quadraticUp" },
            ...
            { "corners.crowd.radius.periodic.amplitude.mobJitterScale", "0.545276" },
            { "corners.crowd.radius.periodic.amplitude.value", "-0.667573" },
            { "corners.crowd.radius.periodic.period.mobJitterScale", "-0.494348" },
            { "corners.crowd.radius.periodic.period.value", "3729.355225" },
            { "corners.crowd.radius.periodic.tickShift.mobJitterScale", "-1.000000" },
            { "corners.crowd.radius.periodic.tickShift.value", "9298.952148" },
            { "corners.crowd.radius.value.mobJitterScale", "-0.023283" },
            { "corners.crowd.radius.value.value", "881.891785" },
            { "corners.crowd.radius.valueType", "periodic" },
            ...
            { "corners.crowd.size.valueType", "periodic" },
            { "corners.crowdType", "always" },
            { "corners.radius.periodic.amplitude.mobJitterScale", "-0.292849" },
            { "corners.radius.periodic.amplitude.value", "0.575863" },
            { "corners.radius.periodic.period.mobJitterScale", "-0.237989" },
            { "corners.radius.periodic.period.value", "9375.089844" },
            { "corners.radius.periodic.tickShift.mobJitterScale", "-1.000000" },
            { "corners.radius.periodic.tickShift.value", "10000.000000" },
            { "corners.radius.value.mobJitterScale", "0.351557" },
            { "corners.radius.value.value", "1190.916992" },
            { "corners.radius.valueType", "periodic" },
            { "corners.rangeType", "quadraticDown" },
            ...
            { "curHeadingWeight.valueType", "constant" },
            { "edges.crowd.radius.periodic.amplitude.mobJitterScale", "-0.264377" },
            { "edges.crowd.radius.periodic.amplitude.value", "-0.328272" },
            { "edges.crowd.radius.periodic.period.mobJitterScale", "0.073687" },
            { "edges.crowd.radius.periodic.period.value", "7369.365723" },
            { "edges.crowd.radius.periodic.tickShift.mobJitterScale", "0.399379" },
            { "edges.crowd.radius.periodic.tickShift.value", "1881.367310" },
            { "edges.crowd.radius.value.mobJitterScale", "0.243162" },
            { "edges.crowd.radius.value.value", "1011.215576" },
            { "edges.crowd.radius.valueType", "constant" },
            ...
            { "edges.crowd.size.valueType", "periodic" },
            { "edges.crowdType", "strictOn" },
            { "edges.radius.periodic.amplitude.mobJitterScale", "0.179700" },
            { "edges.radius.periodic.amplitude.value", "0.426636" },
            { "edges.radius.periodic.period.mobJitterScale", "-0.398081" },
            { "edges.radius.periodic.period.value", "8295.972656" },
            { "edges.radius.periodic.tickShift.mobJitterScale", "-0.900000" },
            { "edges.radius.periodic.tickShift.value", "76.200035" },
            { "edges.radius.value.mobJitterScale", "-0.564461" },
            { "edges.radius.value.value", "316.399292" },
            { "edges.radius.valueType", "periodic" },
            { "edges.rangeType", "linearDown" },
            ...
            { "edges.weight.valueType", "periodic" },
            { "enemy.crowd.radius.periodic.amplitude.mobJitterScale", "0.487030" },
            { "enemy.crowd.radius.periodic.amplitude.value", "-0.557261" },
            { "enemy.crowd.radius.periodic.period.mobJitterScale", "-0.327608" },
            { "enemy.crowd.radius.periodic.period.value", "1618.205078" },
            { "enemy.crowd.radius.periodic.tickShift.mobJitterScale", "-0.558650" },
            { "enemy.crowd.radius.periodic.tickShift.value", "8219.541992" },
            { "enemy.crowd.radius.value.mobJitterScale", "-0.344907" },
            { "enemy.crowd.radius.value.value", "302.855103" },
            ...
            { "enemy.crowd.size.valueType", "periodic" },
            { "enemy.crowdType", "strictOff" },
            { "enemy.radius.periodic.amplitude.mobJitterScale", "1.000000" },
            { "enemy.radius.periodic.amplitude.value", "-0.015732" },
            { "enemy.radius.periodic.period.mobJitterScale", "0.643457" },
            { "enemy.radius.periodic.period.value", "2120.450928" },
            { "enemy.radius.periodic.tickShift.mobJitterScale", "0.155305" },
            { "enemy.radius.periodic.tickShift.value", "6946.404785" },
            { "enemy.radius.value.mobJitterScale", "1.000000" },
            { "enemy.radius.value.value", "-1.000000" },
            { "enemy.radius.valueType", "constant" },
            { "enemy.rangeType", "quadraticDown" },
            ...
            { "enemyBase.crowd.radius.periodic.amplitude.mobJitterScale", "-0.061686" },
            { "enemyBase.crowd.radius.periodic.amplitude.value", "0.619051" },
            { "enemyBase.crowd.radius.periodic.period.mobJitterScale", "-0.838136" },
            { "enemyBase.crowd.radius.periodic.period.value", "6577.403809" },
            { "enemyBase.crowd.radius.periodic.tickShift.mobJitterScale", "0.105226" },
            { "enemyBase.crowd.radius.periodic.tickShift.value", "6348.147461" },
            { "enemyBase.crowd.radius.value.mobJitterScale", "-0.920971" },
            { "enemyBase.crowd.radius.value.value", "1237.082153" },
            { "enemyBase.crowd.radius.valueType", "constant" },
            ...
            { "enemyBase.crowd.size.valueType", "constant" },
            { "enemyBase.crowdType", "linearUp" },
            { "enemyBase.radius.periodic.amplitude.mobJitterScale", "-0.503440" },
            { "enemyBase.radius.periodic.amplitude.value", "0.540863" },
            { "enemyBase.radius.periodic.period.mobJitterScale", "-0.289706" },
            { "enemyBase.radius.periodic.period.value", "10000.000000" },
            { "enemyBase.radius.periodic.tickShift.mobJitterScale", "-0.298801" },
            { "enemyBase.radius.periodic.tickShift.value", "2433.526123" },
            { "enemyBase.radius.value.mobJitterScale", "0.538608" },
            { "enemyBase.radius.value.value", "160.581238" },
            { "enemyBase.radius.valueType", "constant" },
            { "enemyBase.rangeType", "strictOn" },
            ...
            { "fleetLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "-0.198688" },
            { "fleetLocus.force.crowd.radius.periodic.amplitude.value", "0.334394" },
            { "fleetLocus.force.crowd.radius.periodic.period.mobJitterScale", "-0.370963" },
            { "fleetLocus.force.crowd.radius.periodic.period.value", "7651.486816" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "0.379651" },
            { "fleetLocus.force.crowd.radius.periodic.tickShift.value", "8593.720703" },
            { "fleetLocus.force.crowd.radius.value.mobJitterScale", "0.745147" },
            { "fleetLocus.force.crowd.radius.value.value", "1264.364746" },
            { "fleetLocus.force.crowd.radius.valueType", "periodic" },
            ...
            { "fleetLocus.force.crowd.size.valueType", "constant" },
            { "fleetLocus.force.crowdType", "linearDown" },
            { "fleetLocus.force.radius.periodic.amplitude.mobJitterScale", "-0.804319" },
            { "fleetLocus.force.radius.periodic.amplitude.value", "0.060413" },
            { "fleetLocus.force.radius.periodic.period.mobJitterScale", "-0.618225" },
            { "fleetLocus.force.radius.periodic.period.value", "8286.911133" },
            { "fleetLocus.force.radius.periodic.tickShift.mobJitterScale", "0.059195" },
            { "fleetLocus.force.radius.periodic.tickShift.value", "8401.980469" },
            { "fleetLocus.force.radius.value.mobJitterScale", "-0.794933" },
            { "fleetLocus.force.radius.value.value", "1631.495483" },
            { "fleetLocus.force.radius.valueType", "constant" },
            { "fleetLocus.force.rangeType", "linearUp" },
            ...
            { "mobLocus.circularWeight.valueType", "periodic" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.mobJitterScale", "-0.416112" },
            { "mobLocus.force.crowd.radius.periodic.amplitude.value", "0.350509" },
            { "mobLocus.force.crowd.radius.periodic.period.mobJitterScale", "-0.342188" },
            { "mobLocus.force.crowd.radius.periodic.period.value", "3973.057861" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.mobJitterScale", "0.022501" },
            { "mobLocus.force.crowd.radius.periodic.tickShift.value", "8258.509766" },
            { "mobLocus.force.crowd.radius.value.mobJitterScale", "-0.052231" },
            { "mobLocus.force.crowd.radius.value.value", "749.637512" },
            { "mobLocus.force.crowd.radius.valueType", "constant" },
            ...
            { "mobLocus.force.crowd.size.valueType", "constant" },
            { "mobLocus.force.crowdType", "linearDown" },
            { "mobLocus.force.radius.periodic.amplitude.mobJitterScale", "-0.158173" },
            { "mobLocus.force.radius.periodic.amplitude.value", "-0.791974" },
            { "mobLocus.force.radius.periodic.period.mobJitterScale", "0.183857" },
            { "mobLocus.force.radius.periodic.period.value", "2880.281250" },
            { "mobLocus.force.radius.periodic.tickShift.mobJitterScale", "1.000000" },
            { "mobLocus.force.radius.periodic.tickShift.value", "8523.562500" },
            { "mobLocus.force.radius.value.mobJitterScale", "0.650785" },
            { "mobLocus.force.radius.value.value", "407.114441" },
            { "mobLocus.force.radius.valueType", "periodic" },
            { "mobLocus.force.rangeType", "strictOn" },
            ...
            { "nearBaseRandomIdle", "FALSE" },
            { "nearestFriend.crowd.radius.periodic.amplitude.mobJitterScale", "0.475914" },
            { "nearestFriend.crowd.radius.periodic.amplitude.value", "0.263599" },
            { "nearestFriend.crowd.radius.periodic.period.mobJitterScale", "0.377700" },
            { "nearestFriend.crowd.radius.periodic.period.value", "10000.000000" },
            { "nearestFriend.crowd.radius.periodic.tickShift.mobJitterScale", "-0.588540" },
            { "nearestFriend.crowd.radius.periodic.tickShift.value", "10000.000000" },
            { "nearestFriend.crowd.radius.value.mobJitterScale", "-0.438807" },
            { "nearestFriend.crowd.radius.value.value", "208.059341" },
            { "nearestFriend.crowd.radius.valueType", "constant" },
            ...
            { "nearestFriend.crowd.size.valueType", "periodic" },
            { "nearestFriend.crowdType", "linearDown" },
            { "nearestFriend.radius.periodic.amplitude.mobJitterScale", "1.000000" },
            { "nearestFriend.radius.periodic.amplitude.value", "-0.501191" },
            { "nearestFriend.radius.periodic.period.mobJitterScale", "0.465727" },
            { "nearestFriend.radius.periodic.period.value", "5543.703613" },
            { "nearestFriend.radius.periodic.tickShift.mobJitterScale", "-0.787756" },
            { "nearestFriend.radius.periodic.tickShift.value", "5758.913574" },
            { "nearestFriend.radius.value.mobJitterScale", "-1.000000" },
            { "nearestFriend.radius.value.value", "1267.734497" },
            { "nearestFriend.radius.valueType", "constant" },
            { "nearestFriend.rangeType", "linearUp" },
            ...
            { "separate.crowd.radius.periodic.amplitude.mobJitterScale", "-0.088320" },
            { "separate.crowd.radius.periodic.amplitude.value", "-0.076864" },
            { "separate.crowd.radius.periodic.period.mobJitterScale", "0.422677" },
            { "separate.crowd.radius.periodic.period.value", "3548.283936" },
            { "separate.crowd.radius.periodic.tickShift.mobJitterScale", "-0.494341" },
            { "separate.crowd.radius.periodic.tickShift.value", "673.003906" },
            { "separate.crowd.radius.value.mobJitterScale", "-0.721141" },
            { "separate.crowd.radius.value.value", "596.943848" },
            { "separate.crowd.radius.valueType", "constant" },
            ...
            { "separate.crowdType", "quadraticDown" },
            { "separate.radius.periodic.amplitude.mobJitterScale", "-1.000000" },
            { "separate.radius.periodic.amplitude.value", "0.936464" },
            { "separate.radius.periodic.period.mobJitterScale", "0.174253" },
            { "separate.radius.periodic.period.value", "8491.372070" },
            { "separate.radius.periodic.tickShift.mobJitterScale", "-1.000000" },
            { "separate.radius.periodic.tickShift.value", "5407.598633" },
            { "separate.radius.value.mobJitterScale", "0.834946" },
            { "separate.radius.value.value", "968.393311" },
            { "separate.radius.valueType", "constant" },
            { "separate.rangeType", "quadraticUp" },
