...
typedef enum NeuralForceType {
    ...
    NEURAL_FORCE_BASE_FORWARD_CONTROL_LIMIT,
    NEURAL_FORCE_BASE_BACKWARD_CONTROL_LIMIT,
    NEURAL_FORCE_BASE_ADVANCE_CONTROL_LIMIT,
    NEURAL_FORCE_BASE_RETREAT_CONTROL_LIMIT,
    NEURAL_FORCE_BASE_CONTROL_SHELL,
    NEURAL_FORCE_ENEMY,
    //NEURAL_FORCE_FORWARD_ENEMY,
    //NEURAL_FORCE_BACKWARD_ENEMY,
