...
typedef enum FleetAIType {
    ...
    FLEET_AI_NEURAL8     = 45,
    FLEET_AI_NEURAL9     = 46,
    FLEET_AI_NEURAL10    = 47,
    FLEET_AI_NEURAL11    = 48,
    FLEET_AI_NEURAL12    = 49,
    FLEET_AI_NEURAL13    = 50,
    FLEET_AI_NEURAL14    = 51,
    FLEET_AI_BINEURAL1   = 52,
    FLEET_AI_BINEURAL2   = 53,
    FLEET_AI_BINEURAL3   = 54,
    FLEET_AI_BINEURAL4   = 55,
    FLEET_AI_BINEURAL5   = 56,
    FLEET_AI_MATRIX1     = 57,
    FLEET_AI_MAX,
} FleetAIType;
