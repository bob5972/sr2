...
public:
    ...
    void putDefaults(MBRegistry *mreg, FleetAIType aiType) {
        ...
        BineuralConfigValue configs2[] = {
            ...
            { "fleetNet.node[100].params", "{0.000000, }" },
            { "fleetNet.node[101].inputs", "{}" },
            { "fleetNet.node[101].op", "ML_FOP_Nx0_ARITHMETIC_MEAN" },
            { "fleetNet.node[101].params", "{}" },
            { "fleetNet.node[102].inputs", "{}" },
            { "fleetNet.node[102].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[102].params", "{}" },
            { "fleetNet.node[103].inputs", "{}" },
            { "fleetNet.node[103].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[103].params", "{}" },
            { "fleetNet.node[104].inputs", "{7, }" },
            { "fleetNet.node[104].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[104].params", "{}" },
            { "fleetNet.node[105].inputs", "{}" },
            { "fleetNet.node[105].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[105].params", "{}" },
            { "fleetNet.node[106].inputs", "{}" },
            { "fleetNet.node[106].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[106].params", "{}" },
            { "fleetNet.node[107].inputs", "{18, }" },
            { "fleetNet.node[107].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[107].params", "{0.000000, 972.643250, 0.000000, }" },
            { "fleetNet.node[108].inputs", "{}" },
            { "fleetNet.node[108].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[108].params", "{}" },
            ...
            { "fleetNet.node[111].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[111].params", "{}" },
            { "fleetNet.node[112].inputs", "{}" },
            { "fleetNet.node[112].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[112].params", "{}" },
            { "fleetNet.node[113].inputs", "{}" },
            { "fleetNet.node[113].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[113].params", "{}" },
            { "fleetNet.node[114].inputs", "{}" },
            { "fleetNet.node[114].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[114].params", "{}" },
            { "fleetNet.node[115].inputs", "{}" },
            { "fleetNet.node[115].op", "ML_FOP_2x0_PRODUCT" },
            { "fleetNet.node[115].params", "{0.000000, 6310.932129, 0.966382, 0.000000, 0.000000, 0.000000, 0.000000, 4.921803, }" },
            { "fleetNet.node[116].inputs", "{}" },
            { "fleetNet.node[116].op", "ML_FOP_0x1_CONSTANT_N10_0" },
            { "fleetNet.node[116].params", "{0.000000, }" },
            { "fleetNet.node[117].inputs", "{4, }" },
            { "fleetNet.node[117].op", "ML_FOP_Nx2_ACTIVATE_QUADRATIC_DOWN" },
            { "fleetNet.node[117].params", "{}" },
            { "fleetNet.node[118].inputs", "{79, 40, 77, 99, 58, 56, 114, }" },
            { "fleetNet.node[118].op", "ML_FOP_0x1_CONSTANT_N1K_1K" },
            { "fleetNet.node[118].params", "{}" },
            { "fleetNet.node[119].inputs", "{}" },
            { "fleetNet.node[119].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[119].params", "{969.825378, }" },
            { "fleetNet.node[120].inputs", "{}" },
            { "fleetNet.node[120].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[120].params", "{}" },
            { "fleetNet.node[121].inputs", "{}" },
            { "fleetNet.node[121].op", "ML_FOP_NxN_LINEAR_COMBINATION_CLAMPED_UNIT" },
            { "fleetNet.node[121].params", "{}" },
            { "fleetNet.node[122].inputs", "{117, 63, }" },
            { "fleetNet.node[122].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[122].params", "{0.000000, }" },
            { "fleetNet.node[123].inputs", "{115, }" },
            { "fleetNet.node[123].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[123].params", "{}" },
            ...
            { "fleetNet.node[131].params", "{0.000000, 8.941780, 0.000000, 0.000000, }" },
            { "fleetNet.node[132].inputs", "{}" },
            { "fleetNet.node[132].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[132].params", "{0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "fleetNet.node[133].inputs", "{}" },
            { "fleetNet.node[133].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[133].params", "{}" },
            { "fleetNet.node[134].inputs", "{}" },
            { "fleetNet.node[134].op", "ML_FOP_0x0_ZERO" },
            ...
            { "fleetNet.node[139].inputs", "{}" },
            { "fleetNet.node[139].op", "ML_FOP_1xN_POLYNOMIAL" },
            { "fleetNet.node[139].params", "{0.000000, }" },
            { "fleetNet.node[140].inputs", "{}" },
            ...
            { "fleetNet.node[142].inputs", "{}" },
            { "fleetNet.node[142].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[142].params", "{}" },
            { "fleetNet.node[143].inputs", "{}" },
            { "fleetNet.node[143].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[143].params", "{0.000000, }" },
            { "fleetNet.node[144].inputs", "{129, }" },
            { "fleetNet.node[144].op", "ML_FOP_NxN_SELECT_GTE" },
            ...
            { "fleetNet.node[146].params", "{0.000000, }" },
            { "fleetNet.node[147].inputs", "{}" },
            { "fleetNet.node[147].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[147].params", "{}" },
            { "fleetNet.node[148].inputs", "{}" },
            { "fleetNet.node[148].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[148].params", "{0.000000, 0.104905, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "fleetNet.node[149].inputs", "{139, 140, }" },
            { "fleetNet.node[149].op", "ML_FOP_Nx0_SELECT_UNIT_INTERVAL_STEP" },
            { "fleetNet.node[149].params", "{}" },
            { "fleetNet.node[150].inputs", "{}" },
            { "fleetNet.node[150].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[150].params", "{}" },
            { "fleetNet.node[151].inputs", "{42, 141, }" },
            { "fleetNet.node[151].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[151].params", "{}" },
            { "fleetNet.node[152].inputs", "{106, 36, 70, 74, }" },
            { "fleetNet.node[152].op", "ML_FOP_1x3_ARC_TANGENT" },
            { "fleetNet.node[152].params", "{0.000000, }" },
            { "fleetNet.node[153].inputs", "{}" },
            { "fleetNet.node[153].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[153].params", "{}" },
            { "fleetNet.node[154].inputs", "{}" },
            { "fleetNet.node[154].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[154].params", "{}" },
            { "fleetNet.node[155].inputs", "{0, }" },
            ...
            { "fleetNet.node[158].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[158].params", "{}" },
            { "fleetNet.node[159].inputs", "{70, }" },
            { "fleetNet.node[159].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[159].params", "{}" },
            { "fleetNet.node[30].inputs", "{}" },
            { "fleetNet.node[30].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[30].params", "{0.000000, 0.000000, 0.000000, }" },
            { "fleetNet.node[31].inputs", "{13, 18, }" },
            { "fleetNet.node[31].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[31].params", "{}" },
            { "fleetNet.node[32].inputs", "{}" },
            ...
            { "fleetNet.node[34].inputs", "{}" },
            { "fleetNet.node[34].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[34].params", "{}" },
            { "fleetNet.node[35].inputs", "{}" },
            { "fleetNet.node[35].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[35].params", "{}" },
            { "fleetNet.node[36].inputs", "{}" },
            { "fleetNet.node[36].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[36].params", "{}" },
            { "fleetNet.node[37].inputs", "{}" },
            { "fleetNet.node[37].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[37].params", "{}" },
            { "fleetNet.node[38].inputs", "{}" },
            { "fleetNet.node[38].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[38].params", "{}" },
            { "fleetNet.node[39].inputs", "{}" },
            { "fleetNet.node[39].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[39].params", "{}" },
            { "fleetNet.node[40].inputs", "{}" },
            { "fleetNet.node[40].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[40].params", "{0.000000, 0.000000, }" },
            { "fleetNet.node[41].inputs", "{}" },
            { "fleetNet.node[41].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[41].params", "{}" },
            { "fleetNet.node[42].inputs", "{}" },
            { "fleetNet.node[42].op", "ML_FOP_Nx2_ACTIVATE_GAUSSIAN" },
            { "fleetNet.node[42].params", "{0.000000, }" },
            { "fleetNet.node[43].inputs", "{16, 22, 35, 15, 10, 10, }" },
            { "fleetNet.node[43].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[43].params", "{}" },
            { "fleetNet.node[44].inputs", "{}" },
            { "fleetNet.node[44].op", "ML_FOP_1x0_FLOOR" },
            { "fleetNet.node[44].params", "{}" },
            { "fleetNet.node[45].inputs", "{}" },
            { "fleetNet.node[45].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[45].params", "{}" },
            { "fleetNet.node[46].inputs", "{39, }" },
            { "fleetNet.node[46].op", "ML_FOP_2x2_LINEAR_COMBINATION" },
            { "fleetNet.node[46].params", "{}" },
            { "fleetNet.node[47].inputs", "{}" },
            { "fleetNet.node[47].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[47].params", "{}" },
            { "fleetNet.node[48].inputs", "{40, }" },
            { "fleetNet.node[48].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[48].params", "{}" },
            { "fleetNet.node[49].inputs", "{}" },
            { "fleetNet.node[49].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[49].params", "{}" },
            { "fleetNet.node[50].inputs", "{}" },
            { "fleetNet.node[50].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[50].params", "{}" },
            { "fleetNet.node[51].inputs", "{}" },
            { "fleetNet.node[51].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[51].params", "{}" },
            { "fleetNet.node[52].inputs", "{}" },
            { "fleetNet.node[52].op", "ML_FOP_0x1_CONSTANT_0_10" },
            { "fleetNet.node[52].params", "{}" },
            { "fleetNet.node[53].inputs", "{}" },
            { "fleetNet.node[53].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[53].params", "{0.000000, 0.000000, }" },
            { "fleetNet.node[54].inputs", "{}" },
            { "fleetNet.node[54].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[54].params", "{}" },
            { "fleetNet.node[55].inputs", "{20, }" },
            { "fleetNet.node[55].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[55].params", "{}" },
            { "fleetNet.node[56].inputs", "{}" },
            { "fleetNet.node[56].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[56].params", "{}" },
            { "fleetNet.node[57].inputs", "{}" },
            { "fleetNet.node[57].op", "ML_FOP_3x0_CLAMP" },
            { "fleetNet.node[57].params", "{}" },
            { "fleetNet.node[58].inputs", "{}" },
            { "fleetNet.node[58].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[58].params", "{}" },
            { "fleetNet.node[59].inputs", "{}" },
            { "fleetNet.node[59].op", "ML_FOP_0x0_ZERO" },
            ...
            { "fleetNet.node[61].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[61].params", "{}" },
            { "fleetNet.node[62].inputs", "{}" },
            { "fleetNet.node[62].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[62].params", "{}" },
            { "fleetNet.node[63].inputs", "{8, }" },
            { "fleetNet.node[63].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[63].params", "{0.000000, }" },
            { "fleetNet.node[64].inputs", "{16, }" },
            { "fleetNet.node[64].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[64].params", "{}" },
            { "fleetNet.node[65].inputs", "{}" },
            { "fleetNet.node[65].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[65].params", "{}" },
            { "fleetNet.node[66].inputs", "{}" },
            { "fleetNet.node[66].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[66].params", "{0.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            ...
            { "fleetNet.node[69].inputs", "{}" },
            { "fleetNet.node[69].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[69].params", "{0.000000, 0.000000, }" },
            { "fleetNet.node[70].inputs", "{}" },
            { "fleetNet.node[70].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[70].params", "{}" },
            { "fleetNet.node[71].inputs", "{61, }" },
            { "fleetNet.node[71].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[71].params", "{}" },
            { "fleetNet.node[72].inputs", "{2, }" },
            { "fleetNet.node[72].op", "ML_FOP_1x2_CLAMP" },
            { "fleetNet.node[72].params", "{0.000000, }" },
            ...
            { "fleetNet.node[75].inputs", "{21, }" },
            { "fleetNet.node[75].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[75].params", "{}" },
            { "fleetNet.node[76].inputs", "{}" },
            { "fleetNet.node[76].op", "ML_FOP_1x1_STRICT_OFF" },
            { "fleetNet.node[76].params", "{}" },
            { "fleetNet.node[77].inputs", "{20, }" },
            { "fleetNet.node[77].op", "ML_FOP_1x0_TAN" },
            { "fleetNet.node[77].params", "{0.000000, }" },
            { "fleetNet.node[78].inputs", "{45, }" },
            { "fleetNet.node[78].op", "ML_FOP_NxN_WEIGHTED_ARITHMETIC_MEAN" },
            { "fleetNet.node[78].params", "{}" },
            { "fleetNet.node[79].inputs", "{}" },
            { "fleetNet.node[79].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[79].params", "{}" },
            { "fleetNet.node[80].inputs", "{}" },
            { "fleetNet.node[80].op", "ML_FOP_3x3_LINEAR_COMBINATION" },
            { "fleetNet.node[80].params", "{}" },
            { "fleetNet.node[81].inputs", "{17, }" },
            { "fleetNet.node[81].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[81].params", "{}" },
            { "fleetNet.node[82].inputs", "{}" },
            { "fleetNet.node[82].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[82].params", "{}" },
            { "fleetNet.node[83].inputs", "{}" },
            { "fleetNet.node[83].op", "ML_FOP_Nx2_ACTIVATE_GAUSSIAN" },
            { "fleetNet.node[83].params", "{0.000000, }" },
            { "fleetNet.node[84].inputs", "{}" },
            { "fleetNet.node[84].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[84].params", "{0.000000, }" },
            { "fleetNet.node[85].inputs", "{}" },
            { "fleetNet.node[85].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[85].params", "{}" },
            ...
            { "fleetNet.node[87].params", "{0.000000, }" },
            { "fleetNet.node[88].inputs", "{}" },
            { "fleetNet.node[88].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[88].params", "{0.000000, }" },
            { "fleetNet.node[89].inputs", "{}" },
            { "fleetNet.node[89].op", "ML_FOP_Nx2_ACTIVATE_GAUSSIAN" },
            { "fleetNet.node[89].params", "{}" },
            { "fleetNet.node[90].inputs", "{}" },
            { "fleetNet.node[90].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[90].params", "{0.000000, }" },
            { "fleetNet.node[91].inputs", "{}" },
            { "fleetNet.node[91].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[91].params", "{}" },
            { "fleetNet.node[92].inputs", "{}" },
            { "fleetNet.node[92].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[92].params", "{}" },
            { "fleetNet.node[93].inputs", "{}" },
            { "fleetNet.node[93].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[93].params", "{}" },
            { "fleetNet.node[94].inputs", "{47, }" },
            { "fleetNet.node[94].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[94].params", "{0.000000, }" },
            { "fleetNet.node[95].inputs", "{}" },
            { "fleetNet.node[95].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[95].params", "{}" },
            { "fleetNet.node[96].inputs", "{}" },
            { "fleetNet.node[96].op", "ML_FOP_Nx0_SUM" },
            { "fleetNet.node[96].params", "{}" },
            { "fleetNet.node[97].inputs", "{}" },
            { "fleetNet.node[97].op", "ML_FOP_0x0_ZERO" },
            { "fleetNet.node[97].params", "{}" },
            { "fleetNet.node[98].inputs", "{6, 15, 49, }" },
            { "fleetNet.node[98].op", "ML_FOP_Nx2_ACTIVATE_LINEAR_UP" },
            { "fleetNet.node[98].params", "{}" },
            { "fleetNet.node[99].inputs", "{}" },
            { "fleetNet.node[99].op", "ML_FOP_Nx0_SELECT_UNIT_INTERVAL_STEP" },
            { "fleetNet.node[99].params", "{0.000000, 0.000000, }" },
            { "fleetNet.numInputs", "30" },
            { "fleetNet.numNodes", "130" },
            { "fleetNet.numOutputs", "30" },
            ...
            { "shipNet.node[101].op", "ML_FOP_3x2_IF_INSIDE_RANGE_ELSE_CONST" },
            { "shipNet.node[101].params", "{}" },
            { "shipNet.node[102].inputs", "{24, 21, 77, 0, 37, 74, 89, }" },
            { "shipNet.node[102].op", "ML_FOP_NxN_SELECT_UNIT_INTERVAL_WEIGHTED_STEP" },
            { "shipNet.node[102].params", "{1.626612, 0.995004, 2.244309, 17922.958984, 0.000000, }" },
            { "shipNet.node[103].inputs", "{62, 66, 14, }" },
            { "shipNet.node[103].op", "ML_FOP_1x0_FLOOR" },
            { "shipNet.node[103].params", "{1993.878906, 11.889168, 0.102949, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[104].inputs", "{0, }" },
            { "shipNet.node[104].op", "ML_FOP_Nx1_ACTIVATE_THRESHOLD_DOWN" },
            { "shipNet.node[104].params", "{0.543301, 1293.997192, 1.978794, 989.214783, 493.272369, }" },
            { "shipNet.node[105].inputs", "{67, 84, 58, 16, 91, 41, 18, 99, }" },
            { "shipNet.node[105].op", "ML_FOP_1x1_SUM" },
            { "shipNet.node[105].params", "{1.000000, 0.000000, }" },
            { "shipNet.node[106].inputs", "{}" },
            { "shipNet.node[106].op", "ML_FOP_Nx0_ARITHMETIC_MEAN" },
            { "shipNet.node[106].params", "{987.682922, 0.000000, }" },
            { "shipNet.node[107].inputs", "{11, 61, 48, 48, 72, 86, }" },
            { "shipNet.node[107].op", "ML_FOP_Nx1_ACTIVATE_DIV_SUM" },
            { "shipNet.node[107].params", "{1.050000, 712.670227, 0.000000, }" },
            { "shipNet.node[108].inputs", "{33, 11, }" },
            { "shipNet.node[108].op", "ML_FOP_1x2_CLAMP" },
            { "shipNet.node[108].params", "{0.181056, 1.520744, 0.313480, 0.000000, }" },
            { "shipNet.node[109].inputs", "{21, 28, 24, 4, 37, 17, }" },
            { "shipNet.node[109].op", "ML_FOP_3x2_IF_OUTSIDE_RANGE_ELSE_CONST" },
            { "shipNet.node[109].params", "{40.355164, 1369.562012, 0.000000, }" },
            { "shipNet.node[110].inputs", "{5, 11, 15, 8, 14, 22, }" },
            { "shipNet.node[110].op", "ML_FOP_0x1_CONSTANT_0_100" },
            { "shipNet.node[110].params", "{0.000000, 1.000000, }" },
            { "shipNet.node[111].inputs", "{48, 77, 73, 52, 97, 0, 4, 18, }" },
            { "shipNet.node[111].op", "ML_FOP_NxN_SCALED_DIV_SUM_SQUARED" },
            { "shipNet.node[111].params", "{}" },
            { "shipNet.node[112].inputs", "{48, 63, 75, 44, 17, 42, }" },
            { "shipNet.node[112].op", "ML_FOP_1x2_INSIDE_RANGE" },
            { "shipNet.node[112].params", "{0.116223, 1.000000, 1372.458252, }" },
            { "shipNet.node[113].inputs", "{64, 22, 57, 78, 62, 94, 67, }" },
            { "shipNet.node[113].op", "ML_FOP_Nx0_ACTIVATE_DIV_SUM" },
            { "shipNet.node[113].params", "{1.482340, 0.513569, 19.756893, 0.000000, 143.244186, 0.000000, }" },
            { "shipNet.node[114].inputs", "{1, 77, }" },
            { "shipNet.node[114].op", "ML_FOP_1x3_SQRT" },
            { "shipNet.node[114].params", "{0.000000, }" },
            { "shipNet.node[115].inputs", "{91, 9, 72, 106, 107, }" },
            { "shipNet.node[115].op", "ML_FOP_0x1_UNIT_CONSTANT" },
            { "shipNet.node[115].params", "{0.099994, 0.000000, 0.000000, 0.000000, 1.596393, 0.000000, 0.203419, }" },
            { "shipNet.node[116].inputs", "{}" },
            { "shipNet.node[116].op", "ML_FOP_1x2_COSINE" },
            { "shipNet.node[116].params", "{0.000000, }" },
            { "shipNet.node[117].inputs", "{70, 90, 79, 72, 107, }" },
            { "shipNet.node[117].op", "ML_FOP_NxN_SELECT_UNIT_INTERVAL_WEIGHTED_STEP" },
            { "shipNet.node[117].params", "{}" },
            { "shipNet.node[118].inputs", "{1, 45, 76, }" },
            { "shipNet.node[118].op", "ML_FOP_1x0_CEIL" },
            { "shipNet.node[118].params", "{0.000000, 1273.960815, 177.286774, 0.000000, 0.840318, 0.603231, }" },
            { "shipNet.node[119].inputs", "{13, 97, 111, 3, 30, 100, 96, }" },
            { "shipNet.node[119].op", "ML_FOP_Nx0_ACTIVATE_GAUSSIAN_UP_PROB_INVERSE" },
            { "shipNet.node[119].params", "{0.000000, 1.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[120].inputs", "{117, 93, 38, 47, 93, 36, }" },
            { "shipNet.node[120].op", "ML_FOP_1x0_ARC_TANGENT" },
            { "shipNet.node[120].params", "{1047.382690, 0.517285, 0.000000, 0.000000, }" },
            { "shipNet.node[121].inputs", "{4, 8, 42, 114, }" },
            { "shipNet.node[121].op", "ML_FOP_3x0_IF_GTEZ_ELSE" },
            { "shipNet.node[121].params", "{}" },
            { "shipNet.node[122].inputs", "{98, 88, 13, 72, 113, }" },
            { "shipNet.node[122].op", "ML_FOP_1x0_UNIT_SINE" },
            { "shipNet.node[122].params", "{0.000000, 150.159256, }" },
            { "shipNet.node[123].inputs", "{39, 17, 47, 96, }" },
            { "shipNet.node[123].op", "ML_FOP_1x1_LINEAR_COMBINATION" },
            { "shipNet.node[123].params", "{0.184680, 0.000000, 0.000000, 155.073166, 981.998840, 0.000000, }" },
            { "shipNet.node[124].inputs", "{11, 2, 87, 19, }" },
            { "shipNet.node[124].op", "ML_FOP_1x0_UNIT_SINE" },
            { "shipNet.node[124].params", "{0.000000, 0.000000, 0.000000, 0.000000, 1.000000, 0.000000, 1.000000, }" },
            { "shipNet.node[25].inputs", "{5, 11, 15, 8, 14, 22, }" },
            ...
            { "shipNet.node[27].inputs", "{}" },
            { "shipNet.node[27].op", "ML_FOP_1x2_INSIDE_RANGE" },
            { "shipNet.node[27].params", "{1.535408, 0.000000, }" },
            { "shipNet.node[28].inputs", "{16, 20, 24, 13, 20, 15, 25, }" },
            { "shipNet.node[28].op", "ML_FOP_Nx2_ACTIVATE_QUADRATIC_UP" },
            { "shipNet.node[28].params", "{0.642530, 7505.147461, 868.092957, 1.000000, 0.508775, 1.000000, 0.094623, -1.008148, }" },
            { "shipNet.node[29].inputs", "{27, 16, 4, }" },
            { "shipNet.node[29].op", "ML_FOP_1x1_GTE" },
            { "shipNet.node[29].params", "{0.090702, 0.000000, 0.000000, 9535.729492, 0.000000, 0.000000, 239.734283, }" },
            { "shipNet.node[30].inputs", "{}" },
            { "shipNet.node[30].op", "ML_FOP_1x1_QUADRATIC_UP" },
            { "shipNet.node[30].params", "{798.988342, 0.000000, 1149.891479, 0.000000, 0.000000, }" },
            { "shipNet.node[31].inputs", "{16, 20, 24, 13, 20, 15, 25, }" },
            { "shipNet.node[31].op", "ML_FOP_Nx2_ACTIVATE_QUADRATIC_UP" },
            { "shipNet.node[31].params", "{0.642530, 7505.147461, 868.092957, 1.000000, 0.508775, 1.000000, 0.094623, -1.008148, }" },
            { "shipNet.node[32].inputs", "{12, 18, 31, 12, }" },
            { "shipNet.node[32].op", "ML_FOP_Nx0_ACTIVATE_SQRT_UP" },
            { "shipNet.node[32].params", "{8.834229, 1.000000, 1540.079956, 1.000000, 0.000000, 0.769500, 0.000000, 0.000000, }" },
            { "shipNet.node[33].inputs", "{22, 3, 21, 2, 7, 27, 27, 21, }" },
            { "shipNet.node[33].op", "ML_FOP_Nx0_GEOMETRIC_MEAN" },
            { "shipNet.node[33].params", "{0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 6.296649, 1.000000, 0.000000, }" },
            { "shipNet.node[34].inputs", "{7, 14, 16, 10, }" },
            { "shipNet.node[34].op", "ML_FOP_0x1_CONSTANT_N1K_0" },
            { "shipNet.node[34].params", "{1060.549072, 0.000000, 0.000000, 0.097707, 1.000000, 0.069093, }" },
            { "shipNet.node[35].inputs", "{17, 33, 18, 16, }" },
            { "shipNet.node[35].op", "ML_FOP_1x2_INSIDE_RANGE" },
            { "shipNet.node[35].params", "{1123.579956, 0.000000, 0.425565, 0.525454, 9747.679688, 0.000000, 1.002265, 10237.089844, }" },
            { "shipNet.node[36].inputs", "{3, }" },
            { "shipNet.node[36].op", "ML_FOP_Nx0_ACTIVATE_GAUSSIAN_UP" },
            { "shipNet.node[36].params", "{4.920677, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[37].inputs", "{26, }" },
            { "shipNet.node[37].op", "ML_FOP_Nx0_ACTIVATE_DIV_SUM" },
            { "shipNet.node[37].params", "{1019.083862, 0.340067, }" },
            { "shipNet.node[38].inputs", "{}" },
            ...
            { "shipNet.node[39].op", "ML_FOP_Nx0_ACTIVATE_GAUSSIAN_UP_PROB_INVERSE" },
            { "shipNet.node[39].params", "{27.074999, 2.256364, 0.895679, 24.541735, 1.000000, 0.291301, 2500.483643, }" },
            { "shipNet.node[40].inputs", "{27, 13, 19, 19, 3, 15, 21, 24, }" },
            { "shipNet.node[40].op", "ML_FOP_0x0_ZERO" },
            { "shipNet.node[40].params", "{0.000000, 0.000000, }" },
            { "shipNet.node[41].inputs", "{37, 14, 31, 32, 28, 29, 9, 13, }" },
            { "shipNet.node[41].op", "ML_FOP_Nx0_MAX" },
            { "shipNet.node[41].params", "{0.000000, 5.276439, 1.485161, 0.000000, }" },
            { "shipNet.node[42].inputs", "{16, }" },
            { "shipNet.node[42].op", "ML_FOP_1x3_ARC_TANGENT" },
            ...
            { "shipNet.node[45].op", "ML_FOP_2x0_POW" },
            { "shipNet.node[45].params", "{0.000000, 0.000000, 243.633469, 584.325378, 0.090686, 2.019671, 0.000000, }" },
            { "shipNet.node[46].inputs", "{21, 28, 24, 4, 37, 17, }" },
            { "shipNet.node[46].op", "ML_FOP_3x2_IF_OUTSIDE_RANGE_ELSE_CONST" },
            { "shipNet.node[46].params", "{40.355164, 1369.562012, 0.000000, }" },
            { "shipNet.node[47].inputs", "{41, }" },
            { "shipNet.node[47].op", "ML_FOP_1xN_SELECT_UNIT_INTERVAL_LERP" },
            { "shipNet.node[47].params", "{0.000000, 1.000000, }" },
            { "shipNet.node[48].inputs", "{}" },
            { "shipNet.node[48].op", "ML_FOP_NxN_WEIGHTED_ARITHMETIC_MEAN" },
            { "shipNet.node[48].params", "{1.586385, 0.000000, 1.040559, 1759.740967, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[49].inputs", "{20, }" },
            { "shipNet.node[49].op", "ML_FOP_1x0_ARC_SINE" },
            { "shipNet.node[49].params", "{1136.950073, 0.000000, 0.000000, 1.490049, }" },
            { "shipNet.node[50].inputs", "{15, 20, 9, 16, 25, 20, 24, }" },
            { "shipNet.node[50].op", "ML_FOP_Nx2_ACTIVATE_QUADRATIC_UP" },
            { "shipNet.node[50].params", "{0.642530, 7505.147461, 868.092957, 1.000000, 0.508775, 1.000000, 0.094623, 0.000000, }" },
            { "shipNet.node[51].inputs", "{10, }" },
            { "shipNet.node[51].op", "ML_FOP_1x0_ARC_COSINE" },
            { "shipNet.node[51].params", "{0.000000, 1.034716, 0.997500, 0.000000, }" },
            { "shipNet.node[52].inputs", "{8, }" },
            { "shipNet.node[52].op", "ML_FOP_Nx0_GEOMETRIC_MEAN" },
            { "shipNet.node[52].params", "{3723.401611, 260.550598, 0.000000, }" },
            { "shipNet.node[53].inputs", "{39, 9, 8, }" },
            { "shipNet.node[53].op", "ML_FOP_Nx1_ACTIVATE_THRESHOLD_UP" },
            { "shipNet.node[53].params", "{1.000000, 0.950000, 1.000000, 0.499292, 20.688713, 2950.105957, 1.000000, 0.000000, }" },
            { "shipNet.node[54].inputs", "{23, 38, }" },
            { "shipNet.node[54].op", "ML_FOP_1x1_QUADRATIC_UP" },
            { "shipNet.node[54].params", "{0.000000, 0.000000, 1013.443298, 0.201231, 1.155000, 0.000000, 0.000000, }" },
            { "shipNet.node[55].inputs", "{25, 53, 48, 28, 27, }" },
            { "shipNet.node[55].op", "ML_FOP_Nx0_ACTIVATE_GAUSSIAN_PROB_INVERSE" },
            { "shipNet.node[55].params", "{1.000000, 0.000000, 0.134443, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[56].inputs", "{1, 5, }" },
            { "shipNet.node[56].op", "ML_FOP_1x2_POW" },
            { "shipNet.node[56].params", "{1.000000, 1880.100464, 1.000000, }" },
            { "shipNet.node[57].inputs", "{53, 16, 48, 19, 38, 50, }" },
            { "shipNet.node[57].op", "ML_FOP_Nx0_ACTIVATE_GAUSSIAN_UP" },
            { "shipNet.node[57].params", "{911.902893, 0.000000, 1.000000, 0.000000, }" },
            { "shipNet.node[58].inputs", "{19, 17, 46, 51, 35, 13, 46, 23, }" },
            { "shipNet.node[58].op", "ML_FOP_1x1_PRODUCT" },
            { "shipNet.node[58].params", "{1.000000, }" },
            { "shipNet.node[59].inputs", "{7, 9, 56, 39, 1, 38, 41, }" },
            { "shipNet.node[59].op", "ML_FOP_1xN_SELECT_UNIT_INTERVAL_LERP" },
            { "shipNet.node[59].params", "{0.000000, 0.216434, 1.774954, 0.000000, 974.963074, 1.000000, 0.000000, }" },
            { "shipNet.node[60].inputs", "{16, }" },
            { "shipNet.node[60].op", "ML_FOP_1x3_ARC_TANGENT" },
            { "shipNet.node[60].params", "{163.507523, }" },
            { "shipNet.node[61].inputs", "{33, }" },
            { "shipNet.node[61].op", "ML_FOP_1x0_HYP_COSINE" },
            { "shipNet.node[61].params", "{4283.847168, 0.094453, 1.000000, 1065.806641, 2322.148682, }" },
            { "shipNet.node[62].inputs", "{14, 43, }" },
            ...
            { "shipNet.node[67].inputs", "{}" },
            { "shipNet.node[67].op", "ML_FOP_1x3_HYP_SINE" },
            { "shipNet.node[67].params", "{0.000000, }" },
            { "shipNet.node[68].inputs", "{10, 30, 14, 0, }" },
            { "shipNet.node[68].op", "ML_FOP_1x0_ARC_COSINE" },
            { "shipNet.node[68].params", "{0.610892, 1771.931152, }" },
            { "shipNet.node[69].inputs", "{56, 15, 59, 24, 8, 50, 44, }" },
            { "shipNet.node[69].op", "ML_FOP_0x3_CONSTANT_CLAMPED" },
            { "shipNet.node[69].params", "{0.000000, 2388.428223, }" },
            { "shipNet.node[70].inputs", "{0, }" },
            { "shipNet.node[70].op", "ML_FOP_1x3_SQRT" },
            { "shipNet.node[70].params", "{13.927458, }" },
            { "shipNet.node[71].inputs", "{60, 70, 1, }" },
            { "shipNet.node[71].op", "ML_FOP_2x2_IF_GTE_ELSE" },
            { "shipNet.node[71].params", "{1.000000, 0.000000, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[72].inputs", "{69, }" },
            { "shipNet.node[72].op", "ML_FOP_1x0_HYP_SINE" },
            { "shipNet.node[72].params", "{0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[73].inputs", "{9, 18, }" },
            { "shipNet.node[73].op", "ML_FOP_NxN_ANCHORED_DIV_SUM_SQUARED" },
            { "shipNet.node[73].params", "{0.000000, }" },
            { "shipNet.node[74].inputs", "{43, 38, 66, 27, 73, 28, 67, }" },
            { "shipNet.node[74].op", "ML_FOP_Nx1_ACTIVATE_THRESHOLD_UP" },
            { "shipNet.node[74].params", "{1113.128052, 0.000000, 1086.244385, }" },
            { "shipNet.node[75].inputs", "{70, }" },
            { "shipNet.node[75].op", "ML_FOP_4x0_IF_GTE_ELSE" },
            { "shipNet.node[75].params", "{0.000000, 0.000000, 0.000000, 1.491193, 1.682133, }" },
            { "shipNet.node[76].inputs", "{66, 21, 15, 32, }" },
            { "shipNet.node[76].op", "ML_FOP_1x0_SQRT" },
            { "shipNet.node[76].params", "{0.791190, 0.000000, 0.000000, }" },
            { "shipNet.node[77].inputs", "{68, 18, 12, 38, 73, }" },
            { "shipNet.node[77].op", "ML_FOP_1x0_COS" },
            { "shipNet.node[77].params", "{0.950000, 0.749966, 0.000000, }" },
            { "shipNet.node[78].inputs", "{77, }" },
            { "shipNet.node[78].op", "ML_FOP_Nx0_ACTIVATE_GAUSSIAN_UP_PROB_INVERSE" },
            { "shipNet.node[78].params", "{0.185203, 0.000000, }" },
            { "shipNet.node[79].inputs", "{30, 42, 42, 47, 10, 48, }" },
            { "shipNet.node[79].op", "ML_FOP_1x1_GTE" },
            { "shipNet.node[79].params", "{1.607831, 0.000000, }" },
            { "shipNet.node[80].inputs", "{29, 31, 33, 11, 2, 20, 36, }" },
            { "shipNet.node[80].op", "ML_FOP_NxN_WEIGHTED_GEOMETRIC_MEAN" },
            { "shipNet.node[80].params", "{}" },
            { "shipNet.node[81].inputs", "{1, 32, 4, }" },
            { "shipNet.node[81].op", "ML_FOP_3x2_IF_OUTSIDE_RANGE_ELSE_CONST" },
            { "shipNet.node[81].params", "{1.611180, 2.407777, }" },
            { "shipNet.node[82].inputs", "{2, }" },
            { "shipNet.node[82].op", "ML_FOP_1x3_HYP_TANGENT" },
            { "shipNet.node[82].params", "{386.799255, }" },
            { "shipNet.node[83].inputs", "{74, 24, 23, }" },
            { "shipNet.node[83].op", "ML_FOP_Nx0_SELECT_UNIT_INTERVAL_STEP" },
            { "shipNet.node[83].params", "{1.000000, 0.000000, 2385.538574, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[84].inputs", "{16, 11, 48, }" },
            { "shipNet.node[84].op", "ML_FOP_1x0_HYP_COSINE" },
            { "shipNet.node[84].params", "{}" },
            { "shipNet.node[85].inputs", "{2, 4, 10, 25, 66, 2, 18, 75, }" },
            { "shipNet.node[85].op", "ML_FOP_4x0_IF_LTE_ELSE" },
            ...
            { "shipNet.node[88].op", "ML_FOP_0x1_CONSTANT_N1K_0" },
            { "shipNet.node[88].params", "{}" },
            { "shipNet.node[89].inputs", "{85, 60, 45, 78, }" },
            { "shipNet.node[89].op", "ML_FOP_0x1_UNIT_CONSTANT" },
            { "shipNet.node[89].params", "{0.091052, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[90].inputs", "{21, 55, 37, 57, 8, 58, 70, }" },
            { "shipNet.node[90].op", "ML_FOP_NxN_SCALED_MAX" },
            { "shipNet.node[90].params", "{0.093566, 0.103454, 0.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[91].inputs", "{38, 90, 21, 11, 40, }" },
            { "shipNet.node[91].op", "ML_FOP_1x3_HYP_SINE" },
            { "shipNet.node[91].params", "{}" },
            { "shipNet.node[92].inputs", "{55, 0, 87, 66, 80, 50, }" },
            { "shipNet.node[92].op", "ML_FOP_1x0_SIN" },
            { "shipNet.node[92].params", "{219.802856, 0.293661, 0.000000, 0.159984, 0.713351, }" },
            { "shipNet.node[93].inputs", "{}" },
            { "shipNet.node[93].op", "ML_FOP_1x0_SIN" },
            { "shipNet.node[93].params", "{0.997500, 0.895488, 411.156036, 1.000000, 0.000000, 0.000000, 0.000000, 0.000000, }" },
            { "shipNet.node[94].inputs", "{78, 36, 72, 69, }" },
            { "shipNet.node[94].op", "ML_FOP_1x1_FMOD" },
            { "shipNet.node[94].params", "{0.097396, 2053.246582, 27.440088, }" },
            ...
            { "shipNet.node[97].inputs", "{66, 14, 57, 8, 21, 40, 2, 58, }" },
            { "shipNet.node[97].op", "ML_FOP_3x0_POW" },
            { "shipNet.node[97].params", "{0.000000, 0.000000, 148.431381, }" },
            { "shipNet.node[98].inputs", "{43, 19, 6, 36, 3, 36, }" },
            { "shipNet.node[98].op", "ML_FOP_Nx0_ACTIVATE_GAUSSIAN_UP_PROB_INVERSE" },
            { "shipNet.node[98].params", "{0.099385, 1.000000, 0.098355, 1989.178833, 0.000000, 0.503039, 0.000000, 0.000000, }" },
            { "shipNet.node[99].inputs", "{}" },
            { "shipNet.node[99].op", "ML_FOP_NxN_LINEAR_COMBINATION" },
            { "shipNet.node[99].params", "{0.122032, }" },
            { "shipNet.numInputs", "25" },
            { "shipNet.numNodes", "100" },
            { "shipNet.numOutputs", "25" },
